...
function PackageSynchronizerClient:_resolve_ability_packages(archetype, talents, profile_packages, mission, game_mode_settings, profile)
...
function PackageSynchronizerClient:_resolve_profile_properties(items, archetype, selected_voice, sound_dependencies, particle_dependencies)
...
function PackageSynchronizerClient:_resolve_archetype_dependencies(archetype, sound_dependencies, particle_dependencies)
...
function PackageSynchronizerClient:cached_profile(peer_id, local_player_id)
