...
function PackageSynchronizerHost:_calculate_player_unit_respawn(profile, new_profile)
...
function PackageSynchronizerHost:_handle_player_unit_respawn_before_sync(player, sync_data)
...
function PackageSynchronizerHost:_handle_player_unit_respawn_after_sync(player, sync_data)
	local player_unit_spawn_manager = Managers.state.player_unit_spawn
...
function PackageSynchronizerHost:_cleanup_owned_units(player)
