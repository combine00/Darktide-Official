...
function LocalIngameState:init(state_machine, shared_state)
	self._shared_state = shared_state
	shared_state.state = "playing"
	self._mission_name = nil
end

function LocalIngameState:destroy()
	self._mission_name = nil
end

function LocalIngameState:update()
...
function LocalIngameState:load_mission()
