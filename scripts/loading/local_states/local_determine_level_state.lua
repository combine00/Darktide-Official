...
function LocalDetermineLevelState:init(state_machine, shared_state)
	self._shared_state = shared_state
	self._mission_name = nil
end

function LocalDetermineLevelState:destroy()
	self._mission_name = nil
end

function LocalDetermineLevelState:update(dt)
...
function LocalDetermineLevelState:load_mission()
