...
function ProfileSynchronizerHost:_profile_changed(local_player_id, peer_id, character_id)
...
function ProfileSynchronizerHost:profile_updates_profile(peer_id, local_player_id)
