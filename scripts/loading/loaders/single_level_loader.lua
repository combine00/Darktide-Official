...
function SingleLevelLoader:init()
...
function SingleLevelLoader:destroy()
	self:cleanup()
end

function SingleLevelLoader:start_loading(context)
...
function SingleLevelLoader:_level_load_done_callback(item_definitions)
...
function SingleLevelLoader:_load_done_callback(package_id)
...
function SingleLevelLoader:is_loading_done()
	return self._load_state == LOAD_STATES.done
end

function SingleLevelLoader:cleanup()
	local package_manager = Managers.package
...
function SingleLevelLoader:dont_destroy()
	return false
end
