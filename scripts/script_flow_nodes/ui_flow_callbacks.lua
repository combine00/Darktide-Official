...
function UIFlowCallbacks.companion_footstep(params)
	return
end

function UIFlowCallbacks.companion_inventory_fx(params)
	return
end
...
function UIFlowCallbacks.is_dedicated_server(params)
