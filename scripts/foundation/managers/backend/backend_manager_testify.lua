...
function BackendManagerTestify.fail_on_not_authenticated(backend_manager)
...
function BackendManagerTestify.load_mission_in_mission_board(backend_manager, params)
