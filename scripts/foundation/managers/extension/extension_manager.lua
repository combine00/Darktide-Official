...
function ExtensionManager:init(world, physics_world, wwise_world, nav_world, has_navmesh, level_name, circumstance_name, havoc_data, is_server, unit_templates, system_configuration, system_init_data, unit_category_list, network_event_delegate, fixed_time_step, game_session, optional_soft_cap_out_of_bounds_units, use_time_slice)
...
function ExtensionManager:on_unit_id_resolved(unit, is_level_unit, unit_id)
...
function ExtensionManager:_add_and_register_units(world, unit_list, from_index, to_index, optional_category, added_list, num_added)
