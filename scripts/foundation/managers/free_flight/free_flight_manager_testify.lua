...
function FreeFlightManagerTestify.enter_free_flight(free_flight_manager)
...
function FreeFlightManagerTestify.set_free_flight_camera_position(free_flight_manager, camera_data)
...
function FreeFlightManagerTestify.free_flight_camera_follow_main_path(free_flight_manager, speed)
	free_flight_manager:toggle_follow_path()
	free_flight_manager:set_follow_path_speed(speed)
end

function FreeFlightManagerTestify.free_flight_camera_is_arrived_end_of_main_path(free_flight_manager)
