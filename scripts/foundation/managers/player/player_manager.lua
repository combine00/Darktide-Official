...
function PlayerManager:_reassign_slot(slot)
	local claimed_slots = self._claimed_slots
...
function PlayerManager:set_last_mission(mission_name)
...
function PlayerManager:_last_mission_id()
...
function PlayerManager:create_players_from_sync_data(player_class, channel_id, peer_id, is_server, local_player_id_array, is_human_controlled_array, account_id_array, profile_chunks_array, player_session_id_array, slot_array, last_mission_id)
...
function PlayerManager:rpc_player_assisted(channel_id, peer_id, assist_type_lookup)
	local assist_type = NetworkLookup.assist_type_lookup[assist_type_lookup]

	self:_show_assist_notification(peer_id, assist_type)
end

function PlayerManager:_show_assist_notification(peer_id, assist_type)
...
function PlayerManager:rpc_update_slot(_, peer_id, local_player_id, slot)
	local player = self:player(peer_id, local_player_id)
