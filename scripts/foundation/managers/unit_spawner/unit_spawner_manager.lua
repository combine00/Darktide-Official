...
function UnitSpawnerManager:deletion_state()
...
function UnitSpawnerManager:_create_unit_extensions(world, unit, extension_init_function, extension_unit_spawned_function_or_nil, game_object_data_or_session, ...)
