...
function WorldManager:create_world(name, parameters, ...)
...
function WorldManager:set_world_layer(world_name, layer)
...
function WorldManager:world_name(world)
...
function WorldManager:is_world_enabled(name)
...
function WorldManager:set_world_update_time_scale(scale)
...
function WorldManager:world_reset_dlss(world_name)
	local world = self:world(world_name)
