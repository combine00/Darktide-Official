function Utf8.string_length(text)
...
function Utf8.sub_string(text, from, to)
...
function Utf8.string_insert(text, pos, text_to_insert)
...
function Utf8.string_remove(text, pos, num_chars)
...
function Utf8.find(text, pattern, init, plain)
