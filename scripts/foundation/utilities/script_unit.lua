...
function ScriptUnit.extensions(unit)
...
function ScriptUnit.set_extension(unit, system_name, extension)
	_set_extension_script(unit, system_name, extension)
end

function ScriptUnit.add_extension(extension_init_context, unit, extension_name, system_name, extension_init_data, ...)
...
function ScriptUnit.remove_unit(unit)
	Entities[unit] = nil
end
...
function ScriptUnit.move_extensions(unit, new_unit)
	Entities[new_unit] = Entities[unit]
	Entities[unit] = nil
end

function ScriptUnit.optimize(unit)
...
function ScriptUnit.fetch_component_extension(unit, system_name)
