...
function ScriptWorld.destroy_viewport(world, name, ignore_camera_destruction)
	local viewports = World.get_data(world, "viewports")
...
function ScriptWorld.spawn_level(world, name, position, rotation, spawn_units, ignore_background, included_object_sets, excluded_object_sets)
