...
function PlayerUnitWeaponSpreadExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function PlayerUnitWeaponSpreadExtension:_init_components(unit, initial_seed)
...
function PlayerUnitWeaponSpreadExtension:fixed_update(unit, dt, t)
...
function PlayerUnitWeaponSpreadExtension:_update_spread(dt, t, spread_settings)
...
function PlayerUnitWeaponSpreadExtension:_player_event_decay(decay, t)
...
function PlayerUnitWeaponSpreadExtension:randomized_spread(current_rotation, optional_skip_update_component_data)
	local spread_control_component = self._spread_control_component
	local shooting_status_component = self._shooting_status_component
...
function PlayerUnitWeaponSpreadExtension:target_style_spread(current_rotation, num_shots_fired, num_shots_in_attack, num_spread_circles, bullseye, spread_pitch, spread_yaw, scatter_range, no_random, roll_offset)
