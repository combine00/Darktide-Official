...
function MinionPerceptionExtension:set_last_los_position(target_unit, position)
	local last_los_positions = self._last_los_positions
...
function MinionPerceptionExtension:cb_line_of_sight_hit(hit, hit_position)
...
function MinionPerceptionExtension:_update_target_selection(unit, side, target_units, perception_component, breed, dt, t, force_new_target_attempt, force_new_target_attempt_config)
...
function MinionPerceptionExtension:add_threat(threat_unit, threat_to_add, optional_attack_type)
	local threat_config = self._threat_config
...
function MinionPerceptionExtension:has_forced_aim(target_unit)
	return self._force_new_aim[target_unit]
end

function MinionPerceptionExtension:reset_forced_aim(target_unit)
...
function MinionPerceptionExtension:_within_detection_los_range(unit, unit_position, target_unit, target_position)
