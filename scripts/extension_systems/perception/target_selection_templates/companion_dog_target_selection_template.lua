...
local dog_radius = FAR_DISTANCE * 1.25
local player_clossness_weight = 1.5
local dog_clossness_weight = 0.5
...
local target_selection_template = {
	companion_dog = function (unit, side, perception_component, buff_extension, breed, target_units, line_of_sight_lookup, t, threat_units, force_new_target_attempt, force_new_target_attempt_config_or_nil, debug_target_weighting_or_nil)
