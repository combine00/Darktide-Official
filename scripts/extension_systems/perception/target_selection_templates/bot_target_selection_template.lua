...
function target_selection_template.bot_default(unit, unit_position, side, perception_component, behavior_component, breed, target_units, t, threat_units, bot_group, target_selection_debug_info_or_nil)
