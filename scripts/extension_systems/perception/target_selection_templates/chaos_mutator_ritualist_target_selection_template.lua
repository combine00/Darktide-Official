...
function target_selection_template.chaos_mutator_ritualist(unit, side, perception_component, buff_extension, breed, target_units, line_of_sight_lookup, t, threat_units, force_new_target_attempt, force_new_target_attempt_config_or_nil, debug_target_weighting_or_nil)
	local best_target_unit = nil
	local closest_distance_sq = math.huge
	local closest_z_distance = math.huge
	...
	local num_results = broadphase:query(position, BOLSTERING_RADIUS, RESULTS, target_side_names)
