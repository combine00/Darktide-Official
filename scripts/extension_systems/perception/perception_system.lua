...
function PerceptionSystem:destroy()
...
function PerceptionSystem:physics_cb_line_of_sight_hit(line_of_sight_collision_filter, id, hit, hit_position)
...
function PerceptionSystem:add_line_of_sight_raycast_query(unit, los_from_position, los_direction, los_distance, line_of_sight_collision_filter)
	local los_data = self._line_of_sight_raycast_data[line_of_sight_collision_filter]
...
function PerceptionSystem:on_reload(refreshed_resources)
	self:_preparse_bot_gestalt_target_selection_weights(BotGestaltTargetSelectionWeights)
...
function PerceptionSystem:set_untargetable(caller_class, unit)
...
function PerceptionSystem:set_targetable(unit, untargetable_id)
...
function PerceptionSystem:is_untargetable(unit)
	local untargetable_data = self._unit_untargetable_data[unit]
