...
function AnimationSystem:register_extension_update(unit, extension_name, extension)
...
function AnimationSystem:on_remove_extension(unit, extension_name)
...
function AnimationSystem:anim_callback(unit, callback_name, param1)
	local callback = nil
...
function AnimationSystem:rpc_prop_anim_event(channel_id, unit_id, is_level_unit, event_index)
...
function AnimationSystem:rpc_prop_anim_event_variable_float(channel_id, unit_id, is_level_unit, event_index, variable_index, variable_value)
	if not is_level_unit or unit_id ~= NetworkConstants.invalid_level_unit_id then
		local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
...
function AnimationSystem:rpc_prop_anim_set_variable(channel_id, unit_id, is_level_unit, variable_index, variable_value)
	if not is_level_unit or unit_id ~= NetworkConstants.invalid_level_unit_id then
		local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
...
function AnimationSystem:rpc_minion_anim_event(channel_id, unit_id, event_index)
	local unit = Managers.state.unit_spawner:unit(unit_id)

	Unit.animation_event_by_index(unit, event_index)
end

function AnimationSystem:rpc_minion_anim_event_variable_float(channel_id, unit_id, event_index, variable_index, variable_value, variable_name)
	local unit = Managers.state.unit_spawner:unit(unit_id)
	local unit_data_extension = ScriptUnit.has_extension(unit, "unit_data_system")
...
function AnimationSystem:rpc_player_anim_event(channel_id, unit_id, event_index, is_first_person)
	local unit = nil
...
function AnimationSystem:rpc_player_anim_event_variable_float(channel_id, unit_id, event_index, variable_index, variable_value, is_first_person)
	local unit = nil
	local third_person_unit = Managers.state.unit_spawner:unit(unit_id)
...
function AnimationSystem:rpc_player_anim_event_variable_floats(channel_id, unit_id, event_index, variable_indexes, variable_values, is_first_person)
	local unit = nil
	local third_person_unit = Managers.state.unit_spawner:unit(unit_id)
...
function AnimationSystem:rpc_player_anim_event_variable_int(channel_id, unit_id, event_index, variable_index, variable_value, is_first_person)
	local unit = nil
	local third_person_unit = Managers.state.unit_spawner:unit(unit_id)
...
function AnimationSystem:rpc_sync_anim_state(channel_id, unit_id, is_level_unit, animation_state, seeds)
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
...
function AnimationSystem.play_companion_interaction_anim_event(player_unit, companion_unit, anim_event_player, anim_event_companion, optional_variable_name, optional_variable_value)
