...
function SmokeFogSystem:init(context, system_init_data, ...)
...
function SmokeFogSystem:hot_join_sync(sender, channel)
	return
end

function SmokeFogSystem:destroy()
	return
end

function SmokeFogSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function SmokeFogSystem:on_remove_extension(removed_unit, extension_name)
...
function SmokeFogSystem:get_extensions_by_owner_unit(owner_unit)
	local extensions = {}
...
function SmokeFogSystem:update(context, dt, t, ...)
...
function SmokeFogSystem:_check_unit_collisions(t)
	local unit_to_extension_map = self._unit_to_extension_map
...
function SmokeFogSystem:check_fog_los(source_position, target_position, source_unit, count_standing_in_smoke)
