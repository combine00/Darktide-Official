...
function BtSequenceNode:init_values(blackboard, action_data, node_data)
...
function BtSequenceNode:add_child(node)
...
function BtSequenceNode:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy, node_data)
	local node_identifier = self.identifier

	_reset_child_to_run_index(node_data, node_identifier)
end

function BtSequenceNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	local node_identifier = self.identifier
