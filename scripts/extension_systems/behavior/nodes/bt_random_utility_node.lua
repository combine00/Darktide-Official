...
function BtRandomUtilityNode:init(...)
...
function BtRandomUtilityNode:init_values(blackboard, action_data, node_data)
...
function BtRandomUtilityNode:ready(lua_node)
...
function BtRandomUtilityNode:add_child(node)
...
function BtRandomUtilityNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	local node_identifier = self.identifier
...
function BtRandomUtilityNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
