...
local BtChaosArmoredHoundSelectorNode = class("BtChaosArmoredHoundSelectorNode", "BtNode")

function BtChaosArmoredHoundSelectorNode:init(...)
	BtChaosArmoredHoundSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtChaosArmoredHoundSelectorNode:init_values(blackboard, action_data, node_data)
	BtChaosArmoredHoundSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtChaosArmoredHoundSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtChaosArmoredHoundSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	local condition_result = is_aggroed or pounce_component.started_leap
...
function BtChaosArmoredHoundSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosArmoredHoundSelectorNode
