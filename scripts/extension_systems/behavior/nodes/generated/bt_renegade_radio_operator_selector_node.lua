...
function BtRenegadeRadioOperatorSelectorNode:init(...)
	BtRenegadeRadioOperatorSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtRenegadeRadioOperatorSelectorNode:init_values(blackboard, action_data, node_data)
...
function BtRenegadeRadioOperatorSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtRenegadeRadioOperatorSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	condition_result = next_summon_t < t and (true or true) or false

	if condition_result then
		new_running_child_nodes[node_identifier] = node_summon
...
function BtRenegadeRadioOperatorSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
