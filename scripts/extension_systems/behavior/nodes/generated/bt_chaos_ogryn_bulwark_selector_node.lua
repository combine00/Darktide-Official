...
local BtChaosOgrynBulwarkSelectorNode = class("BtChaosOgrynBulwarkSelectorNode", "BtNode")

function BtChaosOgrynBulwarkSelectorNode:init(...)
	BtChaosOgrynBulwarkSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtChaosOgrynBulwarkSelectorNode:init_values(blackboard, action_data, node_data)
	BtChaosOgrynBulwarkSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtChaosOgrynBulwarkSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtChaosOgrynBulwarkSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	local node_far_follow = children[6]
	...
	if condition_result then
		new_running_child_nodes[node_identifier] = node_far_follow

		return node_far_follow
	end
...
function BtChaosOgrynBulwarkSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosOgrynBulwarkSelectorNode
