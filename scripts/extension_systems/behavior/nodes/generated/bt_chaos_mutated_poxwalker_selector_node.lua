...
local BtChaosMutatedPoxwalkerSelectorNode = class("BtChaosMutatedPoxwalkerSelectorNode", "BtNode")

function BtChaosMutatedPoxwalkerSelectorNode:init(...)
	BtChaosMutatedPoxwalkerSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtChaosMutatedPoxwalkerSelectorNode:init_values(blackboard, action_data, node_data)
	BtChaosMutatedPoxwalkerSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtChaosMutatedPoxwalkerSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtChaosMutatedPoxwalkerSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
function BtChaosMutatedPoxwalkerSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosMutatedPoxwalkerSelectorNode
