...
local BtChaosHoundSelectorNode = class("BtChaosHoundSelectorNode", "BtNode")

function BtChaosHoundSelectorNode:init(...)
	BtChaosHoundSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtChaosHoundSelectorNode:init_values(blackboard, action_data, node_data)
	BtChaosHoundSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtChaosHoundSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtChaosHoundSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
function BtChaosHoundSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosHoundSelectorNode
