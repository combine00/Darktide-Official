...
function BtChaosSpawnSelectorNode:init(...)
	BtChaosSpawnSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtChaosSpawnSelectorNode:init_values(blackboard, action_data, node_data)
	BtChaosSpawnSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtChaosSpawnSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtChaosSpawnSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
function BtChaosSpawnSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosSpawnSelectorNode
