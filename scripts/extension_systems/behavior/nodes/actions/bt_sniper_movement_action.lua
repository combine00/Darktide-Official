...
function BtSniperMovementAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtSniperMovementAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtSniperMovementAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtSniperMovementAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data, move_type)
...
function BtSniperMovementAction:_get_move_type(scratchpad, action_data)
...
function BtSniperMovementAction:_set_destinations(scratchpad, action_data)
...
function BtSniperMovementAction:_start_astar(unit, scratchpad, action_data)
...
function BtSniperMovementAction:_evaluate_destinations(unit, scratchpad, action_data)
...
function BtSniperMovementAction:_restart_atar(unit, scratchpad, action_data)
