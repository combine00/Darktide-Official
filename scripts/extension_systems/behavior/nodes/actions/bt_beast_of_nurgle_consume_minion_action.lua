...
function BtBeastOfNurgleConsumeMinionAction:_get_target(unit, breed)
...
function BtBeastOfNurgleConsumeMinionAction:_start_tongue_out(target_distance, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:_start_tongue_in(unit, target_brain, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:_start_consuming(scratchpad)
	local target_unit = scratchpad.target_unit
...
function BtBeastOfNurgleConsumeMinionAction:_update_consuming(scratchpad, t)
