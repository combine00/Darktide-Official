...
function BtStrafeShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtStrafeShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtStrafeShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtStrafeShootAction:_update_moving_animations(unit, scratchpad, action_data)
...
function BtStrafeShootAction:_update_shooting(unit, t, scratchpad, action_data)
...
function BtStrafeShootAction:_update_cooldown(unit, t, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
	local attack_allowed = AttackIntensity.minion_can_attack(unit, action_data.attack_intensity_type, target_unit)
...
function BtStrafeShootAction:_rotate_towards_target_unit(unit, target_unit, scratchpad)
