...
function BtJumpAcrossAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtJumpAcrossAction:_start_jump(unit, breed, animation_extension, locomotion_extension, navigation_extension, nav_smart_object_component, anim_translation_scale_factor, scratchpad, action_data, t)
...
function BtJumpAcrossAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtJumpAcrossAction:_is_unit_on_navmesh(unit, navigation_extension)
...
function BtJumpAcrossAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
