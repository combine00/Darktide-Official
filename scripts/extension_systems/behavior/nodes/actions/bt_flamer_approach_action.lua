...
function BtFlamerApproachAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtFlamerApproachAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtFlamerApproachAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtFlamerApproachAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
...
function BtFlamerApproachAction:_rotate_towards_target_unit(unit, scratchpad, target_unit)
