...
function BtSuppressedAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtSuppressedAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtSuppressedAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtSuppressedAction:_trigger_anim(unit, scratchpad, anim_events, durations, t)
...
function BtSuppressedAction:_setup_jump_anim(unit, scratchpad, blackboard, jump_anim_events)
...
function BtSuppressedAction:_rotate_towards_target_unit(unit, scratchpad)
