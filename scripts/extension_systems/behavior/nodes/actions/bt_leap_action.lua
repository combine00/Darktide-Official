...
function BtLeapAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtLeapAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
	behavior_component.should_leap = false
end

function BtLeapAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtLeapAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local result = nil
	local locomotion_extension = scratchpad.locomotion_extension
...
function BtLeapAction:_update_starting_movement(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
...
function BtLeapAction:_try_start_leap(unit, scratchpad, action_data, t, self_position, target_position)
...
function BtLeapAction:_get_leap_velocity(scratchpad, action_data, self_position, target_position)
	...
	local start_position = nav_mesh_position + Vector3(0, 0, NAV_Z_CORRECTION)
	...
	local radius = ChaosSpawnSettings.trajectory_radius
...
function BtLeapAction:_create_bot_aoe_threats(unit, scratchpad, action_data, target_position)
...
function BtLeapAction:_update_setup_leap(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
...
function BtLeapAction:_leap(scratchpad)
...
function BtLeapAction:_update_leaping(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
...
function BtLeapAction:_check_leap_for_collisions(scratchpad, physics_world, start_t, end_t)
...
function BtLeapAction:_update_falling(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
...
function BtLeapAction:_update_landing(unit, scratchpad, action_data, t)
...
function BtLeapAction:_start_landing(scratchpad, action_data, t)
...
function BtLeapAction:_push_or_catapult_players(unit, scratchpad, action_data, t)
