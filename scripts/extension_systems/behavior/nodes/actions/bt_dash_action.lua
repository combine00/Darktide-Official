...
function BtDashAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtDashAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtDashAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtDashAction:_start_buildup(unit, scratchpad, action_data, t)
	local navigation_extension = scratchpad.navigation_extension
...
function BtDashAction:_start_dashing(unit, scratchpad, action_data, t)
...
function BtDashAction:_start_reached_destination(unit, scratchpad, action_data, t)
...
function BtDashAction:_update_dashing(unit, scratchpad, action_data, t, dt)
...
function BtDashAction:_move_to_position(scratchpad, target_position, action_data)
	local navigation_extension = scratchpad.navigation_extension
...
function BtDashAction:_check_colliding_players(unit, scratchpad, action_data)
...
function BtDashAction:_hit_target(unit, hit_unit, scratchpad, action_data, t)
	scratchpad.hit_target = hit_unit

	self:_damage_target(hit_unit, unit, action_data, scratchpad)
end

function BtDashAction:_rotate_towards_target_unit(unit, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtDashAction:_update_dash_buildup(unit, scratchpad, action_data, t, dt)
...
function BtDashAction:_start_dash_direction_anim(unit, scratchpad, action_data, t)
...
function BtDashAction:_start_dash_anim(unit, scratchpad, action_data, t)
	scratchpad.locomotion_extension = ScriptUnit.extension(unit, "locomotion_system")
...
function BtDashAction:_damage_target(hit_target, unit, action_data, scratchpad)
...
function BtDashAction:_calculate_dash_directions(randomized_directions)
...
function BtDashAction:_get_dash_position(target_position, scratchpad, action_data)
