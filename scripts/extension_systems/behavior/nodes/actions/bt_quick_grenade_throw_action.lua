...
function BtQuickGrenadeThrowAction:_start_throwing(unit, t, scratchpad, action_data)
	local multiple_throw_chance = action_data.multiple_throw_chance
	local should_multiple_throw = multiple_throw_chance and math.random() <= multiple_throw_chance
...
function BtQuickGrenadeThrowAction:_update_throw_timing(unit, t, blackboard, scratchpad, action_data)
	self:_aim_at_target(unit, scratchpad)

	if scratchpad.effect_template_timing and scratchpad.effect_template_timing < t and not scratchpad.global_effect_id then
	...
	if scratchpad.throw_timings then
		if scratchpad.next_throw_timing and scratchpad.next_throw_timing <= t then
	...
	elseif scratchpad.throw_timing < t then
		local throw_position, throw_direction = self:_throw_position_and_direction(unit, scratchpad, action_data)
...
function BtQuickGrenadeThrowAction:_throw_grenade(unit, scratchpad, action_data, throw_type, throw_position, throw_direction, blackboard, t, optional_owner_velocity)
	local throw_config = action_data.throw_config
	local projectile_template = throw_config.projectile_template
	local locomotion_template = projectile_template.locomotion_template
