...
function BtMoveToCombatVectorAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtMoveToCombatVectorAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtMoveToCombatVectorAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtMoveToCombatVectorAction:_move_to_combat_vector(scratchpad, combat_vector_component, navigation_extension)
	local wanted_position = combat_vector_component.position:unbox()
...
function BtMoveToCombatVectorAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
