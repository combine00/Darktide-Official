...
function BtShootPatternAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShootPatternAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtShootPatternAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtShootPatternAction:_start(unit, t, scratchpad, action_data)
...
function BtShootPatternAction:_update_starting(unit, t, scratchpad, action_data)
...
function BtShootPatternAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtShootPatternAction:_stop_shooting(unit, scratchpad)
...
function BtShootPatternAction:_update_shooting(unit, t, dt, scratchpad, action_data)
...
function BtShootPatternAction:_shoot(unit, scratchpad, action_data)
...
function BtShootPatternAction:_setup_pattern_point(scratchpad, pattern_point, position)
...
function BtShootPatternAction:_get_pattern_goal_position(self_position, target_position, pattern_point)
...
function BtShootPatternAction:_sin_cos_offset(position, offset_dir, distance, sin_modifier, cos_modifier, t)
	local offset_pos = position + offset_dir * (math.sin(t * distance) * sin_modifier + math.cos(t * distance) * cos_modifier)

	return offset_pos
end

function BtShootPatternAction:_update_controlled_aiming(unit, scratchpad, action_data, dt, t)
...
function BtShootPatternAction:_rotate_towards_target_unit(unit, scratchpad)
	local target_unit = scratchpad.perception_component.target_unit
