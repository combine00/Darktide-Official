...
function BtRenegadePlasmaShocktrooperShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRenegadePlasmaShocktrooperShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRenegadePlasmaShocktrooperShootAction:init_values(blackboard, action_data, node_data)
	local perception_component = Blackboard.write_component(blackboard, "perception")
	perception_component.has_good_last_los_position = false
end

function BtRenegadePlasmaShocktrooperShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRenegadePlasmaShocktrooperShootAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtRenegadePlasmaShocktrooperShootAction:_update_aiming(unit, t, dt, scratchpad, action_data)
...
function BtRenegadePlasmaShocktrooperShootAction:_aim(unit, t, dt, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtRenegadePlasmaShocktrooperShootAction:_ray_cast(scratchpad, from, to, distance)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtRenegadePlasmaShocktrooperShootAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtRenegadePlasmaShocktrooperShootAction:_update_shooting(unit, t, dt, scratchpad, action_data)
...
function BtRenegadePlasmaShocktrooperShootAction:_start_cooldown(unit, t, scratchpad, action_data)
	MinionPerception.set_target_lock(unit, scratchpad.perception_component, false)
...
function BtRenegadePlasmaShocktrooperShootAction:_update_cooldown(unit, t, dt, scratchpad, action_data)
	self:_aim(unit, t, dt, scratchpad, action_data)
...
function BtRenegadePlasmaShocktrooperShootAction:_create_bot_threat(unit, target_unit)
