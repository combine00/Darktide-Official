...
function BtChaosHoundTargetPouncedAction:_pounce_achieved(scratchpad, action_data, t, pounce_target)
...
function BtChaosHoundTargetPouncedAction:_damage_target(unit, pounce_target, action_data, power_level_table, damage_profile)
