...
function BtTwinCaptainDisappearIdleAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtTwinCaptainDisappearIdleAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
