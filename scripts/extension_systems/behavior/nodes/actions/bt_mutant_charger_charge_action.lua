...
function BtMutantChargerChargeAction:init_values(blackboard)
...
function BtMutantChargerChargeAction:_is_facing_target(unit, scratchpad)
...
function BtMutantChargerChargeAction:_get_min_charge_speed(scratchpad, action_data)
...
function BtMutantChargerChargeAction:_get_max_charge_speed(scratchpad, action_data)
