...
function BtAlertedAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtAlertedAction:_select_alerted_mode(action_data)
...
function BtAlertedAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtAlertedAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local behavior_component = scratchpad.behavior_component
...
function BtAlertedAction:_start_alerted_direction_anim(unit, scratchpad, action_data, t)
	scratchpad.locomotion_extension = ScriptUnit.extension(unit, "locomotion_system")
	local alerted_mode = scratchpad.alerted_mode
...
function BtAlertedAction:_rotate_towards_target_unit(unit, scratchpad, target_unit)
