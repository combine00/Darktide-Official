...
function BtBeastOfNurgleAlignAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleAlignAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBeastOfNurgleAlignAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleAlignAction:_start_align_anim(unit, breed, t, scratchpad, action_data)
...
function BtBeastOfNurgleAlignAction:_update_anim_driven_start_rotation(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleAlignAction:_set_anim_driven(unit, scratchpad, set_anim_driven)
	MinionMovement.set_anim_driven(scratchpad, set_anim_driven)
end

function BtBeastOfNurgleAlignAction:_rotate_towards_target_unit(unit, scratchpad)
