...
function BtPatrolAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtPatrolAction:init_values(blackboard)
	local patrol_component = Blackboard.write_component(blackboard, "patrol")
...
function BtPatrolAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtPatrolAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtPatrolAction:_start_move_anim(unit, scratchpad, behavior_component, action_data, t)
...
function BtPatrolAction:_set_new_patrol_position(unit, patrol_component)
...
function BtPatrolAction:trigger_patrol_sound(scratchpad, should_start)
...
function BtPatrolAction:_update_patrolling(unit, breed, blackboard, scratchpad, action_data, dt, t)
