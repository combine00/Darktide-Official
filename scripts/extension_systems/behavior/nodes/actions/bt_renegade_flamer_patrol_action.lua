...
function BtRenegadeFlamerPatrolAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRenegadeFlamerPatrolAction:init_values(blackboard)
	local patrol_component = Blackboard.write_component(blackboard, "patrol")
...
function BtRenegadeFlamerPatrolAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRenegadeFlamerPatrolAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRenegadeFlamerPatrolAction:_start_move_anim(unit, scratchpad, behavior_component, action_data, t)
...
function BtRenegadeFlamerPatrolAction:_set_new_patrol_position(unit, patrol_component)
...
function BtRenegadeFlamerPatrolAction:trigger_patrol_sound(scratchpad, should_start)
...
function BtRenegadeFlamerPatrolAction:_update_patrolling(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRenegadeFlamerPatrolAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_update_aiming(unit, t, dt, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_update_shooting(unit, t, dt, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_update_shooting_liquid_beam(unit, t, dt, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_update_liquid_beam_positions(dt, scratchpad, action_data, from_position, to_position)
...
function BtRenegadeFlamerPatrolAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_stop_effect_template(scratchpad)
	local liquid_beam_effect_id = scratchpad.liquid_beam_effect_id
...
function BtRenegadeFlamerPatrolAction:_set_game_object_field(scratchpad, key, value)
...
function BtRenegadeFlamerPatrolAction:_get_from_shoot_pos(unit, scratchpad, action_data, t)
	local from_position = self:_get_from_position(unit, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_get_to_shoot_pos(unit, scratchpad, action_data, t)
	local from_position = self:_get_from_position(unit, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_ray_cast(physics_world, from, direction, distance, action_data)
...
function BtRenegadeFlamerPatrolAction:_try_get_trajectory(scratchpad, action_data, from_position, to_position)
...
function BtRenegadeFlamerPatrolAction:_get_from_position(unit, scratchpad, action_data)
...
function BtRenegadeFlamerPatrolAction:_calculate_control_points(scratchpad, segments, total_length, dt)
...
function BtRenegadeFlamerPatrolAction:_stop_liquid_beam(unit, scratchpad, blackboard)
