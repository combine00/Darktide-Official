...
function BtCompanionFallAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtCompanionFallAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtCompanionFallAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
