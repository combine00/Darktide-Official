...
function BtShootLiquidBeamAction:init_values(blackboard, action_data, node_data)
...
function BtShootLiquidBeamAction:_try_start_strafe_shooting(unit, t, scratchpad, action_data, breed)
	local perception_component = scratchpad.perception_component
	local self_position = POSITION_LOOKUP[unit]
...
function BtShootLiquidBeamAction:_update_trying_to_strafe_shoot(unit, t, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
...
function BtShootLiquidBeamAction:_update_strafe_shooting(unit, t, dt, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
	local is_following_path = navigation_extension:is_following_path()
...
function BtShootLiquidBeamAction:_stop_strafe_shooting(unit, t, scratchpad, action_data)
