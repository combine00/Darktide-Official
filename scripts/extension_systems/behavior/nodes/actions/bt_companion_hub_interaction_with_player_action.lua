...
local _is_looking_at_target, _move_towards_animation_point, _rotate_towards_target_unit = nil

function BtCompanionHubInteractionWithPlayerAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtCompanionHubInteractionWithPlayerAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
...
function BtCompanionHubInteractionWithPlayerAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
	if action_data.enable_disable_locomotion_speed then
...
function BtCompanionHubInteractionWithPlayerAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
