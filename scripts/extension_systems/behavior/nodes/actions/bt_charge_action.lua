...
function BtChargeAction:_update_charging(unit, scratchpad, action_data, dt, t)
...
function BtChargeAction:_update_charged_past(unit, scratchpad, action_data, dt, t)
...
function BtChargeAction:_update_attacking(unit, scratchpad, action_data, dt, t)
...
function BtChargeAction:_update_charge_buildup(unit, scratchpad, action_data, dt, t)
