...
function BtRenegadeTwinCaptainShieldDownAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRenegadeTwinCaptainShieldDownAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
...
function BtRenegadeTwinCaptainShieldDownAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRenegadeTwinCaptainShieldDownAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local behavior_component = scratchpad.behavior_component
	...
	elseif scratchpad.stand_up_anim_duration and scratchpad.stand_up_anim_duration <= t then
		behavior_component.toughness_broke = false
		behavior_component.remove_toughness_clamp = false
...
function BtRenegadeTwinCaptainShieldDownAction:_break_shield(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local toughness_extension = scratchpad.toughness_extension
	local behavior_component = scratchpad.behavior_component
