...
local _override_gib = nil

function BtFlamerCheckBackpackAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtFlamerCheckBackpackAction:init_values(blackboard, action_data, node_data)
	local statistics_component = Blackboard.write_component(blackboard, "statistics")
	statistics_component.flamer_backpack_impacts = 0
end

function BtFlamerCheckBackpackAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	return "done"
end
