...
function BtChangeTargetAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChangeTargetAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChangeTargetAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChangeTargetAction:_start_change_target_anim(unit, breed, t, scratchpad, action_data)
	local target_unit = scratchpad.target_unit
	local target_position = POSITION_LOOKUP[target_unit]
