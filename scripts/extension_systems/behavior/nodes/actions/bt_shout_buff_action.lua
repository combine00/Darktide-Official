...
function BtShoutBuffAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShoutBuffAction:_shout(unit, action_data, t)
	...
	local num_hits = broadphase:query(player_position, shout_radius, _broadphase_results, allied_side_names, MINION_BREED_TYPE)
...
function BtShoutBuffAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	...
	if scratchpad.shout_timing and scratchpad.shout_timing <= t then
