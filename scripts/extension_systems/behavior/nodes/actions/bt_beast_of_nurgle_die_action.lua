...
function BtBeastOfNurgleDieAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleDieAction:init_values(blackboard)
	local death_component = Blackboard.write_component(blackboard, "death")
...
function BtBeastOfNurgleDieAction:_set_dead(unit, scratchpad, breed, action_data, blackboard)
...
function BtBeastOfNurgleDieAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleDieAction:_explode(unit, action_data, blackboard)
