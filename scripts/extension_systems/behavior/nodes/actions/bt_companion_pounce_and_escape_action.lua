...
function BtCompanionTargetPounceAndEscapeAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtCompanionTargetPounceAndEscapeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	...
	if not scratchpad.land_anim_duration then
		if scratchpad.is_anim_driven and scratchpad.animation_driven_duration < t then
...
function BtCompanionTargetPounceAndEscapeAction:_damage_target(unit, pounce_target, action_data, damage_profile)
...
function BtCompanionTargetPounceAndEscapeAction:_initial_set_up(unit, scratchpad, action_data, t)
	local companion_pounce_setting = scratchpad.companion_pounce_setting
...
function BtCompanionTargetPounceAndEscapeAction:_select_jump_off_direction(unit, action_data, scratchpad, pounce_target, trace_direction)
...
function BtCompanionTargetPounceAndEscapeAction:_position_companion(unit, scratchpad, action_data, t, pounce_target)
...
function BtCompanionTargetPounceAndEscapeAction:_jump_off_set_up(unit, scratchpad, action_data, t, companion_pounce_setting, reset_rotation)
	local pounce_component = scratchpad.pounce_component
	local pounce_target = pounce_component.pounce_target
...
function BtCompanionTargetPounceAndEscapeAction:_free_token(unit, scratchpad)
	local pounce_component = scratchpad.pounce_component
	local pounce_target = pounce_component.pounce_target
