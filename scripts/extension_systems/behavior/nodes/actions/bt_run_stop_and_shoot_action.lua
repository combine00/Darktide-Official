...
function BtRunStopAndShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRunStopAndShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRunStopAndShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRunStopAndShootAction:_start_attacking(unit, t, scratchpad, action_data)
...
function BtRunStopAndShootAction:_update_attacking(unit, t, scratchpad, action_data)
...
function BtRunStopAndShootAction:_start_cooldown(t, scratchpad, action_data)
...
function BtRunStopAndShootAction:_update_cooldown(t, scratchpad)
	return scratchpad.cooldown < t
end

function BtRunStopAndShootAction:_start_move_anim(unit, t, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
	local target_position = POSITION_LOOKUP[target_unit]
