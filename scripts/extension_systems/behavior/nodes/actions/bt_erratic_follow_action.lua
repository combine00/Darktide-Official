...
function BtErraticFollowAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtErraticFollowAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtErraticFollowAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtErraticFollowAction:_start_move_anim(unit, breed, t, scratchpad, action_data)
	scratchpad.state = "running"
...
function BtErraticFollowAction:_update_running(unit, t, scratchpad, blackboard, action_data)
	local navigation_extension = scratchpad.navigation_extension
	local slot_system = Managers.state.extension:system("slot_system")
...
function BtErraticFollowAction:_update_jumping(unit, t, scratchpad, blackboard, action_data, breed)
...
function BtErraticFollowAction:_check_for_high_jump(unit, scratchpad)
...
function BtErraticFollowAction:check_dir(p0, travel_dir, nav_world, traverse_logic, data)
...
function BtErraticFollowAction:_investigate_jump(unit, t, scratchpad, blackboard, action_data)
...
function BtErraticFollowAction:_update_effect_template(unit, scratchpad, action_data, target_unit)
...
function BtErraticFollowAction:_rotate_towards_target_unit(unit, target_unit, scratchpad)
