...
function BtPoxwalkerBomberApproachAction:_update_effect_template(unit, scratchpad, action_data, navigation_extension)
	if scratchpad.global_effect_id then
...
function BtPoxwalkerBomberApproachAction:_start_lunge(unit, blackboard, scratchpad, action_data, target_unit, t)
