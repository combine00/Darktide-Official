...
function BtSwitchWeaponAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtSwitchWeaponAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtSwitchWeaponAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtSwitchWeaponAction:_rotate_towards_target_unit(unit, scratchpad)
