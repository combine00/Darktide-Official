...
function BtBotReloadAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotReloadAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
	scratchpad.is_reloading = false

	scratchpad.action_input_extension:bot_queue_clear_requests("weapon_action")
end

function BtBotReloadAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
