...
function BtBotShootAction:_aim_position(self_unit, scratchpad, action_data, dt, current_position, current_rotation, target_unit)
...
function BtBotShootAction:_calculate_aim_speed(dt, current_yaw, current_pitch, wanted_yaw, wanted_pitch, current_yaw_speed, action_data)
