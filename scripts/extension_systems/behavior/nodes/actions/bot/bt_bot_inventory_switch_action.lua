...
function BtBotInventorySwitchAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotInventorySwitchAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	...
	if inventory_component.wielded_slot == wanted_slot then
		return "done"
	elseif scratchpad.next_evaluate_t < t then
	...
	elseif scratchpad.next_action_input_t < t then
