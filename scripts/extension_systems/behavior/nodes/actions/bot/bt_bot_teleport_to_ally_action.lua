...
function BtBotTeleportToAllyAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotTeleportToAllyAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
