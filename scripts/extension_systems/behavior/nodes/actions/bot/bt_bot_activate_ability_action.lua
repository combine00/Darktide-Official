...
function BtBotActivateAbilityAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotActivateAbilityAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBotActivateAbilityAction:_start_ability(scratchpad, t)
	local started = nil
...
function BtBotActivateAbilityAction:_perform_wait_action(wait_action_data, scratchpad, action_data)
...
function BtBotActivateAbilityAction:_evaluate_end_condition(scratchpad, t)
