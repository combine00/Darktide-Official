...
function BtTwinCaptainIntroAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtTwinCaptainIntroAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
...
function BtTwinCaptainIntroAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtTwinCaptainIntroAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	...
	if scratchpad.move_to_position then
		...
		if ARRIVED_AT_POSITION_THRESHOLD_SQ <= new_distance_sq then
...
function BtTwinCaptainIntroAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
