...
function BtChaosHoundLeapAction:_update_starting_state(unit, scratchpad, action_data, dt, t, locomotion_extension, perception_component, target_unit)
...
function BtChaosHoundLeapAction:_calculate_wanted_velocity(physics_world, start_position, target_position, target_velocity, speed, optional_relax_distance, debug)
...
function BtChaosHoundLeapAction:_leap(unit, scratchpad, action_data, start_position, leap_velocity)
...
function BtChaosHoundLeapAction:_stop(scratchpad, action_data, t)
...
function BtChaosHoundLeapAction:_create_bot_aoe_threats(unit, scratchpad, action_data, target_unit)
...
function BtChaosHoundLeapAction:_update_stopping_state(scratchpad, t)
...
function BtChaosHoundLeapAction:_set_pounce_cooldown(scratchpad, t)
...
function BtChaosHoundLeapAction:_update_leaping_state(unit, scratchpad, action_data, dt, t, breed, locomotion_extension, target_unit)
...
function BtChaosHoundLeapAction:_advance_leap(unit, scratchpad, action_data, locomotion_extension, dt, t, old_leap_time, new_leap_time, leap_start_position, leap_velocity)
	local physics_world = scratchpad.physics_world
...
function BtChaosHoundLeapAction:_stop_in_air_stagger(scratchpad)
	local locomotion_extension = scratchpad.locomotion_extension
...
function BtChaosHoundLeapAction:_check_leap_for_collisions(scratchpad, action_data, physics_world, start_t, end_t, leap_start_position, leap_velocity)
...
function BtChaosHoundLeapAction:_calculate_wall_jump_velocity(action_data, physics_world, nav_world, traverse_logic, position, wall_normal)
...
function BtChaosHoundLeapAction:_start_wall_jump(scratchpad, action_data, t, wall_normal, wall_jump_start_position, wall_jump_velocity)
	local locomotion_extension = scratchpad.locomotion_extension
...
function BtChaosHoundLeapAction:_update_in_air_stagger_state(unit, scratchpad, action_data, t)
	self:_update_in_air_stagger(scratchpad, action_data, t)
...
function BtChaosHoundLeapAction:_start_landing(scratchpad, action_data, t)
	scratchpad.state = "landing"
...
function BtChaosHoundLeapAction:_update_wall_jump_state(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
...
function BtChaosHoundLeapAction:_update_falling_state(unit, scratchpad, action_data, dt, t, locomotion_extension, target_unit)
	local current_velocity = locomotion_extension:current_velocity()
	local gravity = ChaosHoundSettings.leap_gravity
...
function BtChaosHoundLeapAction:_update_landing_state(unit, scratchpad, action_data, t, locomotion_extension)
