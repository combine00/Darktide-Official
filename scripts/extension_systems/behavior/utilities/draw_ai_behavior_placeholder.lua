...
function DrawAiBehavior.tree_width(gui, node)
...
function DrawAiBehavior.draw_tree(bt, gui, node, blackboard, running_node, row, dt, t, x, y, draw_utility, extra_info, node_data)
	local identifier = node.identifier
