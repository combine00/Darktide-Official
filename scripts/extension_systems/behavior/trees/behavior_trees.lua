...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/chaos/chaos_mutator_daemonhost_behavior_tree")
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/chaos/chaos_mutator_ritualist_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/renegade/renegade_radio_operator_behavior_tree")
