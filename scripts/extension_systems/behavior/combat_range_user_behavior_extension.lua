...
function CombatRangeUserBehaviorExtension:extensions_ready(world, unit)
...
function CombatRangeUserBehaviorExtension:_switch_combat_range(unit, blackboard, config, weapon_switch_component, behavior_component, t)
