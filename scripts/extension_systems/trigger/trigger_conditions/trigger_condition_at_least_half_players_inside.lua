...
function TriggerConditionAtLeastHalfPlayersInside:on_volume_enter(entering_unit, dt, t)
...
function TriggerConditionAtLeastHalfPlayersInside:on_volume_exit(exiting_unit)
	return self:_unregister_unit(exiting_unit)
end

local unit_to_test = {}

function TriggerConditionAtLeastHalfPlayersInside:filter_passed(filter_unit, volume_id)
...
function TriggerConditionAtLeastHalfPlayersInside:_is_player(unit)
	local player_unit_spawn_manager = Managers.state.player_unit_spawn
