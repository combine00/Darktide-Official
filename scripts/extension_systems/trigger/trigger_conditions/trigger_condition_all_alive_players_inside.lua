...
function TriggerConditionAllAlivePlayersInside:init(engine_volume_event_system, is_server, volume_unit, only_once, condition_name, evaluates_bots)
...
function TriggerConditionAllAlivePlayersInside:on_volume_enter(entering_unit, dt, t)
...
function TriggerConditionAllAlivePlayersInside:on_volume_exit(exiting_unit)
	return self:_unregister_unit(exiting_unit)
end

local units_to_test = {}

function TriggerConditionAllAlivePlayersInside:filter_passed(filter_unit, volume_id)
...
function TriggerConditionAllAlivePlayersInside:_unit_is_on_side(unit, side_name)
