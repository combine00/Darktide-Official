...
function TriggerConditionOnlyEnter:init(engine_volume_event_system, is_server, volume_unit, only_once, condition_name, evaluates_bots)
...
function TriggerConditionOnlyEnter:on_volume_enter(entering_unit, dt, t)
...
function TriggerConditionOnlyEnter:on_volume_exit(exiting_unit)
...
function TriggerConditionOnlyEnter:filter_passed(filter_unit, volume_id)
...
function TriggerConditionOnlyEnter:_is_player(unit)
	local player_unit_spawn_manager = Managers.state.player_unit_spawn
