...
function TriggerConditionLuggableInside:init(engine_volume_event_system, is_server, volume_unit, only_once, condition_name, evaluates_bots)
...
function TriggerConditionLuggableInside:_setup_sockets_in_volume()
...
function TriggerConditionLuggableInside:on_volume_enter(entering_unit, dt, t)
...
function TriggerConditionLuggableInside:_socket_luggable(luggable_unit)
