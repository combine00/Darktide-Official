...
function TriggerConditionAllPlayersInsideNoEnemies:init(engine_volume_event_system, is_server, volume_unit, only_once, condition_name, evaluates_bots)
...
function TriggerConditionAllPlayersInsideNoEnemies:on_volume_enter(entering_unit, dt, t)
...
function TriggerConditionAllPlayersInsideNoEnemies:on_volume_exit(exiting_unit)
...
function TriggerConditionAllPlayersInsideNoEnemies:filter_passed(filter_unit, volume_id)
