...
function TriggerSystem:destroy()
...
function TriggerSystem:update_level_props_broadphase()
...
function TriggerSystem:rpc_volume_trigger_activate_on_client(channel_id, volume_unit_id, unit_id)
...
function TriggerSystem:rpc_volume_trigger_deactivate_on_client(channel_id, volume_unit_id, unit_id)
	local unit_spawner_manager = Managers.state.unit_spawner
	local volume_unit = unit_spawner_manager:unit(volume_unit_id, true)
	local unit = unit_spawner_manager:unit(unit_id)
	local trigger_extension = self._unit_to_extension_map[volume_unit]
...
function TriggerSystem:rpc_volume_trigger_unit_enter_on_client(channel_id, volume_unit_id, enter_unit_id)
	local unit_spawner_manager = Managers.state.unit_spawner
	local volume_unit = unit_spawner_manager:unit(volume_unit_id, true)
...
function TriggerSystem:rpc_volume_trigger_unit_exit_on_client(channel_id, volume_unit_id, exit_unit_id)
	local unit_spawner_manager = Managers.state.unit_spawner
	local volume_unit = unit_spawner_manager:unit(volume_unit_id, true)
