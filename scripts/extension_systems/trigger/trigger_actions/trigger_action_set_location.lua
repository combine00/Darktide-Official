...
function TriggerActionSetLocation:init(is_server, volume_unit, parameters, trigger_action_name)
...
function TriggerActionSetLocation:local_on_activate(unit)
	TriggerActionSetLocation.super.local_on_activate(self, unit)
	self:_update_player_location(unit)
end

function TriggerActionSetLocation:_update_player_location(unit)
