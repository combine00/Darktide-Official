...
function MissionObjectiveTargetSystem:init(extension_system_creation_context, ...)
...
function MissionObjectiveTargetSystem:destroy(...)
	if not self._is_server then
...
function MissionObjectiveTargetSystem:hot_join_sync(sender, channel)
...
function MissionObjectiveTargetSystem:rpc_mission_objective_target_set_objective_name(channel, target_unit_id, target_unit_is_level_unit, objective_name_id)
	local unit_spawner_manager = Managers.state.unit_spawner
...
function MissionObjectiveTargetSystem:rpc_mission_objective_target_setup(channel, target_unit_id, target_unit_is_level_unit, objective_name_id, ui_target_type_id, objective_stage, add_marker_on_registration, add_marker_on_objective_start, enabled_only_during_mission)
	local unit_spawner_manager = Managers.state.unit_spawner
	local target_unit = unit_spawner_manager:unit(target_unit_id, target_unit_is_level_unit)
	local objective_name = NetworkLookup.mission_objective_names[objective_name_id]
