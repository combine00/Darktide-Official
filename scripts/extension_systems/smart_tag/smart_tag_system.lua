...
function SmartTagSystem:set_contextual_unit_tag(tagger_unit, target_unit, alternate)
	local target_extension = self._unit_extension_data[target_unit]
...
function SmartTagSystem:cancel_tag(tag_id, remover_unit, exernal_removal)
...
function SmartTagSystem:trigger_tag_interaction(tag_id, interactor_unit, target_unit)
	local all_tags = self._all_tags
...
function SmartTagSystem:unit_tagged_by_player_unit(player_unit)
