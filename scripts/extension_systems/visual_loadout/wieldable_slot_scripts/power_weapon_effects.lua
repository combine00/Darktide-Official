...
function PowerWeaponEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function PowerWeaponEffects:_play_single_sfx(sound_alias, fx_source_name)
...
function PowerWeaponEffects:_play_single_vfx(particle_alias, fx_source_name)
...
function PowerWeaponEffects:_start_vfx_loop()
...
function PowerWeaponEffects:_stop_vfx_loop(destroy)
...
function PowerWeaponEffects:_set_start_time()
...
function PowerWeaponEffects:_set_stop_time()
	local t = World.time(self._world)
	local variables_1p = self._weapon_material_variables_1p
	local variables_3p = self._weapon_material_variables_3p
