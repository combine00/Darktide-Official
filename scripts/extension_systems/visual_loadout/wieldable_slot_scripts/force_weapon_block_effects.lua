...
function ForceWeaponBlockEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function ForceWeaponBlockEffects:_update_sfx()
...
function ForceWeaponBlockEffects:_update_vfx()
...
function ForceWeaponBlockEffects:_destroy_vfx()
...
function ForceWeaponBlockEffects:_stop_sfx()
