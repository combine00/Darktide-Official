...
function RevolverBullets:update(unit, dt, t, frame)
	self:_update_ammo_count()
end

function RevolverBullets:update_first_person_mode(first_person_mode)
	self:_update_ammo_count(true)
end

function RevolverBullets:wield()
	self:_update_ammo_count(true)
end

function RevolverBullets:unwield()
	return
end

function RevolverBullets:destroy()
	return
end

function RevolverBullets:_update_ammo_count(force_update)
