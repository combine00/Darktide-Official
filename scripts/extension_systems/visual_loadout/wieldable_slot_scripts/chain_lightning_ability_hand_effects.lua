...
function ChainLightningAbilityHandEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function ChainLightningAbilityHandEffects:destroy()
...
function ChainLightningAbilityHandEffects:wield()
...
function ChainLightningAbilityHandEffects:unwield()
...
function ChainLightningAbilityHandEffects:update_unit_position(unit, dt, t)
	if DEDICATED_SERVER then
		return
	end
...
function ChainLightningAbilityHandEffects:update_first_person_mode(first_person_mode)
...
function ChainLightningAbilityHandEffects:_update_vfx(t)
...
function ChainLightningAbilityHandEffects:_update_cage_vfx(t, fx_hand)
...
function ChainLightningAbilityHandEffects:_update_charge_vfx(t)
	local action_settings = Action.current_action_settings_from_component(self._weapon_action_component, self._weapon_actions)
...
function ChainLightningAbilityHandEffects:_stop_cage_vfx()
	local world = self._world
...
function ChainLightningAbilityHandEffects:_stop_charge_vfx()
	local world = self._world
...
function ChainLightningAbilityHandEffects:_charge_level(t)
	local action_settings = Action.current_action_settings_from_component(self._weapon_action_component, self._weapon_actions)
	local charge_effects = action_settings and action_settings.charge_effects or self._weapon_template_charge_effects
