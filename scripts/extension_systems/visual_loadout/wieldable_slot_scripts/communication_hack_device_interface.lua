...
function CommunicationHackInterfaceDevice:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function CommunicationHackInterfaceDevice:destroy()
...
function CommunicationHackInterfaceDevice:unwield()
	if self._is_server then
		self._minigame_character_state_component.interface_level_unit_id = NetworkConstants.invalid_level_unit_id
		self._minigame_character_state_component.interface_game_object_id = NetworkConstants.invalid_game_object_id
		self._minigame_character_state_component.interface_is_level_unit = true
...
function CommunicationHackInterfaceDevice:fixed_update(unit, dt, t, frame)
...
function CommunicationHackInterfaceDevice:update(unit, dt, t)
	return
end

function CommunicationHackInterfaceDevice:update_first_person_mode(first_person_mode)
	return
end
