...
function ForceWeaponWindSlashActivationEffects:destroy()
...
function ForceWeaponWindSlashActivationEffects:wield()
...
function ForceWeaponWindSlashActivationEffects:unwield()
...
function ForceWeaponWindSlashActivationEffects:update_unit_position(unit, dt, t)
	if DEDICATED_SERVER then
		return
	end
...
function ForceWeaponWindSlashActivationEffects:update_first_person_mode(first_person_mode)
...
function ForceWeaponWindSlashActivationEffects:_update_vfx(t)
...
function ForceWeaponWindSlashActivationEffects:_update_cage_vfx(t, fx_hand)
...
function ForceWeaponWindSlashActivationEffects:_update_finger_vfx(t, fx_hand)
	local world = self._world
	local fx_extension = self._fx_extension
...
function ForceWeaponWindSlashActivationEffects:_stop_cage_vfx()
	local world = self._world
...
function ForceWeaponWindSlashActivationEffects:_stop_finger_vfx()
	local world = self._world
