...
function ForceStaffAoeTargetingEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function ForceStaffAoeTargetingEffects:_update_effect_positions(action_settings, position_finder_fx, decal_unit, effect_id, scaling_effect_id, scale_variable_index, source_id, parameter_name)
