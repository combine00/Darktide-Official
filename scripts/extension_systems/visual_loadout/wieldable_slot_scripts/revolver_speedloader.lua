...
function RevolverSpeedloader:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function RevolverSpeedloader:fixed_update(unit, dt, t)
	return
end

function RevolverSpeedloader:update(unit, dt, t, frame)
	self:_update_ammo_count(t, false)
end

function RevolverSpeedloader:update_first_person_mode(first_person_mode)
	self:_update_ammo_count(nil, true)
end

function RevolverSpeedloader:wield()
	self:_update_ammo_count(nil, true)
end

function RevolverSpeedloader:unwield()
	return
end

function RevolverSpeedloader:destroy()
	return
end

function RevolverSpeedloader:_update_ammo_count(t, force_update)
