...
function PlasmagunOverheatEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function PlasmagunOverheatEffects:_stop_sfx_loop(stage, force_stop)
	local wwise_world = self._wwise_world
	local sfx_source_id = self._fx_extension:sound_source(self._overheat_sfx_source_name)
	local current_playing_id = self._looping_playing_ids[stage]
...
function PlasmagunOverheatEffects:_stop_all_effects(force_stop)
	local sfx_source_id = self._fx_extension:sound_source(self._overheat_sfx_source_name)
