...
function AimProjectileEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function AimProjectileEffects:_event_update_aim_trajectory_enabled(value)
...
function AimProjectileEffects:_get_trajectory_data(integration_data, max_iterations, stop_on_impact, time_step_multiplier, max_number_of_bounces)
...
function AimProjectileEffects:_set_trajectory_positions_spline(aim_data, number_of_aim_data, arc_offset, total_distance, arc_distances, dt)
