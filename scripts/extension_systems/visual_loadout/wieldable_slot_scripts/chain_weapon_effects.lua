...
function ChainWeaponEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function ChainWeaponEffects:_play_single_sfx(sound_alias, fx_source_name)
