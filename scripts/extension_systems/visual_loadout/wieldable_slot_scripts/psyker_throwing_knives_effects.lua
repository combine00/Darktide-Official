...
function PsykerThrowingKnivesEffects:wield()
	Vo.play_combat_ability_event(self._owner_unit, "ability_gunslinger")
	self:_hide_all_ammo()
	self:_update_ammo_count(self._t)
end

function PsykerThrowingKnivesEffects:unwield()
	self:_hide_all_ammo()
end

function PsykerThrowingKnivesEffects:destroy()
	return
end

function PsykerThrowingKnivesEffects:_update_ammo_count(t)
...
function PsykerThrowingKnivesEffects:_hide_all_ammo()
...
function PsykerThrowingKnivesEffects:_create_passive_sfx()
...
function PsykerThrowingKnivesEffects:_destroy_passive_sfx()
