...
function WeaponTemperatureEffects:_update_overheat(unit, dt, t)
...
function WeaponTemperatureEffects:_update_temperature_parameter(action_settings, dt, t)
...
function WeaponTemperatureEffects:_start_sfx_loop()
...
function WeaponTemperatureEffects:_stop_sfx_loop()
	local wwise_world = self._wwise_world
	local sfx_source_id = self._fx_extension:sound_source(self._fx_source_name)
...
function WeaponTemperatureEffects:_update_wwise_source_parameter(parameter_value)
