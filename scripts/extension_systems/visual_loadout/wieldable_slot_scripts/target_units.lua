...
function TargetUnits:_update_outlines(validate_target_func)
...
function TargetUnits:_update_unit_outline(new_unit, old_unit, old_outline_name, validate_target_func)
...
function TargetUnits:_set_outline(unit, enabled, outline_name)
