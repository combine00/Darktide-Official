...
function ZealotRelicEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function ZealotRelicEffects:fixed_update(unit, dt, t)
	return
end

function ZealotRelicEffects:update(unit, dt, t, frame)
...
function ZealotRelicEffects:update_first_person_mode(first_person_mode)
	return
end

function ZealotRelicEffects:_on_channel_tick(t, action_settings)
...
function ZealotRelicEffects:_trigger_pulse_vfx(t, action_settings)
	self:_destroy_pulse_vfx()
...
function ZealotRelicEffects:_trigger_pulse_sfx(t, action_settings)
...
function ZealotRelicEffects:_destroy_pulse_vfx()
...
function ZealotRelicEffects:wield()
...
function ZealotRelicEffects:unwield()
...
function ZealotRelicEffects:destroy()
	self:_destroy_pulse_vfx()
	self:_destroy_passive_vfx()
	self:_destroy_passive_sfx()
end

function ZealotRelicEffects:_create_passive_vfx()
...
function ZealotRelicEffects:_destroy_passive_vfx()
...
function ZealotRelicEffects:_create_passive_sfx()
...
function ZealotRelicEffects:_destroy_passive_sfx()
