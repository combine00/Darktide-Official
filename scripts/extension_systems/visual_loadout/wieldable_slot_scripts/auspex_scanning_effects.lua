...
function AuspexScanningEffects:init(context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
...
function AuspexScanningEffects:_stop_scan_units_effects()
...
function AuspexScanningEffects:_set_scanner_light(enabled, scanner_light_components)
...
function AuspexScanningEffects:_set_scanner_lights(enabled, color)
