...
function PlayerUnitVisualLoadout.wield_slot(slot_to_wield, player_unit, t, skip_wield_action)
...
function PlayerUnitVisualLoadout.wield_previous_slot(inventory_component, unit, t)
...
function PlayerUnitVisualLoadout.wield_previous_weapon_slot(inventory_component, unit, t)
...
function PlayerUnitVisualLoadout.wield_slot_husk(unit, slot_to_wield, visual_loadout_extension, animation_extension)
	visual_loadout_extension:wield_slot(slot_to_wield)
...
function PlayerUnitVisualLoadout.unwield_slot_husk(slot_to_unwield, visual_loadout_extension)
	visual_loadout_extension:unwield_slot(slot_to_unwield)
end

function PlayerUnitVisualLoadout.slot_equipped(inventory_component, visual_loadout_extension, slot_name)
...
function PlayerUnitVisualLoadout.unequip_item_from_slot(player_unit, slot_name, t)
...
function PlayerUnitVisualLoadout.equip_item_to_slot(player_unit, item, slot_name, optional_existing_unit_3p, t)
	local inventory = ScriptUnit.extension(player_unit, "unit_data_system"):read_component("inventory")
	local visual_loadout_extension = ScriptUnit.extension(player_unit, "visual_loadout_system")
...
function PlayerUnitVisualLoadout.wielded_weapon_template(visual_loadout_extension, inventory_component)
...
function PlayerUnitVisualLoadout.has_wielded_weapon_keyword(visual_loadout_extension, inventory_component, keyword)
...
function PlayerUnitVisualLoadout.has_weapon_keyword_from_slot(visual_loadout_extension, slot_name, keyword)
...
function PlayerUnitVisualLoadout.slot_name_from_wield_input(wield_input, inventory_component, visual_loadout_extension, weapon_extension, ability_extension, input_extension)
...
function PlayerUnitVisualLoadout.wield_input_from_slot_name(slot_name)
...
function PlayerUnitVisualLoadout.slot_is_wieldable(visual_loadout_extension, slot_name)
...
function PlayerUnitVisualLoadout.wielded_slot_disallows_ladders(visual_loadout_extension, inventory_component)
...
function PlayerUnitVisualLoadout.slot_flow_event(first_person_extension, visual_loadout_extension, inventory_slot, flow_event_name)
...
function PlayerUnitVisualLoadout.slot_to_slot_type(slot)
...
function PlayerUnitVisualLoadout.is_slot_of_type(slot, slot_type)
...
function PlayerUnitVisualLoadout.slot_config_from_slot_name(slot_name)
