...
function WieldableSlotScripts._register_script(script_name, unit_1p, unit_3p, num_scripts)
	if script_name == "" then
		return num_scripts
	end
...
function WieldableSlotScripts.create(wieldable_slot_scripts_context, wieldable_slot_scripts, fx_sources, slot)
	local num_scripts = 0
	local root_unit_1p = slot.unit_1p
	local root_unit_3p = slot.unit_3p
...
function WieldableSlotScripts.server_correction_occurred(wieldable_slot_scripts_per_slot, unit, from_frame)
	for _, wieldable_slot_scripts in pairs(wieldable_slot_scripts_per_slot) do
		local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.fixed_update(wieldable_slot_scripts, unit, dt, t, frame)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.update_first_person_mode(wieldable_slot_scripts, first_person_mode)
	local num_scripts = #wieldable_slot_scripts
