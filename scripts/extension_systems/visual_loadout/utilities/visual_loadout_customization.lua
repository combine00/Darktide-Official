...
function VisualLoadoutCustomization.spawn_item(item_data, attach_settings, parent_unit, optional_map_attachment_name_to_unit, optional_extract_attachment_units_bind_poses, optional_extract_item_names, optional_mission_template, optional_equipment)
...
function VisualLoadoutCustomization.spawn_base_unit(item_data, attach_settings, parent_unit, optional_mission_template, optional_equipment)
	return _spawn_attachment(item_data, attach_settings, parent_unit, optional_mission_template, optional_equipment)
end

function VisualLoadoutCustomization._create_extract_data(map_attachment_units, map_bind_poses, map_item_names)
	local extract_data = {
		parents = {},
...
function VisualLoadoutCustomization._push_extract_data(extract_data, item_unit, item_name, attachment_key_or_nil)
...
function VisualLoadoutCustomization._pop_extract_data(extract_data, expected_parent)
	extract_data.parents[#extract_data.parents] = nil
end

function VisualLoadoutCustomization._fill_extract_data(extract_data, attachment_name, attachment_unit, bind_pose)
...
function VisualLoadoutCustomization.spawn_item_attachments(item_data, override_lookup, attach_settings, item_unit, optional_map_attachment_name_to_unit, optional_extract_attachment_units_bind_poses, optional_extract_item_names, optional_mission_template, optional_equipment)
...
function VisualLoadoutCustomization.attach_hierarchy(attachment_slot_data, override_lookup, settings, parent_unit, parent_item_name, attachment_name, optional_map_attachment_name_to_unit, optional_extract_attachment_units_bind_poses, optional_extract_item_names, optional_mission_template)
	local extract_data = VisualLoadoutCustomization._create_extract_data(optional_map_attachment_name_to_unit, optional_extract_attachment_units_bind_poses, optional_extract_item_names)
