...
function RespawnBeaconSystem:on_gameplay_post_init(level)
...
function RespawnBeaconSystem:_create_respawn_beacons()
	local main_path_manager = Managers.state.main_path
...
function RespawnBeaconSystem:_update_hogtied_players(side_id)
