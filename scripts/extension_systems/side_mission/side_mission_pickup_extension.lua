...
function SideMissionPickupExtension:init(extension_init_context, unit, extension_init_data)
	self:_register_to_mission_objective(unit)
end

function SideMissionPickupExtension:_register_to_mission_objective(unit)
