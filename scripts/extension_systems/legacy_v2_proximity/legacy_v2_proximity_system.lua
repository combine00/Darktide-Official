...
function LegacyV2ProximitySystem:init(extension_system_creation_context, ...)
...
function LegacyV2ProximitySystem:_update_nearby_minions(broadphase, broadphase_result)
...
function LegacyV2ProximitySystem:_process_distance_based_vo_query(broadphase, broadphase_result)
...
function LegacyV2ProximitySystem:_async_raycast_result_cb(id, hits, num_hits)
	local raycast_data = self._raycast_data
