...
function ForceFieldSystem:init(context, system_init_data, ...)
...
function ForceFieldSystem:destroy()
	return
end

function ForceFieldSystem:update(context, dt, t, ...)
...
function ForceFieldSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function ForceFieldSystem:on_remove_extension(removed_unit, extension_name)
	if self._is_server then
...
function ForceFieldSystem:get_extension_by_owner_unit(owner_unit)
	local unit_to_extension_map = self._unit_to_extension_map
...
function ForceFieldSystem:get_extensions_by_owner_unit(owner_unit)
	local extensions = {}
	local unit_to_extension_map = self._unit_to_extension_map
...
function ForceFieldSystem:get_extensions_by_owner_unit_keyword(keyword)
	local extensions = {}
	local unit_to_extension_map = self._unit_to_extension_map
...
function ForceFieldSystem:_check_unit_collisions(t)
	local unit_to_extension_map = self._unit_to_extension_map
...
function ForceFieldSystem:is_object_inside_force_field(position, radius, handle_height)
...
function ForceFieldSystem:hot_join_sync(sender, channel)
	return
end
