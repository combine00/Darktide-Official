...
function UnitCoherencyExtension:fixed_update(unit, dt, t)
...
function UnitCoherencyExtension:is_unit_in_coherency(unit_to_check)
...
function UnitCoherencyExtension:_get_valid_buff_owners(buff_id)
