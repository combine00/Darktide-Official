...
function CompanionCoherencyExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function CompanionCoherencyExtension:destroy()
	self._in_coherence_units = {}
	self._num_units_in_coherence = 0
...
function CompanionCoherencyExtension:update(unit, dt, t)
	return
end

function CompanionCoherencyExtension:fixed_update(unit, dt, t)
	return
end

function CompanionCoherencyExtension:in_coherence_units()
	return self._in_coherence_units
end

function CompanionCoherencyExtension:num_units_in_coherency()
	return self._num_units_in_coherence
end

function CompanionCoherencyExtension:_get_valid_buff_owners(buff_id)
...
function CompanionCoherencyExtension:add_external_buff(buff_name)
...
function CompanionCoherencyExtension:remove_external_buff(index)
	self._free_external_buff_indexes[index] = true
	self._external_buff_template_names[index] = nil
end

function CompanionCoherencyExtension:coherency_data()
	return self._coherency_data
end

function CompanionCoherencyExtension:coherency_settings()
...
function CompanionCoherencyExtension:buff_template_names()
	return self._coherency_settings.buff_template_names
end

function CompanionCoherencyExtension:external_buff_template_names()
	return self._external_buff_template_names
end

function CompanionCoherencyExtension:base_radius()
	return self._coherency_settings.radius, self._coherency_settings.stickiness_limit
end

function CompanionCoherencyExtension:current_radius()
	local modifier = 1
...
function CompanionCoherencyExtension:current_stickiness_time()
...
function CompanionCoherencyExtension:hot_join_sync(unit, sender, channel_id)
	return
end

function CompanionCoherencyExtension:on_coherency_enter(coherency_unit, coherency_extension, t)
...
function CompanionCoherencyExtension:on_coherency_exit(coherency_unit, coherency_extension, t)
	self._num_units_in_coherence = self._num_units_in_coherence - 1
	self._in_coherence_units[coherency_unit] = nil
end

function CompanionCoherencyExtension:update_buffs_for_unit(unit, extension)
	return
end

function CompanionCoherencyExtension:_send_rpc(rpc_name, other_unit)
