...
function FirstPersonRunSpeedAnimationControl:init(first_person_unit, unit)
...
function FirstPersonRunSpeedAnimationControl:update(dt, t)
...
function FirstPersonRunSpeedAnimationControl:_max_movement_speed(is_sprinting, move_method)
...
function FirstPersonRunSpeedAnimationControl:_target_speed_scale(current_speed_scale)
