...
function CommunicationWheelPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier, rotation_contraints)
...
function CommunicationWheelPlayerOrientation:orientation_offset()
