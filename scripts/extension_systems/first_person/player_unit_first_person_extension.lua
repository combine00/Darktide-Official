...
function PlayerUnitFirstPersonExtension:set_wanted_player_height(state, time_to_change, height_change_function)
...
function PlayerUnitFirstPersonExtension:reset_height_change(time_to_change, height_change_function)
	local fp_component = self._first_person_component
