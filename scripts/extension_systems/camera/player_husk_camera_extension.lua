...
function PlayerHuskCameraExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
	self._unit = unit
...
function PlayerHuskCameraExtension:camera_tree_node()
...
function PlayerHuskCameraExtension:trigger_camera_shake(event_name)
