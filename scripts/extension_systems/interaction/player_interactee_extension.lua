...
function PlayerInteracteeExtension:interaction_input()
	local unit_has_context = self._unit_has_context
...
function PlayerInteracteeExtension:interaction_priority()
	local unit_has_context = self._unit_has_context
...
function PlayerInteracteeExtension:block_text(interactor_unit)
	local unit_has_context = self._unit_has_context
