...
function LuggableSocketInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function LuggableSocketInteraction:stop(world, interactor_unit, unit_data_component, t, result, is_server)
...
function LuggableSocketInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
