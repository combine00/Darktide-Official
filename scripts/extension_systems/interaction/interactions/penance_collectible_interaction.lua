...
function PenanceCollectibleInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function PenanceCollectibleInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function PenanceCollectibleInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
