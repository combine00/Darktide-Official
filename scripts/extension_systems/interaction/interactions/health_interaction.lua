...
function HealthInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function HealthInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function HealthInteraction:_heal(interactor_unit, target_unit)
	local health_extension = ScriptUnit.extension(interactor_unit, "health_system")
