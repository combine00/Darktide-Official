...
function LuggableInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function LuggableInteraction:stop(world, interactor_unit, unit_data_component, t, result, is_server)
