...
function CompanionHubInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function CompanionHubInteraction:_start(interactor_unit, interactee_unit)
	Managers.state.companion_interaction:trigger_interaction(interactor_unit, interactee_unit)
end

function CompanionHubInteraction:_is_blocked(interactor_unit, interactee_unit)
...
function CompanionHubInteraction:interactor_condition_func(interactor_unit, interactee_unit)
