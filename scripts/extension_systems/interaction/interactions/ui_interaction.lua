...
function UIInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function UIInteraction:_start(interactor_unit, interactee_unit)
	return
end

function UIInteraction:_is_blocked(interactor_unit, interactee_unit)
...
function UIInteraction:hud_block_text(interactor_unit, interactee_unit, target_node)
...
function UIInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
