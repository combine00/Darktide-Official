...
function AssistBaseInteraction:start(world, interactor_unit, unit_data_component, t, is_server)
...
function AssistBaseInteraction:_handle_buffs(interactor_unit, target_unit, proc_event)
...
function AssistBaseInteraction:_record_stats_and_telemetry(interactor_unit, target_unit, stat_id, from_state_name)
