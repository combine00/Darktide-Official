...
function PlayerSuppressionExtension:rpc_player_suppressed(channel_id, unit_id, num_suppression_hits)
	self._num_suppression_hits = num_suppression_hits
	self._next_suppression_hit_clear_time = _add_to_clear_time(num_suppression_hits)
end

function PlayerSuppressionExtension:num_suppression_hits()
	return self._num_suppression_hits
end

function PlayerSuppressionExtension:has_suppression()
	return self._num_suppression_hits > 0
end

function PlayerSuppressionExtension:has_low_suppression()
	return NUM_HITS_FOR_LOW_SUPPRESSION <= self._num_suppression_hits
end

function PlayerSuppressionExtension:has_high_suppression()
	return NUM_HITS_FOR_HIGH_SUPPRESSION <= self._num_suppression_hits
end

function PlayerSuppressionExtension:max_suppression()
