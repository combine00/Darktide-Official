...
function MinionSuppressionExtension:add_suppression_immunity_duration(duration)
	local t = Managers.time:time("gameplay")
...
function MinionSuppressionExtension:suppress_value()
	local suppression_component = self._suppression_component
...
function MinionSuppressionExtension:apply_suppression_decay_delay(decay_delay)
