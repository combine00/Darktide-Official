...
function PickupAnimationSystem:init(context, system_init_data, ...)
...
function PickupAnimationSystem:start_animation_to_unit(pickup_unit, destination_unit)
...
function PickupAnimationSystem:start_animation_from_unit(pickup_unit, from_unit)
	local pickup_animation_extension = self._unit_to_extension_map[pickup_unit]
...
function PickupAnimationSystem:rpc_start_pickup_animation(channel_id, pickup_id, pickup_is_level_unit, end_id, end_is_level_unit)
	local unit_spawner_manager = Managers.state.unit_spawner
...
function PickupAnimationSystem:rpc_start_place_animation(channel_id, pickup_id, pickup_is_level_unit, end_id, end_is_level_unit)
	local unit_spawner_manager = Managers.state.unit_spawner
	local pickup_unit = unit_spawner_manager:unit(pickup_id, pickup_is_level_unit)
	local end_unit = unit_spawner_manager:unit(end_id, end_is_level_unit)
	local pickup_animation_extension = self._unit_to_extension_map[pickup_unit]
...
function PickupAnimationSystem:destroy()
