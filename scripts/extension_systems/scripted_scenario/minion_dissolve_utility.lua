...
function MinionDissolveUtility.start_dissolve(unit, t, reverted)
	local dissolve_data = {}
	local duration = 1.15
...
function MinionDissolveUtility.update_dissolve(unit, dissolve_data, t)
...
function MinionDissolveUtility.inherit_progress(old_dissolve_data, new_dissolve_data, t)
