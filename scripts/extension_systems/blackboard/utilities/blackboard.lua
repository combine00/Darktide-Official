...
function Blackboard.validate(blackboard)
...
function Blackboard.write_component(blackboard, component_name)
	return blackboard[component_name]
end

function Blackboard.component_config(blackboard)
	return blackboard.__config
end

function Blackboard.has_component(blackboard, component_name)
