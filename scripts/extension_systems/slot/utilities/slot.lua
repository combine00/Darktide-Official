...
function Slot.update_target_slots_status(target_unit, target_units, unit_extension_data, nav_world, traverse_logic, outside_navmesh)
	local target_unit_extension = unit_extension_data[target_unit]
	local all_slots = target_unit_extension.all_slots
...
function Slot.update_target_slots_positions(target_unit, target_units, unit_extension_data, should_offset_slot, nav_world, traverse_logic, is_on_ladder, ladder_unit, bottom, top, target_outside_navmesh)
	local target_unit_extension = unit_extension_data[target_unit]
...
function Slot.find_best_slot(target_unit, user_unit, unit_extension_data)
	local user_unit_position = POSITION_LOOKUP[user_unit]
	local user_unit_extension = unit_extension_data[user_unit]
	local target_unit_extension = unit_extension_data[target_unit]
...
function Slot.find_best_slot_to_wait_on(target_unit, user_unit, unit_extension_data)
	local user_unit_extension = unit_extension_data[user_unit]
	local waiting_on_slot = user_unit_extension.wait_slot
	local target_unit_extension = unit_extension_data[target_unit]
	local slot_type = user_unit_extension.use_slot_type
...
function Slot.update_slot_sound(target_units, unit_extension_data)
