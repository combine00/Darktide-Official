...
function PlayerUnitMoodExtension:remove_all_moods()
	local moods_data = self._moods_data
...
function PlayerUnitMoodExtension:remove_mood(t, mood_type)
	self:_remove_mood(t, mood_type)
...
function PlayerUnitMoodExtension:rpc_remove_mood(channel_id, go_id, mood_type_id)
	local mood_type = NetworkLookup.moods_types[mood_type_id]
	local t = Managers.time:time("gameplay")
