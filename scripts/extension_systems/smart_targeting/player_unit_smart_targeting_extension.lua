...
function PlayerUnitSmartTargetingExtension:fixed_update(unit, dt, t, fixed_frame)
...
function PlayerUnitSmartTargetingExtension:_update_precision_target(unit, smart_targeting_template, ray_origin, forward, right, up, targeting_data, fixed_frame, optional_line_of_sight_cache)
...
function PlayerUnitSmartTargetingExtension:_target_visibility_and_aim_position(ray_origin, forward, right, up, hit_unit_center_pos, distance_to_center_pos, half_width, half_height, x_diff_no_abs, hit_unit, fixed_frame, visibility_cache, visibility_check_frame)
...
function PlayerUnitSmartTargetingExtension:has_line_of_sight(unit)
