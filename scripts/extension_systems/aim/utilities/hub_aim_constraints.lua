...
function HubAimConstraints:init(unit, init_context)
	self._unit = unit
...
function HubAimConstraints:is_moving()
...
function HubAimConstraints:update(head_direction, torso_direction, is_moving, aim_state, dt, t)
...
function HubAimConstraints:_get_aim_weight(aim_state, target_name)
...
function HubAimConstraints:_update_aim_weight(unit, current_weight, target_weight, dt, target_name, anim_variable_id)
...
function HubAimConstraints:_goal_speeds(is_moving, is_passive)
...
function HubAimConstraints:_target_goal_positions(unit_pose, head_direction, torso_direction)
...
function HubAimConstraints:_update_speeds(dt, head_goal_speed, torso_goal_speed, is_passive)
...
function HubAimConstraints:_lerp_target(unit, unit_forward, unit_right, source_pos, target_pos, lerp_t, target_name, target, is_passive, is_moving)
