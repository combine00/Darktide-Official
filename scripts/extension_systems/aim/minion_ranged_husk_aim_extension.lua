...
function MinionRangedHuskAimExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id)
...
function MinionRangedHuskAimExtension:update(unit, dt, t)
