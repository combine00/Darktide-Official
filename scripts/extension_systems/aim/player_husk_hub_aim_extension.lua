...
function PlayerHuskHubAimExtension:init(extension_init_context, unit, extension_init_data, game_session_id, game_object_id, owner_id)
...
function PlayerHuskHubAimExtension:state_machine_changed(unit)
	self._hub_aim_constraints = HubAimConstraints:new(unit, self._init_context)
end

function PlayerHuskHubAimExtension:update(unit, dt, t)
