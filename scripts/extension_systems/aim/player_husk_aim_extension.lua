...
function PlayerHuskAimExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id, owner_id)
...
function PlayerHuskAimExtension:state_machine_changed(unit)
...
function PlayerHuskAimExtension:update(unit, dt, t)
