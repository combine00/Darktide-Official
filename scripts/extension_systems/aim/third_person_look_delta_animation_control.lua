...
function ThirdPersonLookDeltaAnimationControl:init(unit)
...
function ThirdPersonLookDeltaAnimationControl:state_machine_changed(unit)
...
function ThirdPersonLookDeltaAnimationControl:update(dt, t, game_object_id)
