...
function MinionDissolveExtension:init(extension_init_context, unit, extension_init_data, ...)
	self._unit = unit
...
function MinionDissolveExtension:set_unit_local()
...
function MinionDissolveExtension:update(unit, dt, t)
...
function MinionDissolveExtension:_dissolve(delay, t)
...
function MinionDissolveExtension:register_stump_unit(stump_unit)
