...
function FxSystem:has_running_global_effect_id(global_effect_id)
	local template_effects = self._template_effects
	local buffer_index = global_effect_id % self._max_num_template_effects + 1
	local template_effect = template_effects[buffer_index]
...
function FxSystem:play_impact_fx(impact_fx, position, direction, source_parameters, attacking_unit, optional_target_unit, optional_node_index, optional_hit_normal, optional_will_be_predicted, local_only_or_nil)
...
function FxSystem:play_surface_impact_fx(hit_position, hit_direction, source_parameters, attacking_unit, optional_hit_normal, damage_type, hit_type, optional_will_be_predicted)
	if self._is_server then
		local attacking_unit_id = Managers.state.unit_spawner:game_object_id(attacking_unit)
...
function FxSystem:play_shotshell_surface_impact_fx(fire_position, hit_positions, hit_normals, source_parameters, attacking_unit, damage_type, hit_type, optional_will_be_predicted)
	if self._is_server then
		local attacking_unit_id = Managers.state.unit_spawner:game_object_id(attacking_unit)
...
function FxSystem:trigger_wwise_event(event_name, optional_position, optional_unit, optional_node, optional_parameter_name, optional_parameter_value, optional_ambisonics)
	local wwise_world = self._wwise_world
	local source_id = nil
...
function FxSystem:_delete_units_belonging_to_particle_group(particle_group_id)
	local spawned_impact_fx_units = self._spawned_impact_fx_units
...
function FxSystem:rpc_play_impact_fx(channel_id, impact_fx_name_id, position, direction, attacking_unit_id, optional_target_unit_id, optional_node_index, optional_hit_normal, attacking_unit_has_particle_group)
...
function FxSystem:rpc_play_surface_impact_fx(channel_id, hit_position, hit_direction, attacking_unit_id, optional_hit_normal, damage_type_id, hit_type_id, attacking_unit_has_particle_group)
	local attacking_unit = Managers.state.unit_spawner:unit(attacking_unit_id)
...
function FxSystem:rpc_play_shotshell_surface_impact_fx(channel_id, fire_position, hit_positions, hit_normals, attacking_unit_id, damage_type_id, hit_type_id, attacking_unit_has_particle_group)
	local attacking_unit = Managers.state.unit_spawner:unit(attacking_unit_id)
...
function FxSystem:rpc_trigger_wwise_event(channel_id, event_id, optional_position, optional_unit_id, optional_node, optional_parameter_id, optional_parameter_value, optional_ambisonics)
