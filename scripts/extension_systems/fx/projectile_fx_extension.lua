...
function ProjectileFxExtension:fixed_update(unit, dt, t, fixed_frame)
	return
end
...
function ProjectileFxExtension:on_impact(hit_position, hit_unit, hit_direction, hit_normal, current_speed)
...
function ProjectileFxExtension:hot_join_sync(unit, sender, channel_id)
	local effects = self._effects
