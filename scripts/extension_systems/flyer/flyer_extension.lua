...
function FlyerExtension:init(extension_init_context, unit, extension_init_data, ...)
	self._unit = unit
...
function FlyerExtension:setup_from_component(start_free_flight_enabled)
...
function FlyerExtension:set_active(active)
	self._active = active
end

function FlyerExtension:get_target_player()
...
function FlyerExtension:update(unit, dt, t)
