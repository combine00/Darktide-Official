...
function Side:init(definition, side_id)
...
function Side:_create_tag_tables()
	local list = {}
	local list_lookup = {}
...
function Side:_create_relation_tables()
...
function Side:set_relation(relation, sides)
...
function Side:add_unit(unit, side_extension)
...
function Side:remove_unit(unit, side_extension)
	local units_lookup = self.units_lookup
...
function Side:add_relation_unit(unit, side_extension, relation)
...
function Side:remove_relation_unit(unit, side_extension, relation)
	local units_lookup = self._relation_units_lookup[relation]
...
function Side:add_tag_unit(unit, side_extension, relation)
...
function Side:remove_tag_unit(unit, side_extension, relation)
	local units_by_tag = self.units_by_relation_tag[relation]
	local units_by_tag_lookup = self.units_by_relation_tag_lookup[relation]
...
function Side:added_player_units()
	return self._added_player_units
end

function Side:relation_side_names(relation)
	return self._relation_side_names[relation]
end

function Side:relation_sides(relation)
	return self._relation_sides[relation]
end

function Side:relation_units(relation)
	return self._relation_units[relation]
end

function Side:relation_player_units(relation)
	return self._relation_player_units[relation]
end

function Side:alive_units_by_tag(relation, tag)
