...
function PlayerUnitAbilityExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
	self._unit = unit
...
function PlayerUnitAbilityExtension:_init_sync_data(game_object_data)
...
function PlayerUnitAbilityExtension:game_object_initialized(session, object_id)
...
function PlayerUnitAbilityExtension:_handle_sync()
...
function PlayerUnitAbilityExtension:charge_replenished(ability_type)
	return self._charge_replenished[ability_type]
end

function PlayerUnitAbilityExtension:_update_ability_cooldowns(t, dt)
...
function PlayerUnitAbilityExtension:can_be_scroll_wielded(slot_name)
...
function PlayerUnitAbilityExtension:is_cooldown_paused(ability_type)
	local enabled = self:ability_enabled(ability_type)
...
function PlayerUnitAbilityExtension:use_ability_charge(ability_type, optional_num_charges)
	local ability_components = self._ability_components
	local component = ability_components[ability_type]
	local equipped_abilities_component = self._equipped_abilities_component
...
function PlayerUnitAbilityExtension:running_action_settings()
...
function PlayerUnitAbilityExtension:get_current_ability_cooldown_time()
	return self._combat_ability_max_cooldown_sync_value
end

function PlayerUnitAbilityExtension:get_current_ability_name()
