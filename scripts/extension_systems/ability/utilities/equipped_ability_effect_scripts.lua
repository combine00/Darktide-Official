...
local EquippedAbilityEffectScripts = {
	create = function (equipped_ability_effect_scripts_context, equipped_ability_effect_scripts, ability_template, ability_type)
...
function EquippedAbilityEffectScripts.extensions_ready(equipped_ability_effect_scripts, world, unit)
...
function EquippedAbilityEffectScripts.destroy(equipped_ability_effect_scripts)
	local num_scripts = #equipped_ability_effect_scripts
...
function EquippedAbilityEffectScripts.update(equipped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equipped_ability_effect_scripts
...
function EquippedAbilityEffectScripts.fixed_update(equipped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equipped_ability_effect_scripts
...
function EquippedAbilityEffectScripts.post_update(equipped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equipped_ability_effect_scripts
