...
local _handle_enemy_targets, _handle_allied_targets = nil
local broadphase_results = {}

function ShoutAbilityImplementation.execute(radius, shout_target_template_name, player_unit, t, locomotion_component, shout_direction, backup_position, backup_rotation)
...
function _handle_enemy_targets(t, radius, target_settings, player_unit, locomotion_component, player_side, player_buff_extension, backup_position, backup_rotation)
	...
	local num_hits = broadphase:query(player_position, radius_to_use, broadphase_results, enemy_side_names, MINION_BREED_TYPE)
...
function _handle_allied_targets(t, radius, target_settings, player_unit, locomotion_component, player_side, player_buff_extension, backup_position, backup_rotation)
	...
	if revive_allies and talent_extension then
		...
		local num_hits = broadphase:query(player_position, radius_to_use, broadphase_results, allied_side_names, PLAYER_BREED_TYPE)
