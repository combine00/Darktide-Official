...
function ActionAbilityTargetFinder:init(action_context, action_params, action_settings)
...
function ActionAbilityTargetFinder:start(action_settings, t, time_scale, action_start_params)
...
function ActionAbilityTargetFinder:fixed_update(dt, t, time_in_action)
...
function ActionAbilityTargetFinder:finish(reason, data, t, time_in_action)
