...
function ActionPsykerShout:_handle_enemies(action_settings, side, t, talent_extension)
...
function ActionPsykerShout:_handle_allies(action_settings, side, t, talent_extension)
	...
	if shout_shape and shout_shape == "cone" then
		...
		while total_range > 0 do
			...
			local num_hits = broadphase:query(position, slice_radius, broadphase_results, ally_side_name)
			total_num_hits = total_num_hits + num_hits
