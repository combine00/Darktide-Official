...
function ActionAdamantShout:init(action_context, action_params, action_settings)
...
function ActionAdamantShout:start(action_settings, t, time_scale, action_start_params)
...
function ActionAdamantShout:finish(reason, data, t, time_in_action, action_settings)
