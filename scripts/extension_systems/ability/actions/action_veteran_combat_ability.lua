...
function ActionVeteranCombatAbility:init(action_context, action_params, action_settings)
...
function ActionVeteranCombatAbility:start(action_settings, t, time_scale, action_start_params)
...
function ActionVeteranCombatAbility:finish(reason, data, t, time_in_action, action_settings)
