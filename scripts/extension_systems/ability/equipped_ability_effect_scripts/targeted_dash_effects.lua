...
function TargetedDashEffects:init(equipped_ability_effect_scripts_context, ability_template)
...
function TargetedDashEffects:_update_effect_positions(target_position)
