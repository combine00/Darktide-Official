...
function ShoutEffects:init(context, ability_template)
...
function ShoutEffects:extensions_ready(world, unit)
...
function ShoutEffects:_update_aim_shout(unit, dt, t)
...
function ShoutEffects:_spawn_aim_shout_effects(radius, unit)
...
function ShoutEffects:_destroy_aim_shout_effects(unit)
...
function ShoutEffects:_update_aim_shout_effect_positions(target_position)
...
function ShoutEffects:_update_active_shout(unit, dt, t)
...
function ShoutEffects:_spawn_active_shout_effects(unit)
	local combat_ability_action_component = self._combat_ability_action_component
	local ability_template = AbilityTemplate.current_ability_template(combat_ability_action_component)
	local _, current_action_settings = Action.current_action(combat_ability_action_component, ability_template)
	local radius = current_action_settings and current_action_settings.radius or DEFAULT_RADIUS
...
function ShoutEffects:_update_active_shout_effect_positions(target_position)
