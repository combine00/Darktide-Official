...
function CombatVectorSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function CombatVectorSystem:on_remove_extension(unit, extension_name)
	if extension_name == "CombatVectorUserExtension" then
		local current_update_unit = self._current_update_unit
		local unit_extension_data = self._unit_extension_data
...
function CombatVectorSystem:get_from_position()
...
function CombatVectorSystem:set_last_known_position(unit, position)
...
function CombatVectorSystem:num_aggroed_combat_vector_minions()
