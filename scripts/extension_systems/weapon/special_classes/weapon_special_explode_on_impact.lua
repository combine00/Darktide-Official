...
function WeaponSpecialExplodeOnImpact:process_hit(t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, damage, result, damage_efficiency, stagger_result, hit_position, attack_direction, abort_attack, optional_origin_slot)
...
function WeaponSpecialExplodeOnImpact:on_special_deactivation(t)
	return
end

function WeaponSpecialExplodeOnImpact:on_sweep_action_start(t)
	return
end

function WeaponSpecialExplodeOnImpact:on_sweep_action_finish(t, num_hit_enemies)
