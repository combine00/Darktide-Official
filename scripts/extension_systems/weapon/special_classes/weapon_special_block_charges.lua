...
function WeaponSpecialBlockCharges:init(context, init_data)
...
function WeaponSpecialBlockCharges:on_wieldable_slot_equipped()
	return
end

function WeaponSpecialBlockCharges:fixed_update(dt, t)
...
function WeaponSpecialBlockCharges:on_special_activation(t)
	return
end

function WeaponSpecialBlockCharges:on_special_deactivation(t)
	return
end

function WeaponSpecialBlockCharges:on_sweep_action_start(t)
	return
end

function WeaponSpecialBlockCharges:on_sweep_action_finish(t, num_hit_enemies)
	return
end

function WeaponSpecialBlockCharges:process_hit(t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, damage, result, damage_efficiency, stagger_result, hit_position, attack_direction, abort_attack, optional_origin_slot)
	return
end

function WeaponSpecialBlockCharges:blocked_attack(attacking_unit, block_cost, block_broken, is_perfect_block)
...
function WeaponSpecialBlockCharges:on_exit_damage_window(t, num_hit_enemies, aborted)
	return
end
