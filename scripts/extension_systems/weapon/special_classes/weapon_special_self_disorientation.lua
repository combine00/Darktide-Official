...
function WeaponSpecialSelfDisorientation:process_hit(t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, hit_position, attack_direction, abort_attack, optional_origin_slot)
...
function WeaponSpecialSelfDisorientation:trigger_anim_event(anim_event, anim_event_3p, action_time_offset, ...)
