...
function WeaponSpecialSelfDisorientation:on_wieldable_slot_equipped()
	return
end

function WeaponSpecialSelfDisorientation:fixed_update(dt, t)
...
function WeaponSpecialSelfDisorientation:on_special_activation(t)
	return
end

function WeaponSpecialSelfDisorientation:on_special_deactivation(t)
	return
end

function WeaponSpecialSelfDisorientation:on_sweep_action_start(t)
	return
end

function WeaponSpecialSelfDisorientation:on_sweep_action_finish(t, num_hit_enemies)
...
function WeaponSpecialSelfDisorientation:process_hit(t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, damage, result, damage_efficiency, stagger_result, hit_position, attack_direction, abort_attack, optional_origin_slot)
...
function WeaponSpecialSelfDisorientation:blocked_attack(attacking_unit, block_cost, block_broken, is_perfect_block)
	return
end
...
function WeaponSpecialSelfDisorientation:_trigger_anim_event(anim_event, anim_event_3p, action_time_offset, ...)
