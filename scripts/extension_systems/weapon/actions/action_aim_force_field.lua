...
function ActionAimForceField:init(action_context, ...)
...
function ActionAimForceField:fixed_update(dt, t)
...
function ActionAimForceField:finish(reason, data, t, time_in_action)
	self._action_component.aiming_place = false
end

function ActionAimForceField:_rotate(position, rotation, place_configuration)
