...
local _find_frame, _apply_reference_context, _damage_window_frames, _build_matrix = nil

function SweepSplineExported:init(action_settings, matrices_data_location, anchor_point_offset)
...
function SweepSplineExported:position_and_rotation(t, reference_position, reference_rotation)
...
function SweepSplineExported:rebuild(action_settings)
	self._action_settings = action_settings

	self:_build(action_settings)
end

function SweepSplineExported:_build(action_settings)
