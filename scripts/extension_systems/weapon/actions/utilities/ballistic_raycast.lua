...
function BallisticRaycast.cast(physics_world, collision_filter, first_person_component, optional_max_steps, optional_max_time, optional_speed, optional_angle, optional_gravity)
