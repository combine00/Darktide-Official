...
function SweepSplineVisualizer.draw_splines(sweep_spline, drawer, time, combined_spline, control_splines, color, reference_position, reference_rotation)
...
function SweepSplineVisualizer.draw_point_on_spline(sweep_spline, drawer, t, show_rotation, color, reference_position, reference_rotation)
