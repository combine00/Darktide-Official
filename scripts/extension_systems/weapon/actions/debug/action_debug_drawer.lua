...
function ActionDebugDrawer:draw(has_running_action)
...
function ActionDebugDrawer:_draw_action_name(gui, anchor_position, has_running_action)
...
function ActionDebugDrawer:_draw_single_chain_action(action_timeline, time_scale, chain_action_index, chain_action, gui, anchor_position, anchor_size, extra_background_y_size, action_available)
