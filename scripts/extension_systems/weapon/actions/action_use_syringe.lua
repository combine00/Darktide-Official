...
function ActionUseSyringe:init(action_context, action_params, action_settings)
...
function ActionUseSyringe:start(action_settings, t, time_scale, action_start_params)
...
function ActionUseSyringe:finish(reason, data, t, time_in_action)
...
function ActionUseSyringe:fixed_update(dt, t, time_in_action)
...
function ActionUseSyringe:_play_hit_react_anim(action_settings, target_unit)
...
function ActionUseSyringe:_target_unit()
	local action_settings = self._action_settings
	local action_module_targeting_component = self._action_module_targeting_component
...
function ActionUseSyringe:_report_use_to_stat_system(target)
	local syringe_data = {}
	local action_settings = self._action_settings
	local player = Managers.player:player_by_unit(self._player_unit)
