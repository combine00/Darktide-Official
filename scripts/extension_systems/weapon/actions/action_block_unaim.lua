...
function ActionBlockUnaim:init(action_context, action_params, action_settings)
...
function ActionBlockUnaim:start(action_settings, t, ...)
...
function ActionBlockUnaim:finish(reason, data, t, time_in_action)
