...
function ActionFlamerGas:_is_unit_blocking(unit, player_pos, hit_zone_name_or_nil)
...
function ActionFlamerGas:_damage_targets(dt, t, force_damage)
...
function ActionFlamerGas:_burn_targets(dt, t, force_burn)
	local player_unit = self._player_unit
	local weapon_item = self._weapon.item
