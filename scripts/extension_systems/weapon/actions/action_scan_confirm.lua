...
function ActionScanConfirm:init(action_context, action_params, action_settings)
...
function ActionScanConfirm:start(action_settings, ...)
...
function ActionScanConfirm:fixed_update(dt, t, time_in_action)
	local scanning_compomnent = self._scanning_compomnent
...
function ActionScanConfirm:finish(reason, data, t, time_in_action)
...
function ActionScanConfirm:running_action_state(t, time_in_action)
...
function ActionScanConfirm:_check_line_of_sight()
	local scan_settings = self._action_settings.scan_settings
	local first_person_component = self._first_person_component
	local scanning_compomnent = self._scanning_compomnent
...
function ActionScanConfirm:_bank_scannable_unit()
	local scanning_compomnent = self._scanning_compomnent
...
function ActionScanConfirm:_has_valid_target()
	local scanning_compomnent = self._scanning_compomnent
...
function ActionScanConfirm:_completed_scanning(t, time_in_action)
	local has_valid_target = self:_has_valid_target()
