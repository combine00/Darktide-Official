...
local ActionPositionFinder = class("ActionPositionFinder", "ActionWeaponBase")

function ActionPositionFinder:init(action_context, action_params, action_settings)
	ActionPositionFinder.super.init(self, action_context, action_params, action_settings)
	...
	self._position_finder_module = ActionModules[position_finder_module_class_name]:new(self._is_server, self._physics_world, player_unit, position_finder_component, action_settings)
...
function ActionPositionFinder:start(action_settings, t, time_scale, action_start_params)
	ActionPositionFinder.super.start(self, action_settings, t, time_scale, action_start_params)
...
function ActionPositionFinder:fixed_update(dt, t, time_in_action)
	self._position_finder_module:fixed_update(dt, t)
end

function ActionPositionFinder:finish(reason, data, t, time_in_action)
	ActionPositionFinder.super.finish(self, reason, data, t, time_in_action)
