...
function RaycastTargetingActionModule:init(is_server, physics_world, player_unit, component, action_settings)
...
function RaycastTargetingActionModule:start(action_settings, t)
...
function RaycastTargetingActionModule:fixed_update(dt, t)
	local component = self._component
...
function RaycastTargetingActionModule:finish(reason, data, t)
