...
function DroneTargetPositionFinderActionModule:init(is_server, physics_world, player_unit, position_finder_component, action_settings)
...
function DroneTargetPositionFinderActionModule:start(action_settings, t)
...
function DroneTargetPositionFinderActionModule:finish(reason, data, t)
