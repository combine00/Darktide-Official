...
function AdamantWhistleTargetingActionModule:init(is_server, physics_world, player_unit, component, action_settings)
...
function AdamantWhistleTargetingActionModule:start(action_settings, t)
...
function AdamantWhistleTargetingActionModule:fixed_update(dt, t)
...
function AdamantWhistleTargetingActionModule:finish(reason, data, t)
