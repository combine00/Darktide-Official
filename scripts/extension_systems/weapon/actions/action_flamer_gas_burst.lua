...
function ActionFlamerGasBurst:fixed_update(dt, t, time_in_action, frame)
...
function ActionFlamerGasBurst:_process_hit(hit, targets, target_actors, player_unit, player_pos, side_system, dot_targets, t, is_server)
...
function ActionFlamerGasBurst:_do_raycast(i, position, rotation, max_range, num_rays_this_frame, spread_angle, targets, target_actors, player_unit, player_pos, side_system, dot_targets, t, is_server)
	local bullseye = true
...
function ActionFlamerGasBurst:_damage_and_burn_targets(t, force_trigger)
	local targets = self._targets
	local target_actors = self._target_actors
	local ALIVE = ALIVE
