...
function ActionWeaponBase:_check_for_lucky_strike(is_melee, is_ranged, chance)
	local wielded_slot = self._inventory_component.wielded_slot
...
function ActionWeaponBase:_add_weapon_blood(target_unit, amount)
...
function ActionWeaponBase:_start_warp_charge_action(t)
...
function ActionWeaponBase:_pay_warp_charge_cost_immediate(t, charge_level, ignore_clients)
	local charge_template = self._weapon_extension:charge_template()
...
function ActionWeaponBase:_pay_warp_charge_cost_over_time(dt, t, charge_level, ignore_clients, first_charge)
	local charge_template = self._weapon_extension:charge_template()
