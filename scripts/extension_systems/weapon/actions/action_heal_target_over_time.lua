...
function ActionHealTargetOverTime:init(action_context, action_params, action_settings)
...
function ActionHealTargetOverTime:start(action_settings, t, time_scale, action_start_params)
...
function ActionHealTargetOverTime:fixed_update(dt, t, time_in_action)
...
function ActionHealTargetOverTime:finish(reason, data, t, time_in_action)
