...
function ActionGivePocketable:init(action_context, action_params, action_setting)
...
function ActionGivePocketable:start(action_settings, t, time_scale, action_start_params)
	ActionGivePocketable.super.start(self, action_settings, t, time_scale, action_start_params)
end

local external_properties = {}

function ActionGivePocketable:fixed_update(dt, t, time_in_action)
...
function ActionGivePocketable:finish(reason, data, t, time_in_action)
