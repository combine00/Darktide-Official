...
function ActionOverloadChargeWeaponSpecial:init(action_context, action_params, action_settings)
...
function ActionOverloadChargeWeaponSpecial:finish(reason, data, t, time_in_action)
...
function ActionOverloadChargeWeaponSpecial:running_action_state(t, time_in_action)
