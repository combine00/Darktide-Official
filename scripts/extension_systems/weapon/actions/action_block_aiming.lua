...
function ActionBlockAiming:init(action_context, ...)
...
function ActionBlockAiming:start(action_settings, t, time_scale, action_start_params)
...
function ActionBlockAiming:running_action_state(t, time_in_action)
...
function ActionBlockAiming:finish(reason, data, t, time_in_action)
