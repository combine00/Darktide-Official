...
function SwayWeaponModule:init(unit, unit_data_extension, weapon_extension)
...
function SwayWeaponModule:extensions_ready(world, unit)
	self._weapon_extension = ScriptUnit.extension(unit, "weapon_system")
end

function SwayWeaponModule:fixed_update(dt, t)
...
function SwayWeaponModule:_player_event_decay(decay, t)
...
function SwayWeaponModule:_calculate_sway_offsets(dt, t)
	local movement_state_component = self._movement_state_component
	local sway_component = self._sway_component
	local weapon_tweak_templates_component = self._weapon_tweak_templates_component
	local sway_template_name = weapon_tweak_templates_component.sway_template_name
