...
function Weapon:_init_traits(weapon_template, item, override_trait_lerp_value_or_nil, override_tweak_template_lerp_value_or_nil)
	local base_stats = item.base_stats or EMPTY_TABLE
	local overclocks = item.overclocks or EMPTY_TABLE
	...
	WeaponTweakTemplates.extract_trait_buffs(weapon_template, buffs, traits)
	WeaponTweakTemplates.extract_trait_buffs(weapon_template, buffs, perks)
