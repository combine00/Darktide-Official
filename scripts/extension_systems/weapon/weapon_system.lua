...
function WeaponSystem:pre_update(context, dt, t)
...
function WeaponSystem:prepare_queued_explosion()
...
function WeaponSystem:explosion_result(queue_index)
...
function WeaponSystem:_preallocate_queued_explosions(queue_index, num_to_allocate)
	local handle = Application.query_performance_counter()
	local queued_explosions = self._queued_explosions
...
function WeaponSystem:_update_queued_explosions(dt, t)
	local queued_explosions = self._queued_explosions
	local physics_world = self._physics_world
...
function WeaponSystem:_update_perils_of_the_warp_elite_kills_achievement()
...
function WeaponSystem:give_ammo_carryover_percentages(unit, weapon_slot_configuration)
