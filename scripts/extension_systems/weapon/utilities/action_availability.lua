...
function ActionAvailability.available_in_lunge(action_settings)
...
function ActionAvailability.available_in_sprint(action_settings, buff_extension)
...
function ActionAvailability.allowed_without_smite_target(action_settings)
...
function ActionAvailability.needs_ammo(action_settings)
...
function ActionAvailability.allowed_while_exploding(action_settings)
...
function ActionAvailability.increases_action_combo(action_settings)
...
function ActionAvailability.holds_action_combo(action_settings)
