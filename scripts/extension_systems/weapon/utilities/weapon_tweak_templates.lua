...
local _preparse_templates, _preparse_damage_templates, _preparse_explosion_templates, _lookup_entry, _add_tweak_stats, _build_templates, _lerp_array, _verify_base_templates, _add_tweak_modifiers, _add_lerped_tweak_modifiers, _resolve_template = nil
...
function WeaponTweakTemplates.preparse_weapon_template(weapon_template)
	local base_template_lookup = {
		...
		[template_types.weapon_shout] = _preparse_templates(weapon_template, template_types.weapon_shout),
...
function WeaponTweakTemplates.extract_trait_buffs(weapon_template, buffs, traits)
	local weapon_name = weapon_template.name
...
function WeaponTweakTemplates.get_base_stats(weapon_template, template_type, target)
...
function WeaponTweakTemplates.get_template_identifiers(weapon_template, template_type, target)
	local base_template_lookup = weapon_template.__base_template_lookup
...
function WeaponTweakTemplates.get_base_stats_values(base_stats, stat_data)
...
function WeaponTweakTemplates.get_base_stats_lerp_values(stat_data)
	local path_len = #stat_data
...
function WeaponTweakTemplates.get_stat_ui_data(template_type, stat_data, path_length_offset)
