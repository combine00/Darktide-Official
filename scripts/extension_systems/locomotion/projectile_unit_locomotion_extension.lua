...
function ProjectileUnitLocomotionExtension:post_update(unit, dt, t)
...
function ProjectileUnitLocomotionExtension:_switch_to_manual_state_helper(position, rotation, direction, speed, angular_velocity, target_unit, target_position)
	local projectile_unit = self._projectile_unit
...
function ProjectileUnitLocomotionExtension:switch_to_sticky(sticking_to_unit, sticking_to_actor, world_position, world_rotation, hit_normal, hit_direction)
