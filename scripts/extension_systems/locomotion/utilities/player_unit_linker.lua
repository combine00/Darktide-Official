...
function PlayerUnitLinker:init(world, unit)
	self._unit = unit
	self._linked = false
...
function PlayerUnitLinker:link(parent_unit, parent_node_name, node_name)
...
function PlayerUnitLinker:unlink()
	local linker_component = self._linker_component
	linker_component.linked = false
	linker_component.parent_unit = nil
	linker_component.parent_node = "none"
...
function PlayerUnitLinker:_link(parent_unit, parent_node_name, node_name)
...
function PlayerUnitLinker:_unlink()
...
function PlayerUnitLinker:mispredict_happened()
	local linker_component = self._linker_component
