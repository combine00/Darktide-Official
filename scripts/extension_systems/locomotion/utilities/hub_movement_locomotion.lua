...
function HubMovementLocomotion.update_movement(mover, dt, velocity_current, velocity_wanted, current_position, calculate_fall_velocity, player_character_constants, movement_settings, movement_settings_override, hub_active_stopping)
...
function HubMovementLocomotion.fetch_movement_settings(unit, player_character_constants, hub_jog_character_state_component)
