...
function ProjectileIntegration.integrate_position(physics_world, integration_data, dt, t, time_step_multiplier, dont_draw)
...
function ProjectileIntegration.integrate_rotation(physics_world, integration_data, dt, t)
...
function ProjectileIntegration.integrate(physics_world, integration_data, dt, t, is_server, time_step_multiplier, dont_draw)
