...
local function _is_target_valid(target_unit, integration_data)
	...
	return not have_unit_been_hit and HEALTH_ALIVE[target_unit]
end
...
function TrueFlightProjectileIntegration.integrate(physics_world, integration_data, dt, t, is_server)
