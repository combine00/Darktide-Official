...
function MoverController.create_mover_state()
	return {
		disable_reasons = {}
	}
end

function MoverController.set_active_mover(unit, mover_state, new_active_mover)
...
function MoverController.set_disable_reason(unit, mover_state, reason, new_state)
