...
function ForceTranslation.start(locomotion_force_translation_component, locomotion_steering_component, force_translation, start_translation, start_time, duration)
...
function ForceTranslation.get_translation(locomotion_force_translation_component, locomotion_steering_component, t)
...
function ForceTranslation.stop(locomotion_force_translation_component)
