...
function TrueFlightDrone.drone_projectile_locomotion(physics_world, integration_data, dt, t)
...
function TrueFlightDrone.drone_update_towards_position(target_position, physics_world, integration_data, dt, t, optional_validate_impact_func, optional_on_impact_func)
