...
function ProjectileLocomotion.activate_physics(unit)
	if not _has_actor(unit, "dynamic") then
		Unit.create_actor(unit, "dynamic")
	end
end

function ProjectileLocomotion.deactivate_physics(unit, dynamic_id)
...
function ProjectileLocomotion.check_suppression(physics_world, integration_data, previus_position, new_position, is_server, dt, t)
...
function ProjectileLocomotion.check_collision(hit_unit, hit_position, integration_data, bounce_unit)
...
function ProjectileLocomotion.projectile_cast(physics_world, travel_position, new_position, travel_direction, travel_distance, collision_filter, radius, optional_skip_static, optional_statics_radius, optional_static_raycast)
	local max_hits = 32
	local hits = nil
...
function ProjectileLocomotion.impact_detection_and_resolution(integration_data, new_position, new_velocity, physics_world, collision_filter, dt, dont_draw, optional_skip_static)
