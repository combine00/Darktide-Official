...
function ThirdPersonHubMovementDirectionAnimationControl:init(unit, init_context)
	self._unit = unit
...
function ThirdPersonHubMovementDirectionAnimationControl:update(dt, t)
...
function ThirdPersonHubMovementDirectionAnimationControl:_directions()
...
function ThirdPersonHubMovementDirectionAnimationControl:_movement_direction(move_state_movement_settings, velocity_current_direction, velocity_wanted_direction, dt)
...
function ThirdPersonHubMovementDirectionAnimationControl:_wanted_movement_direction(move_state_movement_settings, velocity_current_direction, velocity_wanted_direction)
...
function ThirdPersonHubMovementDirectionAnimationControl:_set_variables(unit, movement_direction)
