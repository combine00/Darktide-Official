...
function DialogueSystem:init(extension_system_creation_context, system_init_data, ...)
...
function DialogueSystem:_update_decaying_tension(dt, t)
...
function DialogueSystem:extensions_ready(world, unit, extension_name)
...
function DialogueSystem:_on_client_left(players_data)
...
function DialogueSystem:_update_currently_playing_dialogues(dt, t)
	local ALIVE = ALIVE
...
function DialogueSystem:_is_playable_dialogue_category(dialogue_category)
...
function DialogueSystem:_prevent_on_demand_vo(actor_unit, dialogue_category)
...
function DialogueSystem:rpc_dialogue_system_joined(channel_id, dialogue_breed_ids, dialogue_voice_indexes, dialogue_extension_unit_ids, dialogue_extension_profiles)
...
function DialogueSystem:set_ignore_server_play_requests(value)
...
function DialogueSystem:_play_dialogue_event_implementation(go_id, is_level_unit, level_name_hash, dialogue_id, dialogue_index, dialogue_rule_index, optional_query)
...
function DialogueSystem:send_dynamic_smart_tag(go_id, smart_tag)
...
function DialogueSystem:rpc_set_dynamic_smart_tag(channel_id, go_id, tag_id)
...
function DialogueSystem:_resolve_subtitle(subtitle_id)
...
function DialogueSystem:send_subtitle_event(currently_playing_subtitle)
...
function DialogueSystem:rpc_trigger_subtitle_event(channel_id, subtitle_id)
...
function DialogueSystem:_remove_stopped_dialogue(unit, dialogue)
...
function DialogueSystem:_process_query(query, t, is_a_delayed_query)
...
function DialogueSystem:_execute_dialogue_event(extension, query, dialogue_actor_unit)
...
function DialogueSystem:_is_rule_still_valid(rule, extension)
...
function DialogueSystem:_check_memory(criteria, current_memory)
...
function DialogueSystem:_load_player_resource(profile_name)
...
function DialogueSystem:_unload_player_resource(profile_name)
...
function DialogueSystem:_load_dialogue_resources(file_names)
...
function DialogueSystem:_load_dialogue_resource(file_name)
...
function DialogueSystem:_remove_player_backend_vo(backend_group_id, peer_id)
...
function DialogueSystem:backend_vo_table(backend_id)
	return self._backend_vo_table[backend_id]
end

function DialogueSystem:set_session_backend_vo(backend_group_id, rule_name)
	self._backend_vo_group_id = backend_group_id
	self._backend_vo_rule_name = rule_name
end

function DialogueSystem:save_session_backend_vo()
...
function DialogueSystem:extract_next_backend_vo(backend_group_id, optional_substring)
	if self._saved_backend_vo then
		local backend_table = self._saved_backend_vo[backend_group_id]
		local chosen_index, has_next = nil
...
function DialogueSystem:substring_exists_in_backend_vo(backend_group_id, substring)
	if self._saved_backend_vo then
		local backend_table = self._saved_backend_vo[backend_group_id]
...
function DialogueSystem:_sync_backend_vo_to_server(backend_group_id)
...
function DialogueSystem:rpc_server_sync_backend_vo(channel_id, peer_id, backend_group_id_rpc, rules_array_rpc)
	self:_populate_backend_vo(peer_id, backend_group_id_rpc, rules_array_rpc)
end

function DialogueSystem:_populate_backend_vo(peer_id, backend_group_id_rpc, rules_array_rpc)
...
function DialogueSystem:rpc_save_backend_vo(channel_id, backend_group_id_rpc, rule_name_id_rpc)
	local backend_group_id = NetworkLookup.backend_vo_groups[backend_group_id_rpc]
	local backend_group_lookup_id = backend_group_id .. "_vo"
...
function DialogueSystem:get_backend_vo_rule(group_name, rule_id)
