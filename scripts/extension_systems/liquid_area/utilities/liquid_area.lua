...
function LiquidArea.try_create(position, flow_direction, nav_world, liquid_area_template, optional_source_unit, optional_max_liquid, optional_not_on_other_liquids, optional_source_item, optional_source_side)
...
function LiquidArea.paint(liquid_paint_id, max_liquid_paint_distance, position, nav_world, liquid_area_template, allow_liquid_unit_creation, optional_brush_size, optional_not_on_other_liquids, optional_source_unit, optional_source_item, optional_source_side)
