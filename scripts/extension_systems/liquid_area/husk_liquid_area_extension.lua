...
function HuskLiquidAreaExtension:_add_liquid(unit_position, real_index, offset_position, is_filled)
...
function HuskLiquidAreaExtension:rpc_add_liquid_multiple(channel, go_id, real_index_array, offset_position_array, is_filled_array)
	local unit_position = Unit.world_position(self._unit, 1)
...
function HuskLiquidAreaExtension:rpc_remove_liquid_multiple(channel, go_id, real_index_array)
	local flow = self._flow
