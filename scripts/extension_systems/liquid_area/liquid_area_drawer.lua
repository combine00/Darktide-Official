...
function LiquidAreaDrawer:init(world, liquid_template)
...
function LiquidAreaDrawer:add_cell(position, rotation)
...
function LiquidAreaDrawer:remove_cell(index)
	if self._particles[index] then
...
function LiquidAreaDrawer:destroy()
