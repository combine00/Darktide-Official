...
function LiquidAreaExtension:_handle_create_liquid_syncing()
	local add_liquid_buffer = self._add_liquid_buffer
...
function LiquidAreaExtension:_handle_set_filled_syncing(t)
	local set_filled_buffer = self._set_filled_buffer
...
function LiquidAreaExtension:remove_any_cell_inside_of_radius(from_position, radius)
	if not self._flow_done then
		return
	end
