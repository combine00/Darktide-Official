...
function MissionObjectiveZoneCaptureExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function MissionObjectiveZoneCaptureExtension:_progress_inactive()
	if self._network_timer_state ~= NETWORK_TIMER_STATES.pause then
		self:_set_network_timer_state(NETWORK_TIMER_STATES.pause)
	end
end

function MissionObjectiveZoneCaptureExtension:_players_fulfill_in_zone_check()
...
function MissionObjectiveZoneCaptureExtension:_set_network_timer_state(timer_state)
	if self._is_server then
...
function MissionObjectiveZoneCaptureExtension:current_progression()
