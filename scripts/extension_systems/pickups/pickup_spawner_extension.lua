...
function PickupSpawnerExtension:setup_from_component(component, spawn_method, ignore_item_list, items, item_spawn_selection, spawn_nodes)
...
function PickupSpawnerExtension:on_gameplay_post_init(unit)
...
function PickupSpawnerExtension:spawnable_pickups_amount(component_index)
...
function PickupSpawnerExtension:despawn_items()
...
function PickupSpawnerExtension:despawn_item(item_unit)
	local pickup_system = self._pickup_system
