...
function PointOfInterestSystem:init(extension_system_creation_context, ...)
...
function PointOfInterestSystem:destroy()
...
function PointOfInterestSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function PointOfInterestSystem:on_remove_extension(unit, extension_name)
	if extension_name == "PointOfInterestTargetExtension" then
...
function PointOfInterestSystem:extensions_ready(world, unit)
	local extension = ScriptUnit.extension(unit, "point_of_interest_system")
...
function PointOfInterestSystem:update(context, dt, t, ...)
...
function PointOfInterestSystem:_update_dynamic_targets()
	local broadphase = self._broadphase
...
function PointOfInterestSystem:_update_seen_recently(t)
...
function PointOfInterestSystem:_update_lookat(t)
