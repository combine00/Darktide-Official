...
function CinematicSceneExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function CinematicSceneExtension:setup_from_component(cinematic_name, cinematic_category, origin_level_name)
	self._cinematic_category = cinematic_category
	self._cinematic_name = cinematic_name
	self._origin_level_name = origin_level_name
end

function CinematicSceneExtension:origin_level_name()
	return self._origin_level_name
end

function CinematicSceneExtension:play_cutscene()
