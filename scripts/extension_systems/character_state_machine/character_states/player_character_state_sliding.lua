...
function PlayerCharacterStateSliding:_check_transition(unit, t, next_state_params, input_source, is_crouching, commit_period_over, max_mass_hit, current_speed)
