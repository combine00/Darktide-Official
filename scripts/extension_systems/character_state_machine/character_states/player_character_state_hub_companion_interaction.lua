...
function PlayerCharacterStateHubCompanionInteraction:init(character_state_init_context, ...)
	PlayerCharacterStateHubCompanionInteraction.super.init(self, character_state_init_context, ...)
end

function PlayerCharacterStateHubCompanionInteraction:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateHubCompanionInteraction:on_exit(unit, t, next_state)
	PlayerCharacterStateHubCompanionInteraction.super.on_exit(self, unit, t, next_state)
end

function PlayerCharacterStateHubCompanionInteraction:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateHubCompanionInteraction:_check_transition(unit, t, next_state_params, input_extension, fixed_frame)
