...
function PlayerCharacterStateGrabbed:init(character_state_init_context, ...)
...
function PlayerCharacterStateGrabbed:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateGrabbed:_check_transition(unit, t, next_state_params)
