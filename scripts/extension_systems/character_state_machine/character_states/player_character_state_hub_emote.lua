...
function PlayerCharacterStateHubEmote:init(character_state_init_context, ...)
	PlayerCharacterStateHubEmote.super.init(self, character_state_init_context, ...)
end

function PlayerCharacterStateHubEmote:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateHubEmote:on_exit(unit, t, next_state)
	return
end

function PlayerCharacterStateHubEmote:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateHubEmote:_check_transition(unit, t, next_state_params, input_extension)
