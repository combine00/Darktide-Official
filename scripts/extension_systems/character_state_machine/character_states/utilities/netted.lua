...
function Netted.enter(unit, animation_extension, fx_extension, breed, attacker_breed, locomotion_steering_component, movement_state_component, t)
...
function Netted.try_exit(unit, inventory_component, visual_loadout_extension, unit_data_extension, t)
...
function Netted.exit(unit, unit_data_extension, t)
...
function Netted.calculate_drag_position(locomotion_component, navigation_extension, netting_unit, nav_world)
