...
function AcceleratedLocalSpaceMovement.wanted_movement(player_character_constants, input_source, locomotion_steering_component, movement_settings_component, first_person_component, is_crouching, velocity_current, dt, move_speed_multiplier)
