...
function Ladder.started_climbing(ladder_character_state_component, ladder_unit, is_server, game_session, player_unit_game_object_id, player, player_unit)
...
function Ladder.stopped_climbing(ladder_character_state_component, ladder_cooldown, is_server, game_session, player_unit_game_object_id, player, player_unit)
...
function Ladder.time_in_ladder_anim(unit, ladder_unit, breed)
