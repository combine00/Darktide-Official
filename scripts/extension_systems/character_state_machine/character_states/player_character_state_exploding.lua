...
function PlayerCharacterStateExploding:init(...)
...
function PlayerCharacterStateExploding:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateExploding:_check_transition(unit, t, next_state_params, input_extension, state_component)
	local unit_data_extension = self._unit_data_extension
