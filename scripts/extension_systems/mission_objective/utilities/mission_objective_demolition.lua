...
function MissionObjectiveDemolition:start_objective(mission_objective_data, registered_units, synchronizer_unit)
...
function MissionObjectiveDemolition:start_stage(stage)
...
function MissionObjectiveDemolition:stage_done()
...
function MissionObjectiveDemolition:update(dt)
...
function MissionObjectiveDemolition:update_progression()
