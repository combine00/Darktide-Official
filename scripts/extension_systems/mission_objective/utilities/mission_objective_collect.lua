...
function MissionObjectiveCollect:init()
...
function MissionObjectiveCollect:start_objective(mission_objective_data, units, synchronizer_unit)
...
function MissionObjectiveCollect:start_stage(stage)
	MissionObjectiveCollect.super.start_stage(self, stage)
	self:set_max_increment(self._collect_amount)
end

function MissionObjectiveCollect:update_progression()
