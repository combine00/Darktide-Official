...
function DecoderDeviceSystem:init(context, system_init_data, ...)
...
function DecoderDeviceSystem:rpc_decoder_device_hot_join(channel_id, unit_id, unit_is_enabled, is_placed, started_decode, decoding_interrupted, is_finished)
...
function DecoderDeviceSystem:rpc_decoder_device_enable_unit(channel_id, unit_id)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function DecoderDeviceSystem:rpc_decoder_device_place_unit(channel_id, unit_id)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function DecoderDeviceSystem:rpc_decoder_device_start_decode(channel_id, unit_id)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function DecoderDeviceSystem:rpc_decoder_device_decode_interrupt(channel_id, unit_id)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function DecoderDeviceSystem:rpc_decoder_device_finished(channel_id, unit_id)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
