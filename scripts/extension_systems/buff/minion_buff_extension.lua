...
function MinionBuffExtension:game_object_initialized(game_session, game_object_id)
...
function MinionBuffExtension:_on_remove_buff_stack(buff_instance, previous_stack_count)
	local template = buff_instance:template()
...
function MinionBuffExtension:_on_add_buff_stack(buff_instance, previous_stack_count)
	local template = buff_instance:template()
	local minion_effects = template.minion_effects
...
function MinionBuffExtension:_add_rpc_synced_buff(template, t, ...)
...
function MinionBuffExtension:_remove_rpc_synced_buff(index)
	local game_object_id = self._game_object_id
...
function MinionBuffExtension:_set_proc_active_start_time(index, activation_time)
