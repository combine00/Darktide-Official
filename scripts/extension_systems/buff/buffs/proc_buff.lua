...
function ProcBuff:destroy(extension_destroyed)
...
function ProcBuff:is_proc_active()
	local t = FixedFrame.get_latest_fixed_time()

	return self:_is_proc_active(t)
end

function ProcBuff:_is_proc_active(t)
...
function ProcBuff:_active_percentage(t)
...
function ProcBuff:_show_in_hud()
	local template = self._template
	local template_data = self._template_data
	local template_context = self._template_context
...
function ProcBuff:_is_hud_active()
