...
function Buff:_calculate_talent_override_data(override_data, parent_buff_template_or_nil)
	local template = self._template
...
function Buff:post_update_keywords_and_stats_func(t)
	local template = self._template
...
function Buff:set_need_to_sync_start_time(sync)
...
function Buff:additional_arguments()
	return self._additional_arguments
end

function Buff:owner_unit()
...
function Buff:destroy(extension_destroyed)
	local template = self._template
...
function Buff:template_data()
	return self._template_data
end

function Buff:has_hud()
	local template = self._template
...
function Buff:_hud_show_stack_count()
	local template = self._template
	local max_stacks = self:max_stacks()
...
function Buff:_force_negative_frame()
	return false
end
...
function Buff:hud_icon_gradient_map()
	local template = self._template
