...
function LimitRangeBuff:init(context, template, start_time, instance_id, ...)
...
function LimitRangeBuff:debug_get_stat_buffs()
	return self._stat_buffs
end

function LimitRangeBuff:update_stat_buffs(current_stat_buffs, t)
