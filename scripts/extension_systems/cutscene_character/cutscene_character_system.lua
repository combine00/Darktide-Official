...
function CutsceneCharacterSystem:register_cutscene_companion(extension)
	local cinematic_name = extension:cinematic_name()
...
function CutsceneCharacterSystem:unregister_cutscene_companion(extension)
...
function CutsceneCharacterSystem:get_cutscene_companion_for_slot(cinematic_name, slot_index, target_companion_breed_name)
