...
function CompanionOutlineExtension:_start_outline()
...
function CompanionOutlineExtension:_stop_outline()
	local local_player = Managers.player:local_player(1)
	local is_local_player = local_player == self._owner_player
	local outline_name = is_local_player and "owned_companion" or "allied_companion"
...
function CompanionOutlineExtension:_on_spawn_companion_item(slot_name, unit)
...
function CompanionOutlineExtension:_event_update_companion_outlines(value)
	if value == "both" then
		self:_start_outline()
