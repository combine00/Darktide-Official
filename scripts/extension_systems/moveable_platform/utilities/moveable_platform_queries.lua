...
function MoveablePlatformQueries.interaction_hud_description(moveable_platform_extension, interactable_actor_node_index)
...
function MoveablePlatformQueries.activate_platform(moveable_platform_extension, interactable_actor_node_index)
	local interactables = moveable_platform_extension:get_interactables()
...
function MoveablePlatformQueries.interaction_offset(platform_unit, moveable_platform_extension, interactable_actor_node_index)
	local interactables = moveable_platform_extension:get_interactables()
