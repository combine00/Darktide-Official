...
function MoveablePlatformSystem:rpc_moveable_platform_set_wall_collision(channel_id, level_unit_id, active)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(level_unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function MoveablePlatformSystem:rpc_moveable_platform_set_story(channel_id, level_unit_id, story_name)
	local is_level_unit = true
	local unit = Managers.state.unit_spawner:unit(level_unit_id, is_level_unit)
	local extension = self._unit_to_extension_map[unit]
...
function MoveablePlatformSystem:block_bot_movement()
	local unit_to_extension_map = self._unit_to_extension_map
