...
function LightControllerExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function LightControllerExtension:is_enabled()
	return self._enabled
end

function LightControllerExtension:is_flicker_enabled()
	return self._flicker_enabled
end

function LightControllerExtension:setup_from_component(is_enabled, fake_light, light_groups, flicker_start_enabled, flicker_config)
...
function LightControllerExtension:connect_to_destructible_extension()
...
function LightControllerExtension:light_groups()
	return self._light_groups
end

function LightControllerExtension:_share_network_enabled_state(is_enabled)
...
function LightControllerExtension:set_enabled(is_enabled, is_deterministic)
...
function LightControllerExtension:set_flicker_state(flicker_enabled, configuration, is_deterministic)
...
function LightControllerExtension:_share_network_flicker_state(flicker_enabled, configuration)
	local unit_level_index = Managers.state.unit_spawner:level_index(self._unit)
	local game_session_manager = Managers.state.game_session
...
function LightControllerExtension:hot_join_sync(sender, channel_id)
...
function LightControllerExtension:apply_hot_join_sync(is_enabled, flicker_enabled, configuration)
