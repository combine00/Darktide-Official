...
function GroupSystem:init(extension_system_creation_context, ...)
...
function GroupSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function GroupSystem:register_extension_update(unit, extension_name, extension)
...
function GroupSystem:_create_bot_group(side)
...
function GroupSystem:on_remove_extension(unit, extension_name)
...
function GroupSystem:_destroy_bot_group(side)
...
function GroupSystem:_add_member_to_group(member_unit, group_id)
	local group = self:group_from_id(group_id)
...
function GroupSystem:_remove_member_from_group(member_unit, group_id)
	local group = self:group_from_id(group_id)
...
function GroupSystem:_create_group(id)
...
function GroupSystem:generate_group_id()
...
function GroupSystem:bot_groups_from_sides(sides)
...
function GroupSystem:group_from_id(group_id)
	local groups = self._groups
...
function GroupSystem:lock_group_id(group_id)
	self._locked_group_ids[group_id] = true
end

function GroupSystem:unlock_group_id(group_id)
	self._locked_group_ids[group_id] = nil
end

function GroupSystem:num_groups()
	return self._num_groups
end

function GroupSystem:_remove_group(group_id)
...
function GroupSystem:update(context, dt, t)
...
function GroupSystem:group_position(group_id)
	local group = self:group_from_id(group_id)
...
function GroupSystem:_update_group_sfx()
...
function GroupSystem:start_group_sfx(group_id, start_event_name, stop_event_name_or_nil, optional_min_members)
	local group = self:group_from_id(group_id)
...
function GroupSystem:stop_group_sfx(group)
	local group_sfx = group.sfx
...
function GroupSystem:rpc_start_group_sfx(channel_id, group_id, start_event_id, stop_event_id)
...
function GroupSystem:rpc_stop_group_sfx(channel_id, group_id)
	local group = self:group_from_id(group_id)
