...
function DoorSystem:init(extension_system_creation_context, ...)
...
function DoorSystem:rpc_sync_door_state(channel_id, unit_level_index, state_lookup_id, anim_time_normalized)
...
function DoorSystem:update_level_props_broadphase()
