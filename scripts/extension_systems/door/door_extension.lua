...
function DoorExtension:setup_from_component(door_type, start_state, open_duration, close_duration, allow_closing, self_closing_time, blocked_time, open_type, control_panel_props, control_panels_active, ignore_broadphase)
...
function DoorExtension:instantiate_state()
...
function DoorExtension:started()
	return self._start_state == nil
end

function DoorExtension:set_start_state(state)
...
function DoorExtension:get_last_state_change_time()
...
function DoorExtension:_teleport_companions(unit, start_index)
	local index = start_index
	local current_node_name, has_node = nil
...
function DoorExtension:_free_companions(unit)
	local human_players = Managers.player:human_players()
