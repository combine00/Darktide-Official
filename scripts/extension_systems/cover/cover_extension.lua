...
function CoverExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function CoverExtension:setup_from_component(cover_type, enabled)
...
function CoverExtension:cover_type()
	return self._cover_type
end

function CoverExtension:enabled()
