...
function CoverSlots.create(physics_world, nav_world, unit, cover_type, node_positions)
...
function CoverSlots._add_slot(physics_world, unit, navmesh_position, slot_position, left, cover_type, nav_world, cover_slots)
	local above = 0.75
	local below = 0.75
...
function CoverSlots._generate_slot_peek_types(physics_world, cover_slot, cover_type, position_on_navmesh)
...
function CoverSlots._navmesh_los_check(physics_world, position, position_on_navmesh, z_offset)
...
function CoverSlots._double_raycast_los_check(physics_world, offset_z_position, los_from_position, los_to_position)
