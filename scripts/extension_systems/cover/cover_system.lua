...
function CoverSystem:init(extension_system_creation_context, ...)
...
function CoverSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function CoverSystem:register_extension_update(unit, extension_name, extension)
...
function CoverSystem:on_remove_extension(unit, extension_name)
	if extension_name == "CoverExtension" then
...
function CoverSystem:destroy()
	self._broadphase = nil
end

function CoverSystem:update(context, dt, t, ...)
	self:_update_cover_users(dt, t)
end

function CoverSystem:_update_cover_users(dt, t)
	local cover_user_unit_extension_data = self._cover_user_unit_extension_data
	local current_update_unit = self._current_update_unit
...
function CoverSystem:add_cover_slot_to_broadphase(cover_unit, cover_slot)
...
function CoverSystem:find_cover_slots(search_position, radius)
