...
function MinionSpawnerSpawnPosition.find_exit_position_on_nav_mesh(nav_world, spawn_position, exit_position, traverse_logic)
...
function MinionSpawnerSpawnPosition.validate_exit_position(nav_world, exit_position, traverse_logic)
