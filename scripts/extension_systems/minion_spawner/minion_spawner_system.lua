...
function MinionSpawnerSystem:spawners_in_group(group, optional_in_level_data, optional_level)
...
function MinionSpawnerSystem:spawners_in_group_distance_sorted(group, position, optional_inverse, optional_in_level_data, optional_level)
	local spawners, spawners_table = nil
...
function MinionSpawnerSystem:spawners_in_range(position, radius, optional_spawn_type)
