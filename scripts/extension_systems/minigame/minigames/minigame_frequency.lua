...
function MinigameFrequency:generate_board(seed)
	self._seed = seed
...
function MinigameFrequency:is_visually_on_target()
...
function MinigameFrequency:_is_frequency_on_target(x, y)
...
function MinigameFrequency:test_frequency(x, y)
