...
function MinigameDecodeSymbols:init(unit, is_server, seed)
...
function MinigameDecodeSymbols:_player_miss_target(player)
	if not player then
...
function MinigameDecodeSymbols:is_on_target(t)
