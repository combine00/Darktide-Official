...
function MinionToughnessExtension:set_toughness_damage(damage, reactivation_override)
...
function MinionToughnessExtension:time_since_toughness_broken()
	return math.huge
end
...
function MinionToughnessExtension:set_invulnerable(should_be_invulnerable)
	self._is_invulnerable = should_be_invulnerable
end

function MinionToughnessExtension:break_shield(attack_direction, optional_ignore_stagger, optional_regenerate_full_delay_t)
	local toughness_template = self._toughness_template
	local depleted_settings = toughness_template.depleted_settings
...
function MinionToughnessExtension:set_override_regen_speed(speed)
