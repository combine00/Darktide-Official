...
function Navigation.nav_tag_volume_points_center(points)
...
function Navigation.add_nav_data(nav_world, nav_data, level_name)
...
function Navigation.remove_nav_data(nav_data)
	GwNavWorld.remove_navdata(nav_data)
end

function Navigation.vector3s_to_arrays(vectors)
	local arrays = {}
...
function Navigation.vector3s_from_arrays(arrays)
	local vectors = {}
