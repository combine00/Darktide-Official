...
function NavTagVolumeBox.create_from_node(nav_world, unit, node_name, half_size)
...
function NavTagVolumeBox.create_from_mesh(nav_world, unit, mesh_name)
...
function NavTagVolumeBox.create_from_unit(nav_world, unit)
