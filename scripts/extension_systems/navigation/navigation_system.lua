...
function NavigationSystem:register_extension_update(unit, extension_name, extension)
...
function NavigationSystem:on_remove_extension(unit, extension_name)
	self._enabled_units[unit] = nil

	NavigationSystem.super.on_remove_extension(self, unit, extension_name)
end

function NavigationSystem:set_enabled_unit(unit, enabled)
	local extension = self._unit_to_extension_map[unit]
	self._enabled_units[unit] = enabled and extension or nil
end

function NavigationSystem:update(context, dt, t)
...
function NavigationSystem:post_update(context, dt, t)
	self:_update_position()
end

function NavigationSystem:_update_position()
	local enabled_units = self._enabled_units
