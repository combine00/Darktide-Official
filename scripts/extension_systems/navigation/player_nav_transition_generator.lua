...
function PlayerNavTransitionGenerator:init(unit, nav_world, traverse_logic)
...
function PlayerNavTransitionGenerator:fixed_update(unit, is_on_nav_mesh, latest_position_on_nav_mesh)
...
function PlayerNavTransitionGenerator:_find_from_position(current_position, latest_position_on_nav_mesh)
...
function PlayerNavTransitionGenerator:_reset_state()
	local invalid_vector = Vector3.invalid_vector()
