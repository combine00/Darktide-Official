...
function LuggableSocketExtension:socket_luggable(luggable_unit, socket_lock_time)
	local socket_unit = self._unit
...
function LuggableSocketExtension:_lock_socket(luggable_unit)
...
function LuggableSocketExtension:visible()
