...
local WoundMaterials = {
	...
	calculate = function (unit, wounds_config_or_nil, wounds_data, wound_index, wound_settings, wound_shape, hit_actor_node_index, hit_actor_bind_pose, hit_world_position, start_time)
...
function WoundMaterials.apply(unit, wounds_data, optional_index, optional_slot_items, optional_inverse_root_node_bind_pose)
