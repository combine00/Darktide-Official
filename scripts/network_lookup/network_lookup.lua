...
function NetworkLookup._create_attachment_names_lookup_recursive(attachment_names, items, item)
...
function NetworkLookup.create_attachment_names_lookup(items)
