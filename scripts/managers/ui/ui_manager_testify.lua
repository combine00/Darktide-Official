...
function UIManagerTestify.open_view(ui_manager, view)
...
function UIManagerTestify.wait_for_view(ui_manager, view_name)
	if not ui_manager:view_active(view_name) then
		return Testify.RETRY
	end
end

function UIManagerTestify.wait_for_view_to_close(ui_manager, view_name)
