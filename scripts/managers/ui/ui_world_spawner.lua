...
function UIWorldSpawner:init(world_name, world_layer, timer_name, optional_view_name, optional_flags)
...
function UIWorldSpawner:set_story_speed(story_speed)
...
function UIWorldSpawner:spawn_level(level_name, included_object_sets, position, rotation, ignore_level_background)
...
function UIWorldSpawner:trigger_level_event(event_name)
	local level = self._level
...
function UIWorldSpawner:set_listener(viewport_name)
...
function UIWorldSpawner:release_listener()
	local camera_manager = Managers.state.camera
...
function UIWorldSpawner:listener_pose(viewport_name)
	local world = self._world
...
function UIWorldSpawner:add_viewport_custom_output_targets(custom_render_targets)
