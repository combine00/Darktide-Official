...
function UIScenegraph.init_scenegraph_cached(scenegraph)
...
function UIScenegraph.init_scenegraph(scenegraph, scale)
...
function UIScenegraph.get_scenegraph_id_screen_scale(scenegraph, scenegraph_object_name, scale)
...
function UIScenegraph.world_position(scenegraph, scenegraph_object_name, scale)
...
function UIScenegraph.local_position(scenegraph, scenegraph_object_name)
	return scenegraph[scenegraph_object_name].local_position
end

function UIScenegraph.get_render_size(scenegraph, scenegraph_object_name, optional_scale)
...
function UIScenegraph.get_size(scenegraph, scenegraph_object_name, optional_scale)
	local scenegraph_object = scenegraph[scenegraph_object_name]
	local size = scenegraph_object.size
	local scenegraph_object_scale = scenegraph_object.scale
	local scenegraph_object_parent = scenegraph_object.parent
...
function UIScenegraph.size_scaled(scenegraph, scenegraph_object_name, optional_scale)
	local scenegraph_object = scenegraph[scenegraph_object_name]
	local size = scenegraph_object.size
	local scale = optional_scale or RESOLUTION_LOOKUP.scale
	local inverse_scale = 1 / scale
...
function UIScenegraph.set_local_position(scenegraph, scenegraph_object_name, new_position)
