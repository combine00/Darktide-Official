...
function UIProfileSpawner:spawn_profile(profile, position, rotation, scale, state_machine, animation_event, face_state_machine_key, face_animation_event, force_highest_mip, disable_hair_state_machine, optional_unit_3p, optional_ignore_state_machine)
	if self._loading_profile_data then
		self._loading_profile_data.profile_loader:destroy()
...
function UIProfileSpawner:default_rotation_angle()
