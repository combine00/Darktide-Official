...
function UIConstantElements:is_element_using_input(element_name)
...
function UIConstantElements:post_update(dt, t)
	local elements_array = self._elements_array
...
function UIConstantElements:_apply_hud_scale()
...
function UIConstantElements:_abort_hud_scale()
	local render_settings = self._render_settings
	local scale = RESOLUTION_LOOKUP.scale
	render_settings.scale = scale
	render_settings.inverse_scale = 1 / scale
...
function UIConstantElements:_update_hud_scale_modified()
	local new_scale = Hud.hud_scale()
