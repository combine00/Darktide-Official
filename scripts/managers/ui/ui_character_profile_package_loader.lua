...
function UICharacterProfilePackageLoader:init(unique_id, item_definitions, optional_mission_template)
...
function UICharacterProfilePackageLoader:_unload_all(packages_to_unload)
...
function UICharacterProfilePackageLoader:_unload_packages(packages_to_unload)
	local package_manager = Managers.package
