...
function UsedItemsReporter:init()
	self._reports = {}
end

function UsedItemsReporter:update(dt, t)
	return
end

function UsedItemsReporter:report()
...
function UsedItemsReporter:register_event(player, item_name)
...
function UsedItemsReporter:destroy()
	return
end
