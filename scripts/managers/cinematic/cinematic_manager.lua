...
function CinematicManager:waiting_for_player_input()
	local next_story = self._queued_stories[1]
...
function CinematicManager:has_queued_stories()
	return self._queued_stories[1] ~= nil
end

function CinematicManager:last_story_time_left()
	local story = self._active_story
...
function CinematicManager:mission_intro_played()
