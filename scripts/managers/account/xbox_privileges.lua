...
function XboxPrivileges:verify_user_restriction_batched(xuid, restriction, batch_type)
...
function XboxPrivileges:_update_batched_user_restrictions(dt, t)
...
function XboxPrivileges:_send_batched_user_restrictions(batch_type, t)
	local batch = self._batched_user_restrictions[batch_type]
...
function XboxPrivileges:update(dt, t)
...
function XboxPrivileges:verify_user_restriction(xuid, restriction, optional_callback)
...
function XboxPrivileges:push_telemetry()
