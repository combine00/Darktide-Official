...
function MainPathManager:_generate_spawn_points()
	...
	local spawn_point_min_free_radius = MainPathSettings.spawn_point_min_free_radius
	local spawn_point_min_distance_to_others = MainPathSettings.spawn_point_min_distance_to_others
