...
function MainPathManager:init(world, nav_world, level_seed, main_path_resource_name, path_type, num_sides, is_server, use_nav_point_time_slice)
...
function MainPathManager:path_type()
...
function MainPathManager:generate_spawn_points()
	if not self._is_server then
		return
	end

	local nav_mesh_manager = Managers.state.nav_mesh
	local nav_triangle_group_cost_table = GwNavTagLayerCostTable.create()
	...
	local triangle_group_distance = MainPathSettings.triangle_group_distance
	local triangle_group_cutoff_values = MainPathSettings.triangle_group_cutoff_values
...
function MainPathManager:_init_time_slice_nav_points(nav_world, nav_triangle_group, parameters)
