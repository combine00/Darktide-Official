...
function MutatorPestilentBauble:init(is_server, network_event_delegate, mutator_template)
...
function MutatorPestilentBauble:update(dt, t)
...
function MutatorPestilentBauble:_add_allowed_spawns(dt, t)
...
function MutatorPestilentBauble:_check_allowance(t)
...
function MutatorPestilentBauble:_spawn()
	allowed_spawns = allowed_spawns - 1
	...
	local is_critical_strike, origin_item_slot, charge_level, target_unit, weapon_item_or_nil, fuse_override_time_or_nil = nil
