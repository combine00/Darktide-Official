...
function MutatorNurgleWarp:init(is_server, network_event_delegate, mutator_template, nav_world)
...
function MutatorNurgleWarp:_try_find_occluded_position(nav_world, physics_world, side, target_side, occluded_spawn_range, try_find_on_main_path, optional_main_path_offset, optional_disallowed_positions)
...
function MutatorNurgleWarp:spawn_group(composition, unit)
...
function MutatorNurgleWarp:spawn_random_from_template(optional_target_unit)
...
function MutatorNurgleWarp:update(dt, t)
...
function MutatorNurgleWarp:add_split_spawn(position, rotation, breed_name, buff_to_add, target_unit)
	local queue = self._spawn_queue
