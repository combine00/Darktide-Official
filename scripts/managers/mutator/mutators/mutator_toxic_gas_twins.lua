...
function MutatorToxicGasTwins:init(is_server, network_event_delegate, mutator_template, nav_world, level_seed)
...
function MutatorToxicGasTwins:_activate_cloud(cloud, is_other_cloud, delay)
...
function MutatorToxicGasTwins:_update_delayed_cloud(cloud, dt)
...
function MutatorToxicGasTwins:_spawn_volume_and_liquid(cloud, optional_buildup_liquid_delay)
...
function MutatorToxicGasTwins:_deactivate_cloud(cloud)
...
function MutatorToxicGasTwins:_spawn_twins(twin_spawn_data, section_id)
...
function MutatorToxicGasTwins:_despawn_twin(twin_unit)
	local blackboard = BLACKBOARDS[twin_unit]
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
...
function MutatorToxicGasTwins:_despawn_twins()
...
function MutatorToxicGasTwins:on_gameplay_post_init(level, themes)
	if level then
...
function MutatorToxicGasTwins:destroy()
	Managers.event:unregister(self, "intro_cinematic_started")
	Managers.event:unregister(self, "players_teleported")
end

function MutatorToxicGasTwins:_event_intro_cinematic_started(cinematic_name)
...
function MutatorToxicGasTwins:_event_players_teleported()
...
function MutatorToxicGasTwins:_random(...)
...
function MutatorToxicGasTwins:_update_twins(dt, t, ahead_travel_distance)
...
function MutatorToxicGasTwins:update(dt, t)
	if not self._is_server then
		return
	end
...
function MutatorToxicGasTwins:start_boss_fight()
...
function MutatorToxicGasTwins:spawn_boss_fight_twins()
...
function MutatorToxicGasTwins:_update_boss_fight(dt, t)
	for i = #self._spawned_twins, 1, -1 do
		local twin_unit = self._spawned_twins[i]
...
function MutatorToxicGasTwins:_update_boss_fight_twins_alive(dt, t, health_threshold, gas_index)
...
function MutatorToxicGasTwins:_start_gas_phase(gas_phase_index)
...
function MutatorToxicGasTwins:_spawn_gas_phase_gas(gas_id)
	local section_id = self._current_section_id
	local section_clouds = self._gas_clouds[section_id]
...
function MutatorToxicGasTwins:_update_gas_phase(dt, t)
...
function MutatorToxicGasTwins:_remove_gas_phase_gas()
...
function MutatorToxicGasTwins:_stop_gas_phase()
	self:_remove_gas_phase_gas()
...
function MutatorToxicGasTwins:_trigger_level_event(event_name)
...
function MutatorToxicGasTwins:_ready_to_escape(unit)
...
function MutatorToxicGasTwins:_spawn_horde(horde_type, horde_template, composition)
...
function MutatorToxicGasTwins:_has_hard_mode()
