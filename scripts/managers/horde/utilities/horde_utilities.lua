...
local HordeUtilities = {
	try_find_spawn_position = function (nav_world, center_position, index, num_columns, max_attempts, traverse_logic)
	...
	position_has_line_of_sight_to_any_enemy_player = function (physics_world, from_position, side, collision_filter)
