...
function EnvironmentBlend:init(world)
	self._active_blends = {}
	self._registered_blends = {}
	self._blend_layers = {}
end

function EnvironmentBlend:register_environment(blend)
...
function EnvironmentBlend:unregister_environment(blend)
	local layer = blend:layer()
...
function EnvironmentBlend:blend_list(camera_pos, default_shading_environment_resource)
