...
function BaseCamera:should_apply_fov_multiplier()
	return self._should_apply_fov_multiplier
end

function BaseCamera:default_fov()
...
function BaseCamera:exposure_snap()
	return false
end
...
function BaseCamera:custom_vertical_fov()
...
function BaseCamera:use_collision()
...
function BaseCamera:set_root_unit(unit, object)
...
function BaseCamera:set_root_near_range(near_range)
...
function BaseCamera:set_root_far_range(far_range)
...
function BaseCamera:set_root_dof_enabled(dof_enabled)
...
function BaseCamera:set_root_focal_distance(focal_distance)
...
function BaseCamera:set_root_focal_region(focal_region)
...
function BaseCamera:set_root_focal_padding(focal_padding)
...
function BaseCamera:set_root_focal_scale(focal_scale)
...
function BaseCamera:_update_fov_multiplier(dt, data)
