...
function FirstPersonAnimationCamera:parse_parameters(camera_settings, ...)
	BaseCamera.parse_parameters(self, camera_settings, ...)

	self._animation_object = camera_settings.animation_object
end

function FirstPersonAnimationCamera:set_root_unit(unit, object)
...
function FirstPersonAnimationCamera:update(dt, position, rotation, data)
