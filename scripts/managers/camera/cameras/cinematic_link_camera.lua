...
function CinematicLinkCamera:init(root_node)
...
function CinematicLinkCamera:update(dt, data)
...
function CinematicLinkCamera:far_range()
	if ALIVE[self._root_unit] then
...
function CinematicLinkCamera:vertical_fov()
	if ALIVE[self._root_unit] then
