...
function LerpRotationCamera:init(...)
...
function LerpRotationCamera:parse_parameters(camera_settings, parent_node)
...
function LerpRotationCamera:update(dt, position, rotation, data)
