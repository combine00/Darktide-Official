...
local ObjectLinkCamera = class("ObjectLinkCamera", "BaseCamera")
...
function ObjectLinkCamera:parse_parameters(camera_settings, parent_node)
	...
	self._curve_data_parameter_name = camera_settings.anim_curve_parameter_name
end
