...
function CriticallyDampenedStringTransformCamera:init(root_node)
...
function CriticallyDampenedStringTransformCamera:destroy()
...
function CriticallyDampenedStringTransformCamera:parse_parameters(camera_settings, parent_node)
	BaseCamera.parse_parameters(self, camera_settings, parent_node)

	self._halflife = camera_settings.halflife or 0.1
end

function CriticallyDampenedStringTransformCamera:update(dt, position, rotation, data)
