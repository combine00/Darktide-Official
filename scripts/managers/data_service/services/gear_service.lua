...
function GearService:_refresh_gear_cache()
...
function GearService:fetch_gear()
...
function GearService:invalidate_gear_cache()
	if not GameParameters.enable_backend_gear_cache then
		return
	end
...
function GearService:populate_gear_cache()
	if not GameParameters.enable_backend_gear_cache then
		return
	end
...
function GearService:on_character_deleted(character_id)
...
function GearService:on_gear_deleted(gear_id)
	local cache = self._cached_gear_list
...
function GearService:on_gear_created(gear_id, gear)
	local cache = self._cached_gear_list
...
function GearService:on_gear_updated(gear_id, gear)
	local cache = self._cached_gear_list
...
function GearService:delete_gear(gear_id)
...
function GearService:delete_gear_batch(gear_ids)
...
function GearService:_delete_item_batches(gear_ids_batches, result)
