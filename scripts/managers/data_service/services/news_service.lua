...
function NewsService:init(backend_interface)
	self._backend_interface = backend_interface
	self._cached_data = {}
	self._cached_promise = {}
end

function NewsService:_get_category(category, use_cache)
...
function NewsService:get_news()
	return self:_get_category("news", true)
end

function NewsService:get_events()
