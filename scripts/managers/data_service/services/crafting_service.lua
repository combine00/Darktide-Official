...
function CraftingService:reset()
	if self._trait_sticker_book_cache then
		self._trait_sticker_book_cache:reset()
	end
end

function CraftingService:upgrade_weapon_rarity(gear_id, costs)
...
function CraftingService:upgrade_gadget_rarity(gear_id, costs)
...
function CraftingService:reroll_perk_in_item(gear_id, existing_perk_index, is_gadget, costs)
...
function CraftingService:replace_trait_in_weapon(gear_id, existing_trait_index, new_trait_id, new_trait_tier, costs)
...
function CraftingService:replace_perk_in_weapon(gear_id, existing_trait_index, new_trait_id, costs, new_trait_tier)
...
function CraftingService:extract_trait_from_weapon(gear_id, trait_index, costs)
...
function CraftingService:warm_trait_sticker_book_cache()
...
function CraftingService:on_gear_created(gear_id, gear)
	local cache = self._trait_sticker_book_cache
...
function CraftingService:get_item_crafting_metadata(gear_id)
