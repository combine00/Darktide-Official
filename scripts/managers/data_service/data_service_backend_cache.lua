...
function DataServiceBackendCache:init(name)
	self._name = name
	self._cached_data = {}
...
function DataServiceBackendCache:is_empty()
	return table.is_empty(self._cached_data)
end

function DataServiceBackendCache:get_data(cache_key, backend_func)
...
function DataServiceBackendCache:_fetch_backend_data(cache_key, backend_func)
...
function DataServiceBackendCache:invalidate()
...
function DataServiceBackendCache:reset()
	table.clear(self._cached_data)
...
function DataServiceBackendCache:cached_data_by_key(cache_key)
