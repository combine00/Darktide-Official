...
function WwiseStateGroupPlayerState:init(wwise_world, wwise_game_sync_name)
	WwiseStateGroupPlayerState.super.init(self, wwise_world, wwise_game_sync_name)

	self._next_fast_parameter_update = 0
end

function WwiseStateGroupPlayerState:update(dt, t)
...
function WwiseStateGroupPlayerState:set_followed_player_unit(player_unit)
...
function WwiseStateGroupPlayerState:_wwise_state()
	...
	if scanning_read_component.is_active then
