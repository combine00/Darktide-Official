...
function ChunkLodManager:player()
	return self._local_player
end

function ChunkLodManager:set_level_unit(unit)
...
function ChunkLodManager:clear_level_unit(unit)
...
function ChunkLodManager:register_unit(unit, callback_function)
...
function ChunkLodManager:unregister_unit(unit)
	local level = Unit.level(unit)
...
function ChunkLodManager:reset_timer()
...
function ChunkLodManager:_async_raycast_result_cb(id, data, hits, num_hits)
	if num_hits <= 0 then
		return
	end
...
function ChunkLodManager:_set_show_chunk_units(level, show_units)
