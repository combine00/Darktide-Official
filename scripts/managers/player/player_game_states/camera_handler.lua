...
function CameraHandler:remove_all_moods(unit)
...
function CameraHandler:_update_camera_manager(dt, t, player_orientation)
	local player = self._player
	local camera_manager = Managers.state.camera
...
function CameraHandler:_update_hub_camera_variables(dt, t, unit, viewport_name)
