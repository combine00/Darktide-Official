...
function PresenceManager:initialize()
...
function PresenceManager:reset()
...
function PresenceManager:set_cross_play_disabled(disabled)
...
function PresenceManager:_set_cross_play_disabled_in_party(disabled)
...
function PresenceManager:_set_is_cross_playing(value)
...
function PresenceManager:set_psn_session_id(session_id)
...
function PresenceManager:get_presences(account_ids)
	local promises = {}
...
function PresenceManager:_init_batched_get_presence(stream_id)
	local batched_presence_streams = self._batched_presence_streams
...
function PresenceManager:_get_batched_presence(entry, platform, platform_user_id)
...
function PresenceManager:_check_cross_play()
...
function PresenceManager:_check_activity()
...
function PresenceManager:_update_platform_presence()
	local myself = self._myself
...
function PresenceManager:_delete_platform_presence()
	if HAS_STEAM then
...
function PresenceManager:_create_or_join_psn_session()
...
function PresenceManager:_max_psn_session_players()
	local activity_id = self._myself:activity_id()
...
function PresenceManager:cb_on_game_state_change(previous_state_name, next_state_name)
