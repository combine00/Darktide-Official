...
function DecalManager:init_settings(lifetime, impact_pool_size, blood_pool_size)
...
function DecalManager:delete_units()
...
function DecalManager:add_projection_decal(decal_unit_name, decal_position, decal_rotation, decal_normal, decal_extents, hit_actor, hit_unit, t)
...
function DecalManager:remove_linked_decals(parent_unit)
	EngineOptimizedManagers.decal_manager_return_linked_decals_to_pool(self._decal_system, parent_unit)
end

function DecalManager:register_decal_unit_ids(unit_ids)
	for i = 1, #unit_ids do
...
function DecalManager:unregister_decal_unit_ids(unit_ids)
...
function DecalManager:_check_new_user_settings()
