...
function VotingNotificationHandler:init()
	self._notifications = {}
end

function VotingNotificationHandler:destroy()
	return
end
...
function VotingNotificationHandler:_format_time(seconds)
	return Text.format_time_span_long_form_localized(seconds)
end

function VotingNotificationHandler:_get_text(voting_id)
...
function VotingNotificationHandler:create(voting_id, data)
	_verify_data(data)
...
function VotingNotificationHandler:modify(voting_id, data, optional_clear_cache)
	_verify_data(data)
...
function VotingNotificationHandler:remove(voting_id)
	local notification = self._notifications[voting_id]
...
function VotingNotificationHandler:update(dt, t)
