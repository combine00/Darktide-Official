...
function VotingByNetworkImpl:can_start_voting(template_name, params, initiator_peer)
...
function VotingByNetworkImpl:_on_started(voting_id, template, params, initiator_peer)
