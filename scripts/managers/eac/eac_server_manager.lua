...
function EACServerManager:init()
	_info("init")
...
function EACServerManager:has_eac()
	local has_eac = EOS.has_eac_server()

	return has_eac
end

function EACServerManager:begin_session()
...
function EACServerManager:end_session()
	local state = self._state
...
function EACServerManager:add_peer(channel_id, account_name, ip_address)
...
function EACServerManager:remove_peer(channel_id)
...
function EACServerManager:update(dt, t)
	local state = self._state
...
function EACServerManager:_handle_action(data)
...
function EACServerManager:_check_peer_status()
...
function EACServerManager:_kick_player(peer_id, details)
