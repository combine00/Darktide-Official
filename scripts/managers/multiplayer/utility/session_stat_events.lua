...
function SessionStatEvents.create_player_events(mission_data, mission_result, player)
...
function SessionStatEvents.create_events(mission_data, mission_result, players)
	local events = {}
...
function SessionStatEvents.push_events(session_id, mission_data, mission_result, players)
