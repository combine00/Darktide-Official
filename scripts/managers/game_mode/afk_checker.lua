...
function AFKChecker:_enable_warning(player_id)
...
function AFKChecker:_disable_warning(player_id)
	local player = Managers.player:player_from_unique_id(player_id)
	local peer_id = player:peer_id()
...
function AFKChecker:rpc_enable_inactivity_warning(channel_id, minutes_to_kick)
...
function AFKChecker:rpc_disable_inactivity_warning(channel_id)
...
function AFKChecker:_show_warning_popup(minutes_to_kick)
	local context = {
