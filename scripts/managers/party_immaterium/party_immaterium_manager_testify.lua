...
function PartyImmateriumManagerTestify.immaterium_join_party(party_immaterium_manager, party_id)
	party_immaterium_manager:join_party(party_id)
end

function PartyImmateriumManagerTestify.immaterium_party_id(party_immaterium_manager)
	return party_immaterium_manager:party_id()
end

function PartyImmateriumManagerTestify.leave_party_immaterium(party_immaterium_manager)
