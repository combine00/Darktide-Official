...
function VoiceOverSpawnManager:create_units(dialogue_breed_settings)
...
function VoiceOverSpawnManager:create_unit(dialogue_breed_settings, voice_profile, optional_position)
	local unit_spawner_manager = self._unit_spawner_manager
...
function VoiceOverSpawnManager:voice_over_units()
