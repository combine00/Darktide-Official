...
function MechanismAdventure:init(...)
	...
	if context.server_channel then
		...
		local challenge, resistance, circumstance_name, havoc_data, side_mission, backend_mission_id = nil
...
function MechanismAdventure:profile_changes_are_allowed()
...
function MechanismAdventure:_on_vote_finished(result)
...
function MechanismAdventure:_show_retry_popup()
	self._retrying = true
	local context = {
