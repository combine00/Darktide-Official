...
function ErrorCodes.get_error_code_string_from_reason(error_string)
...
function ErrorCodes.get_error_code_description_from_reason(error_string, localized)
	local error_config = ErrorCodes._config_from_error_string(error_string)
...
function ErrorCodes.get_error_code_title_from_reason(error_string, localized)
	local error_config = ErrorCodes._config_from_error_string(error_string)
	local loc_function = localized and Localize or echo
...
function ErrorCodes.get_error_code_level_from_reason(error_string)
	local error_config = ErrorCodes._config_from_error_string(error_string)

	return error_config.error_level or "warning"
end

function ErrorCodes.apply_backend_game_settings()
...
function ErrorCodes.should_report_to_crashify(error_string)
	local error_config = ErrorCodes._config_from_error_string(error_string)
...
function ErrorCodes.should_leave_party(error_string)
	local error_config = ErrorCodes._config_from_error_string(error_string)
