...
function NetworkStoryManager:unregister_level(level)
...
function NetworkStoryManager:play_story(story_name, story_level, speed, loop_mode)
	speed = speed or 1
...
function NetworkStoryManager:set_story_loop_mode(story_name, story_level, loop_mode)
	if self._is_server then
		local story = self._levels[story_level][story_name]
...
function NetworkStoryManager:rpc_network_story_sync(channel_id, level_id, story_name, loop_mode, story_speed, story_time)
