...
function MissionBuffsUIManager:init(mission_buffs_manager, game_mode, is_server, network_event_delegate)
...
function MissionBuffsUIManager:destroy()
	self._game_mode = nil
	self._network_event_delegate = nil
	self._current_notification = nil
end

function MissionBuffsUIManager:current_choice_resolved()
...
function MissionBuffsUIManager:try_show_new_ui_notification()
...
function MissionBuffsUIManager:_check_if_notification_already_exists(new_notification)
...
function MissionBuffsUIManager:_queue_ui_notification(context)
...
function MissionBuffsUIManager:queue_choice_selection_ui(is_buff_family_choice, options, wave_num)
...
function MissionBuffsUIManager:queue_buff_received_notification_ui(buff_name, buff_family_source_id, wave_num)
...
function MissionBuffsUIManager:queue_wave_end_notification_ui(wave_num)
...
function MissionBuffsUIManager:check_if_can_show_choice_notification()
...
function MissionBuffsUIManager:check_if_can_show_buff_received_notification()
	local game_mode = self._game_mode
	local current_wave_num = game_mode:get_current_wave()
...
function MissionBuffsUIManager:_compare_notifications(notification_a, notification_b)
...
function MissionBuffsUIManager:get_time_left_between_waves()
	local game_mode = self._game_mode
