...
local gib_units = {
	...
	tentacle = {
		default = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_flesh_gib_01",
		upperbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_flesh_gib_01",
		upperbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_flesh_gib_01",
		fullbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_flesh_gib_01",
		fullbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_flesh_gib_01"
	},
	right_arm = {
	...
	torso_sever = {
		default = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full",
		upperbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full",
		upperbody_e = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full",
		upperbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full",
		fullbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full",
		fullbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_gib_full"
	},
	torso_full = {
		default = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01",
		upperbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01",
		upperbody_e = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01",
		upperbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01",
		fullbody_b = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01",
		fullbody_a = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh_gib_01"
	}
}
local name = "chaos_mutated_poxwalker"
local size = GibbingSettings.character_size.small
local gib_push_head = 125
...
head_crush.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/head_gib_cap_crushed_01"
...
local tentacle = table.clone(limb_full)
tentacle.gib_settings.override_push_force = {
	gib_push_arm,
	gib_push_arm * 1.25
}
tentacle.gib_settings.gib_unit = gib_units.tentacle
tentacle.gib_settings.gib_flesh_unit = "content/characters/enemy/chaos_poxwalker/gibbing/tentacle_arm_flesh"
tentacle.gib_settings.gib_spawn_node = "j_leftshoulder"
tentacle.gib_settings.gib_actor = "rp_tentacle_flesh_gib_01"
tentacle.gib_settings.vfx.node_name = tentacle.gib_settings.gib_actor
tentacle.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/left_upper_arm_tenticle_gib_cap"
tentacle.stump_settings.stump_attach_node = "j_spine2"
tentacle.scale_node = "j_leftshoulder"
tentacle.material_overrides = {
	"slot_body",
	"slot_upper_body",
	"envrionmental_override"
}
local tentacle_arm_remove = table.clone(tentacle)
tentacle_arm_remove.gib_settings = nil
local tentacle_arm_warp = table.clone(tentacle)
tentacle_arm_warp.gib_settings.vfx = SharedGibbingTemplates.vfx.warp_gib
tentacle_arm_warp.stump_settings.vfx = SharedGibbingTemplates.vfx.warp_stump
tentacle_arm_warp.gibbing_threshold = GibbingThresholds.medium
local tentacle_arm_warp_lightning = table.clone(tentacle)
tentacle_arm_warp_lightning.gib_settings.vfx = SharedGibbingTemplates.vfx.warp_gib_lightning
tentacle_arm_warp_lightning.stump_settings.vfx = SharedGibbingTemplates.vfx.warp_stump_lightning
local tentacle_arm_warp_shard = table.clone(tentacle)
tentacle_arm_warp_shard.gib_settings.vfx = SharedGibbingTemplates.vfx.warp_gib
tentacle_arm_warp_shard.stump_settings.vfx = SharedGibbingTemplates.vfx.warp_stump
...
upper_right_arm.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_upper_arm_gib_cap_01"
...
lower_right_arm.gib_settings.vfx.node_name = lower_right_arm.gib_settings.gib_actor
lower_right_arm.gib_settings.sfx.node_name = "g_right_lower_arm_gib"
lower_right_arm.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_lower_arm_gib_cap_01"
...
right_arm.gib_settings.vfx.node_name = right_arm.gib_settings.gib_actor
right_arm.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_upper_arm_gib_cap_01"
...
upper_left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/left_upper_leg_gib_cap_01"
...
upper_right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_upper_leg_gib_cap_01"
...
lower_left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/left_lower_leg_gib_cap_01"
...
lower_right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_lower_leg_gib_cap_01"
...
left_leg.gib_settings.vfx.node_name = left_leg.gib_settings.gib_actor
left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/left_upper_leg_gib_cap_01"
...
right_leg.gib_settings.vfx.node_name = right_leg.gib_settings.gib_actor
right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_poxwalker/gibbing/right_upper_leg_gib_cap_01"
...
torso_sever.gib_settings.gib_flesh_unit = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_arm_tenticle_flesh_full"
torso_sever.gib_settings.gib_spawn_node = "j_spine1"
torso_sever.gib_settings.gib_actor = "rp_upper_torso_tentacle_arm_gib_full"
...
torso_full.gib_settings.gib_flesh_unit = "content/characters/enemy/chaos_poxwalker/gibbing/upper_torso_tentacle_arm_flesh"
torso_full.gib_settings.gib_actor = "rp_upper_torso_tentacle_arm_flesh_gib_01"
...
center_mass_full.gib_settings.gib_actor = "rp_upper_torso_tentacle_arm_flesh_gib_01"
...
center_mass_full.extra_hit_zone_gibs = {
	"head",
	"upper_right_arm",
	"tentacle",
	"upper_left_leg",
...
center_mass_left.gib_settings = tentacle.gib_settings
center_mass_left.stump_settings = tentacle.stump_settings
center_mass_left.scale_node = tentacle.scale_node
...
local gibbing_template = {
	...
	tentacle = {
		default = tentacle,
		warp = tentacle_arm_warp,
		warp_shard = tentacle_arm_warp_shard
	},
	upper_right_arm = {
		default = {
			conditional = {
