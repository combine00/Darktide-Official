...
local gib_units = {
	head = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/head_gib",
		head_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/head_01/head_gib"
	},
	left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_fullarm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_fullarm_gib"
	},
	upper_left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_arm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_upper_arm_gib"
	},
	lower_left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_lower_arm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_lower_arm_gib"
	},
	right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_fullarm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_fullarm_gib"
	},
	upper_right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_arm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_upper_arm_gib"
	},
	lower_right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_lower_arm_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_lower_arm_gib"
	},
	torso_sever = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/upper_torso_gib_full",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/upper_torso_gib_full"
	},
	torso_full = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/upper_torso_gib",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/upper_torso_gib"
	}
}
local stump_units = {
	left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_upper_arm_gib_cap"
	},
	upper_left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_upper_arm_gib_cap"
	...
	lower_left_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_lower_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/left_lower_arm_gib_cap"
	},
	right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_upper_arm_gib_cap"
	},
	upper_right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_upper_arm_gib_cap"
	...
	lower_right_arm = {
		default = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_lower_arm_gib_cap",
		var_01 = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/var_01/right_lower_arm_gib_cap"
	}
}
local name = "chaos_ogryn_bulwark"
local size = GibbingSettings.character_size.large
local gib_push_head = 7500
local gib_push_upper_arm = 12500
local gib_push_lower_arm = 12500
local gib_push_arm = gib_push_upper_arm + gib_push_lower_arm
local gib_push_upper_leg = 12500
local gib_push_lower_leg = 12500
...
head_crush.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/head_gib_cap"
...
lower_left_arm.gib_settings.gib_flesh_unit = "content/characters/enemy/chaos_ogryn/gibbing/flesh_left_lower_arm_gib"
...
lower_left_arm.stump_settings.stump_unit = stump_units.lower_left_arm
...
lower_right_arm.stump_settings.stump_unit = stump_units.lower_right_arm
...
left_arm.gib_settings.gib_flesh_unit = "content/characters/enemy/chaos_ogryn/gibbing/flesh_left_fullarm_gib"
left_arm.gib_settings.gib_spawn_node = "j_leftarm"
left_arm.gib_settings.gib_actor = "rp_left_fullarm_gib"
left_arm.stump_settings.stump_unit = stump_units.left_arm
...
right_arm.stump_settings.stump_unit = stump_units.right_arm
...
upper_left_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_leg_gib"
...
upper_left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_leg_gib_cap"
...
upper_right_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_leg_gib"
...
upper_right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_leg_gib_cap"
...
lower_left_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_lower_leg_gib"
...
lower_left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_lower_leg_gib_cap"
...
lower_right_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_lower_leg_gib"
...
lower_right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_lower_leg_gib_cap"
...
left_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_fullleg_gib"
...
left_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/left_upper_leg_gib_cap"
...
right_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_fullleg_gib"
...
right_leg.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/right_upper_leg_gib_cap"
...
torso_sever.stump_settings.stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/melee_a/upper_torso_gib_cap"
...
torso_full.gib_settings.gib_actor = "j_spine1"
...
center_mass_full.gib_settings.gib_actor = "j_spine1"
