...
local name = "cultist_shocktrooper_gibbing"
local size = GibbingSettings.character_size.small
local gib_push_head = 15
local gib_push_upper_arm = 100
local gib_push_lower_arm = 100
local gib_push_arm = gib_push_upper_arm + gib_push_lower_arm
local gib_push_upper_leg = 200
local gib_push_lower_leg = 200
local gib_push_leg = gib_push_upper_leg + gib_push_lower_leg
local gib_push_torso = 8000
local head_sever = table.clone(SharedGibbingTemplates.head)
head_sever.gib_settings.override_push_force = {
	gib_push_head,
	gib_push_head * 1.25
}
head_sever.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/head_gib"
...
lower_left_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/left_lower_leg_gib"
...
lower_right_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/right_lower_leg_gib"
...
left_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/left_fullleg_gib"
...
right_leg.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/right_fullleg_gib"
...
torso_sever.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/upper_torso_gib_full"
...
torso_full.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/upper_torso_gib"
...
center_mass_full.gib_settings.gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/upper_torso_gib"
