...
function MinionSpawnManager:replacement_breed(breed_name)
	local replacement_breed = nil
...
function MinionSpawnManager:request_param_table()
	table.clear(TEMP_INIT_DATA)

	return TEMP_INIT_DATA
end

function MinionSpawnManager:spawn_minion(breed_name, position, rotation, side_id, optional_param_table)
...
function MinionSpawnManager:queue_minion_to_spawn(breed_name, position, rotation, side_id)
...
function MinionSpawnManager:_initialize_blackboard_components(breed, blackboard, seed, optional_spawner_unit, optional_spawner_spawn_index)
...
function MinionSpawnManager:spawned_minions()
