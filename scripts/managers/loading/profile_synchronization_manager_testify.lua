...
function ProfileSynchronizationManagerTestify.equip_item(profile_synchronization_manager, data)
...
function ProfileSynchronizationManagerTestify.equip_item_backend(profile_synchronization_manager, data)
	local item = data.item
	local player = data.player
