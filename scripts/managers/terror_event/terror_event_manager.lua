...
function TerrorEventManager:set_terror_event_point_modifier(point_modifier)
	self._point_modifier = self._point_modifier + point_modifier
end

function TerrorEventManager:get_terror_event_point_modifier()
	return self._point_modifier
end

function TerrorEventManager:replace_terror_event_tags(tags_to_replace)
	self._tags_replacement = tags_to_replace
end

function TerrorEventManager:get_tags_replacement(side_name)
...
function TerrorEventManager:_update_event(event, dt, t)
