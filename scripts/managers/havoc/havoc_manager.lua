...
function HavocManager:init(is_server, world, nav_world, level_name, level_seed, pacing_control)
...
function HavocManager:_initialize_modifiers(havoc_data)
...
function HavocManager:minion_health_modifier(breed)
...
function HavocManager:_on_minion_unit_spawned(unit)
	if not self._modifiers or self._num_modifiers == 0 then
		return
	end
...
function HavocManager:_on_player_unit_spawned(player)
...
function HavocManager:get_power_level_modifier(attack_type)
...
function HavocManager:get_modifier_value(name)
...
function HavocManager:get_modifiers()
	return self._modifiers
end

function HavocManager:get_current_rank()
	return self._current_rank
end

function HavocManager:is_havoc()
...
function HavocManager:init_horde_buff(horde_buff_table)
