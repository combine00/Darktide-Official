...
function InputHoldTracker:init(input_service_name)
...
function InputHoldTracker:start_tracking(action_name, time_completed, cb_completed)
...
function InputHoldTracker:stop_tracking(id)
	self._tracked_actions[id] = nil
end

function InputHoldTracker:update(dt)
...
function InputHoldTracker:_reset_delayed_actions()
...
function InputHoldTracker:_trigger_delayed_actions(action_name)
...
function InputHoldTracker:_lookup_actions_with_same_input_key(action_name)
