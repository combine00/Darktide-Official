...
function CompanionInteractionsManager:init(is_host, network_event_delegate)
...
function CompanionInteractionsManager:destroy()
...
function CompanionInteractionsManager:fixed_update(dt, fixed_t, frame)
...
function CompanionInteractionsManager:is_player_interacting(player_unit)
...
function CompanionInteractionsManager:_start_interaction(player_unit, companion_unit, is_local_player)
	local active_interactions = self._active_interactions
...
function CompanionInteractionsManager:_stop_interaction(player_unit)
...
function CompanionInteractionsManager._interaction_fully_completed(player, interaction_settings)
...
function CompanionInteractionsManager:trigger_interaction(player_unit, companion_unit)
	if ALIVE[player_unit] and ALIVE[companion_unit] then
		self:_start_interaction(player_unit, companion_unit, not self._is_host)
	end
end

function CompanionInteractionsManager:stop_interaction(player_unit)
	self:_stop_interaction(player_unit)
end

function CompanionInteractionsManager:start_interaction_animation(interaction)
	if self._is_host then
...
function CompanionInteractionsManager:interrupt_interaction_animation(player_unit)
...
function CompanionInteractionsManager:set_interaction_duration_for_player_unit(player_unit, interaction_time)
...
function CompanionInteractionsManager:companion_is_in_position_for_interaction(companion_owner_unit, companion_unit)
...
function CompanionInteractionsManager:rpc_client_start_companion_interaction(_, player_unit_id, companion_unit_id)
...
function CompanionInteractionsManager:rpc_client_stop_companion_interaction(_, player_unit_id)
	local player_unit = Managers.state.unit_spawner:unit(player_unit_id)
...
function CompanionInteractionsManager:rpc_client_start_companion_interaction_anim_event(channel_id, player_unit_id, companion_unit_id, target_interaction_index)
	local player_unit = Managers.state.unit_spawner:unit(player_unit_id)
	local companion_unit = Managers.state.unit_spawner:unit(companion_unit_id)
	local animation_system = Managers.state.extension:system("animation_system")
	local interactions_settings = CompanionHubInteractionsSettings.interactions
...
function CompanionInteractionsManager:rpc_client_interrupt_companion_interaction_anim_event(channel_id, player_unit_id, companion_unit_id)
	local player_unit = Managers.state.unit_spawner:unit(player_unit_id)
	local companion_unit = Managers.state.unit_spawner:unit(companion_unit_id)
	local animation_system = Managers.state.extension:system("animation_system")
