...
function LadderNavTransition.find_ground_position(top_position, ladder_length, back_direction, down_direction, physics_world, drawer)
...
function LadderNavTransition.find_position_on_nav_mesh(start_position, nav_world, search_direction, traverse_logic, drawer)
...
function LadderNavTransition.is_bidirectional(ground_position, ladder_bottom_position)
