...
function Havoc:latest(optional_account_id)
...
function Havoc:summary(optional_account_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Havoc:fetch_paged_history(status_id, size)
	return Managers.backend:authenticate():next(function (account)
...
function Havoc:sync(optional_account_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Havoc:status_by_id(week_id, optional_account_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Havoc:refresh_settings()
...
function Havoc:settings()
	return self._havoc_settings
end

function Havoc:personal_mission(mission_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Havoc:delete_personal_mission(mission_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
		local builder = BackendUtilities.url_builder():path("/data/"):path(account_id):path("/account/missions/"):path(mission_id)
		local options = {
...
function Havoc:reject_order(order_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
