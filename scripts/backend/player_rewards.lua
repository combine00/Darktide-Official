...
function PlayerRewards:get_penance_rewards_by_source(wrapped, promise, all_rewards)
	if not wrapped then
...
function PlayerRewards:get_rewards_by_source_paged(limit, source)
...
function PlayerRewards:claim_bundle_reward(bundle_reward_id)
