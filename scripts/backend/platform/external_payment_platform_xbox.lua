...
function ExternalPaymentPlatformXbox:update_account_store_status()
...
function ExternalPaymentPlatformXbox:payment_options()
	local language = "en"
...
function ExternalPaymentPlatformXbox:_decorate_option(option, platform_entitlements)
	option.description = {
		type = "currency",
...
function ExternalPaymentPlatformXbox:get_options()
