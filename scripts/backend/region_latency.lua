...
function RegionLatency:get_preferred_reef()
	self:pre_get_region_latencies()
...
function RegionLatency:_convert_decimal_to_int_latency(decimal)
...
function RegionLatency:get_reef_info_based_on_region_latencies(region_latencies)
	local reefs = {}
