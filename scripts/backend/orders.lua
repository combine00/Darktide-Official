...
function Orders:order_by_id(order_id, optional_account_id)
...
function Orders:orders_by_order_type(order_type, optional_account_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Orders:join_personal_mission(owner_id, mission_id, joiner_id)
	return Managers.backend:authenticate():next(function (account)
...
function Orders:activate_order_by_id(order_id, participants, optional_account_id)
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
...
function Orders:check_ongoing_missions()
	return Managers.backend:authenticate():next(function (account)
		local account_id = account.sub
