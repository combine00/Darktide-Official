...
function DLCLicense.licensed_products_get(account_id, player_profile, platform_id)
...
function DLCLicense.licensed_products_update(account_id, product_ids, challenge_string)
