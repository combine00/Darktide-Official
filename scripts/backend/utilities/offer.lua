...
function Offer:init(store_front, offer, is_personal)
...
function Offer:is_valid_at(now)
	...
	return (price.validFrom == nil or tonumber(price.validFrom) < now) and (price.validTo == nil or now < tonumber(price.validTo))
end
