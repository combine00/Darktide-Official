...
function ConnectionLocalStateMachine:init(event_delegate, engine_lobby, host_peer_id, network_hash, host_type, profile_synchronizer_client, slots_to_reserve, jwt_ticket)
	...
	state_machine:add_transition("LocalSyncStatsState", "stats synced", LocalAwaitHostConnectState)
	state_machine:add_transition("LocalSyncStatsState", "timeout", LocalDisconnectedState)
	state_machine:add_transition("LocalSyncStatsState", "disconnected", LocalDisconnectedState)
...
function ConnectionLocalStateMachine:tick_rate()
