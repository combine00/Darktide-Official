...
function LocalSyncStatsState:_is_ready(local_player_id)
	return Managers.stats:user_state(local_player_id) == Managers.stats.user_states.idle
end

function LocalSyncStatsState:init(state_machine, shared_state)
...
function LocalSyncStatsState:destroy()
...
function LocalSyncStatsState:update(dt)
	local shared_state = self._shared_state
...
function LocalSyncStatsState:rpc_stat_version_mismatch(_, local_player_id)
...
function LocalSyncStatsState:rpc_stat_version_matched(_)
