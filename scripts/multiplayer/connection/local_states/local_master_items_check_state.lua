...
function LocalMasterItemsCheckState:init(state_machine, shared_state)
...
function LocalMasterItemsCheckState:destroy()
...
function LocalMasterItemsCheckState:update(dt)
	local shared_state = self._shared_state
...
function LocalMasterItemsCheckState:rpc_master_items_version_reply(channel_id, host_items_version, host_items_url)
...
function LocalMasterItemsCheckState:_update_master_items(version, url)
