...
function LocalMechanismVerificationState:init(state_machine, shared_state)
...
function LocalMechanismVerificationState:destroy()
	local shared_state = self._shared_state

	shared_state.event_delegate:unregister_channel_events(shared_state.channel_id, unpack(RPCS))
end

function LocalMechanismVerificationState:update(dt)
	local shared_state = self._shared_state
...
function LocalMechanismVerificationState:rpc_check_mechanism_reply(channel_id, mechanism_matched, mismatch_reason)
