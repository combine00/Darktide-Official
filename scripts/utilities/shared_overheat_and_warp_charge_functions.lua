local SharedOverheatAndWarpChargeFunctions = {
	...
	increase_over_time = function (dt, charge_level, add_percentage, full_charge_add_percentage, charge_duration, current_percentage)
		local actual_add_percentage, actual_charge_duration = nil
