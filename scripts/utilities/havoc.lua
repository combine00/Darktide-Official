...
function Havoc.generate_havoc_data(havoc_rank, seed)
	seed = seed or math.random(23062419930608.0, 2023062419930608.0)
	SEED = seed
	...
	local extra_circumstance, increased_difficulty, theme = nil
...
function Havoc.parse_data(data)
	local parsed_data = {}
