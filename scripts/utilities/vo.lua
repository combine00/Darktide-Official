...
function Vo.health_critical_event(unit)
...
function Vo.interaction_start_event(unit, target_unit, interaction_template_name)
...
function Vo.throwing_item_event(unit, projectile_template)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.out_of_ammo_event(inventory_slot_component, visual_loadout_extension)
...
function Vo.ammo_hog_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.health_hog_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.head_shot_event(killer_unit, distance, damage_profile_name)
...
function Vo.player_interaction_vo_event(interactor_unit, interactee_unit, interaction_vo_event)
...
function Vo.kill_spree_self_event(killer_unit)
...
function Vo.player_damage_event(unit, damage)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.player_land_event(unit, time_in_falling)
...
function Vo.coughing_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
	local event_name = "expression"
...
function Vo.coughing_ends_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
	local event_name = "expression"
...
function Vo.pouncing_alert_event(target_unit, pouncing_breed)
...
function Vo.warning_event(target_unit, trigger_id)
	local dialogue_extension = ScriptUnit.has_extension(target_unit, "dialogue_system")
...
function Vo.player_suppressed_event(unit)
...
function Vo.timer_based_vo_event(unit, vo_event_data)
	local context_extension = ScriptUnit.has_extension(unit, "dialogue_context_system")
...
function Vo.armor_hit_event(unit)
	local context_extension = ScriptUnit.has_extension(unit, "dialogue_context_system")
...
function Vo.friendly_fire_counter_event(attacking_unit, attacked_unit)
...
function Vo.friendly_fire_event(attacking_unit, attacked_unit)
...
function Vo.player_ledge_hanging_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_kill_event(killer_unit, killed_unit)
	if killer_unit then
		local killer_dialogue_extension = ScriptUnit.has_extension(killer_unit, "dialogue_system")
...
function Vo.player_vo_enemy_attack_event(unit, breed_name, vo_event)
...
function Vo.closest_player_except_vo_enemy_attack_event(unit, breed_name, vo_event, position, filtered_player_unit)
...
function Vo.monster_health_critical_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.monster_combat_conversation(unit, breed_name)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.player_guidance_wrong_way_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.play_expression_relief_vo()
	local random_player = _get_random_player()
	local dialogue_extension = ScriptUnit.has_extension(random_player, "dialogue_system")
	local event_name = "expression"
...
function Vo.enemy_shooting_from_covers_event()
	local random_player = _get_random_player()
	local dialogue_extension = ScriptUnit.has_extension(random_player, "dialogue_system")
...
function Vo.player_death_event(dead_player_unit)
...
function Vo.play_combat_ability_event(unit, vo_tag)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.heard_horde(unit, horde_type)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.look_at_event(dialogue_extension, tag, distance, target_unit)
...
function Vo.faction_look_at_event(dialogue_extension, faction_event, faction_name, tag, distance)
	local event_data = dialogue_extension:get_event_data_payload()
	local observer_vo_class = dialogue_extension:vo_class_name()
	local observer_vo_profile = dialogue_extension:get_voice_profile()
	event_data.look_at_tag = tag
...
function Vo.distance_based_event(unit, proximity_type, event_data)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.needs_rescue_event(unit, event_name, event_data, hogtied_friends)
...
function Vo.seen_enemy_event(unit, enemy_tag, enemy_unit, distance)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.heard_enemy_event(unit, enemy_tag, enemy_unit, distance)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.generic_mission_vo_event(unit, trigger_id, skip_disabled_check)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.generic_mission_vo_event_closest_friend(unit, trigger_id)
...
function Vo.generic_mission_vo_event_all_players(trigger_id)
...
function Vo.environmental_story_vo_event(unit, story_name)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.player_enemy_alert_event(unit, breed_name, vo_event)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.player_pounced_by_special_event(unit, breed_name)
	local dialogue_extension = ScriptUnit.extension(unit, "dialogue_system")
...
function Vo.knocked_down_multiple_times_event(downed_unit)
...
function Vo.player_knocked_down_multiple_times_event(downed_unit)
...
function Vo.player_catapulted_event(unit)
	if unit then
		local fx_extension = ScriptUnit.extension(unit, "fx_system")
		local visual_loadout_extension = ScriptUnit.extension(unit, "visual_loadout_system")
...
function Vo.player_catapulted_land_event(unit)
	if unit then
		local fx_extension = ScriptUnit.extension(unit, "fx_system")
		local visual_loadout_extension = ScriptUnit.extension(unit, "visual_loadout_system")
...
function Vo.enemy_take_position_event(unit)
...
function Vo.enemy_alerted_idle_event(unit, breed_name)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.random_player_enemy_alert_event(enemy_unit, enemy_breed, vo_event, optional_non_threatening_player)
...
function Vo.enemy_ranged_idle_event(unit)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_take_cover_event(unit)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_call_backup_event(unit)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_spawn_vo_event(unit, spawn_event_name)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_skulk_event(unit)
	local dialogue_ext = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_vo_event(unit, event_name)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_generic_vo_event(unit, trigger_id, breed_name_or_nil, target_distance)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.enemy_generic_vo_event_2d(voice_profile, trigger_id, breed_name_or_nil)
...
function Vo.enemy_vo_special_attack_event(unit, event_type)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.mission_giver_event(unit, concept)
...
function Vo.mission_giver_mission_brief_event(unit, mission_brief_starter_line)
	local dialogue_input = ScriptUnit.extension_input(unit, "dialogue_system")
...
function Vo.mission_giver_mission_info(unit, trigger_id)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.mission_giver_mission_info_vo(voice_selection, selected_voice, trigger_id)
	local is_server = Managers.state.game_session:is_server()
...
function Vo.mission_giver_point_of_interest_vo(dialogue_target_filter, look_at_tag, mission_giver_selected_voice, distance)
	local is_server = Managers.state.game_session:is_server()
...
function Vo.mission_giver_vo_event(voice_profile, concept, trigger_id)
	local unit = _get_mission_giver_unit(voice_profile)
...
function Vo.confessional_vo_event(unit, category)
	if unit then
		local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.play_npc_interacting_vo_event(unit, interactor_unit, vo_event, cooldown_time, play_in)
	local is_server = Managers.state.game_session:is_server()
...
function Vo.play_npc_vo_event(unit, vo_event)
	local dialogue_ext_npc = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.mission_giver_conversation_starter(unit, trigger_id)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.play_npc_story(trigger_id)
...
function Vo.play_voice_fx_preset_preview(world, voice_fx_preset, sound_event)
...
function Vo.on_demand_vo_event(unit, concept, trigger_id, target_unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.start_banter_vo_event(unit, trigger_id)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.reinforcements(dialogue_extension_unit, dialogue_extension)
...
function Vo.backend_vo_event(backend_group_id)
	local is_server = Managers.state.game_session:is_server()
...
function Vo.play_next_backend_vo(backend_group_id, optional_substring)
	local dialogue_system = Managers.state.extension:system_by_extension("DialogueExtension")
...
function Vo.substring_exists_in_backend_vo(backend_group_id, substring)
	local dialogue_system = Managers.state.extension:system_by_extension("DialogueExtension")
...
function Vo.play_local_vo_event(unit, rule_name, wwise_route_key, seed, is_opinion_vo, optional_use_radio_pre, optional_use_radio_post)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.trigger_subtitle(currently_playing_subtitle)
	local is_server = Managers.state.game_session:is_server()
...
function Vo.mission_giver_check_event()
	local is_server = Managers.state.game_session:is_server()
...
function Vo.stop_currently_playing_vo(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.stop_all_currently_playing_vo()
	local dialogue_system = Managers.state.extension:system_by_extension("DialogueExtension")
...
function Vo.set_ignore_server_play_requests(value)
	local dialogue_system = Managers.state.extension:system_by_extension("DialogueExtension")
...
function Vo.is_currently_playing_dialogue(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.spawn_2d_unit(breed_name)
	local voice_over_spawn_manager = Managers.state.voice_over_spawn
...
function Vo.spawn_3d_unit(breed_name, voice_profile, position)
	local voice_over_spawn_manager = Managers.state.voice_over_spawn
	local dialogue_breed_setting = DialogueBreedSettings[breed_name]
...
function Vo.is_mission_available(mission_name)
	local available = nil
...
function Vo.cutscene_vo_event(unit, vo_line_id)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
...
function Vo.play_debug_vo_event(unit)
	local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
	local event_name = "warning"
