...
function ExperiencePresentation.update_presentation(data, dt, t)
...
function ExperiencePresentation.skip_to_next_timestamp(data)
	local experience_settings = data.experience_settings
	local start_level = data.start_level
...
function ExperiencePresentation.setup_presentation_data(experience_settings, starting_experience, experience_gained, presentation_duration, level_up_delay)
