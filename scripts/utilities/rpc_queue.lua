...
function RPCQueue:init(channel_id, settings)
	self._queue = {}
...
function RPCQueue:_can_send_next_rpc()
...
function RPCQueue:_send_next_rpc()
	local channel_id = self._channel_id
...
function RPCQueue:queue_rpc(rpc_name, ...)
