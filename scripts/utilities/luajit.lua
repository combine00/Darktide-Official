...
function LuaJIT.clock_diff(b, a)
	return tonumber(b - a)
end
...
function LuaJIT.bytes(object, exclusive)
	return sizeof(not exclusive and {}, object)
end

function LuaJIT.bytes_ex(object, lut)
