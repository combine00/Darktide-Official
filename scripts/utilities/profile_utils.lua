...
function ProfileUtils.character_companion_name(profile)
...
function ProfileUtils.title_item_name_no_color(title_item, profile)
	local title_text = ""
...
function ProfileUtils.character_title_no_color(profile)
	local text = ""
...
function ProfileUtils.character_title(profile)
	local text = ""
	local loadout = profile.loadout
...
function ProfileUtils.save_active_profile_preset_id(profile_preset_id)
...
function ProfileUtils.get_available_profile_preset_id()
	return math.uuid()
end

function ProfileUtils.add_profile_preset()
...
function ProfileUtils.remove_profile_preset(profile_preset_id)
...
function ProfileUtils.get_active_profile_preset_id()
	local character_data = _character_save_data()
...
function ProfileUtils.save_item_id_for_profile_preset(profile_preset_id, slot_id, item_gear_id)
	local character_data = _character_save_data()
...
function ProfileUtils.save_talent_id_for_profile_preset(profile_preset_id, talent_name, activated)
	local character_data = _character_save_data()
...
function ProfileUtils.save_talent_nodes_for_profile_preset(profile_preset_id, talent_nodes, talents_version)
	local character_data = _character_save_data()
...
function ProfileUtils.save_talent_node_for_profile_preset(profile_preset_id, talent_node_name, points_spent)
	local character_data = _character_save_data()
...
function ProfileUtils.clear_all_talent_nodes_for_profile_preset(profile_preset_id)
	local character_data = _character_save_data()
...
function ProfileUtils.get_profile_preset(profile_preset_id)
	local character_data = _character_save_data()
...
function ProfileUtils.get_profile_presets()
	local character_data = _character_save_data()
...
function ProfileUtils.verify_saved_profile_presets_talents_version(character_id, archetype_name)
	local archetype = Archetypes[archetype_name]
	local talent_layout_file_path = archetype.talent_layout_file_path
...
function ProfileUtils.generate_visual_loadout(loadout)
	local ui_loadout = {}
...
function ProfileUtils.generate_visual_item(item)
...
function ProfileUtils.has_companion(profile)
