...
function ContractCriteriaParser.parse_backend_criteria(backend_criteria)
...
function ContractCriteriaParser.localize_criteria(backend_criteria)
...
function ContractCriteriaParser.icon(backend_criteria)
