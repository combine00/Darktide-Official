...
function AimAssist.sensitivity_modifier(aim_assist_context)
	local aim_assist_type = Managers.save:account_data().input_settings.controller_aim_assist
...
function AimAssist.apply_movement_aim_assist(aim_assist_context, orientation, input, look_delta, dt, t)
...
function AimAssist.apply_lock_on(aim_assist_context, main_t, targeting_data, look_delta, yaw, pitch)
...
function AimAssist.store_target_position(aim_assist_context, orientation)
