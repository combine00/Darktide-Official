local CompanionVisualLoadout = {
	assign_fur_material = function (unit, attachment_units_by_unit)
...
function CompanionVisualLoadout.trigger_gear_sound(unit, source_id, sound_alias, profile_properties_wwise_switch)
...
function CompanionVisualLoadout.trigger_looping_gear_sound(unit, source_id, sound_alias, profile_properties_wwise_switch)
	local wwise_world, owner_visual_loadout_extension, use_husk_events = _wwise_world_and_visual_loadout_extension(unit)
