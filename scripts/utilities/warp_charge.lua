...
function WarpCharge.check_new_state(warp_charge_component, prevent_explosion)
...
function WarpCharge.start_warp_action(t, warp_charge_component)
...
function WarpCharge.increase_over_time(dt, t, charge_level, warp_charge_component, charge_template, owner_unit, first_charge)
	local buff_extension = ScriptUnit.has_extension(owner_unit, "buff_system")
	local stat_buffs = buff_extension and buff_extension:stat_buffs()
	local psyker_smite = charge_template.psyker_smite
	local psyker_smite_multiplier = psyker_smite and stat_buffs and stat_buffs.psyker_smite_cost_multiplier or 1
...
function WarpCharge.can_vent(warp_charge_component, action_settings)
...
function WarpCharge.archetype_warp_charge_template(player)
