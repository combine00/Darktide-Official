...
function MinionAttack.get_aim_position(unit, scratchpad, optional_line_of_sight_id, optional_aim_node_name)
...
function MinionAttack.push_nearby_enemies(unit, scratchpad, action_data, ignored_unit, optional_only_ahead_targets, optional_ignored_breeds)
...
function MinionAttack.sweep(unit, breed, sweep_node, scratchpad, blackboard, target_unit, action_data, physics_world, sweep_hit_units_cache, override_damage_profile_or_nil, override_damage_type_or_nil, attack_event, optional_ignore_target_unit)
