...
function MinionShield.init_block_timings(scratchpad, action_data, anim_event, t)
...
function MinionShield.reset_block_timings(scratchpad, unit)
...
function MinionShield.update_block_timings(scratchpad, unit, t)
