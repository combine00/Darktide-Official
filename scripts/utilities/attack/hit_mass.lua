...
function HitMass.target_hit_mass(attacker_unit, target_unit, hit_weakspot)
...
function HitMass.consume_hit_mass(attacker_unit, target_unit, hit_mass_budget_attack, hit_mass_budget_impact, hit_weakspot, hit_mass_override)
