...
local BotAoeThreat = {}
local EPSILON = 0.01
local THREAT_NAV_MESH_ABOVE = 2
local THREAT_NAV_MESH_BELOW = 2

function BotAoeThreat.detect_sphere(nav_world, traverse_logic, bot_position, bot_height, bot_radius, sphere_x, sphere_y, sphere_z, rotation, sphere_radius, duration)
...
function BotAoeThreat.detect_cylinder(nav_world, traverse_logic, bot_position, bot_height, bot_radius, x, y, z, rotation, size, duration)
...
function BotAoeThreat.detect_oobb(nav_world, traverse_logic, bot_position, bot_height, bot_radius, x, y, z, rotation, extents, duration)
