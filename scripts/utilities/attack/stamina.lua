...
function Stamina.drain_pecentage(unit, amount_percentage, t)
	local unit_data_ext = ScriptUnit.extension(unit, "unit_data_system")
	local stamina_write_component = unit_data_ext:write_component("stamina")
	local buff_extension = ScriptUnit.has_extension(unit, "buff_system")
	local stat_buffs = buff_extension and buff_extension:stat_buffs()
...
function Stamina.drain_pecentage_of_base_stamina(unit, amount_percentage, t)
	local unit_data_ext = ScriptUnit.extension(unit, "unit_data_system")
	local archetype = unit_data_ext:archetype()
	local base_stamina_template = archetype.stamina
...
function Stamina.update(t, dt, stamina_write_component, archetype_stamina_template, unit, fixed_frame)
...
function Stamina.current_and_max_value(unit, stamina_read_component, archetype_stamina_template)
	local buff_extension = ScriptUnit.has_extension(unit, "buff_system")
	local weapon_extension = ScriptUnit.has_extension(unit, "weapon_system")
	local weapon_modifier = 0
