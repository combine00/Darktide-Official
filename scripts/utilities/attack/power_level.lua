...
function PowerLevel.scale_power_level_to_power_type_curve(power_level, power_type, stat_buffs_or_nil, attack_type_or_nil, weakspot_or_nil)
...
function PowerLevel.scale_by_charge_level(power_level, charge_level, charge_level_scaler)
