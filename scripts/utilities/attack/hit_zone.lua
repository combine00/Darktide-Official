...
local HitZone = {}
local hit_zone_names = table.enum("head", "torso", "lower_tail", "upper_tail", "tongue", "upper_left_arm", "lower_left_arm", "upper_right_arm", "lower_right_arm", "upper_left_leg", "lower_left_leg", "upper_right_leg", "lower_right_leg", "afro", "center_mass", "backpack", "tentacle", "captain_void_shield", "corruptor_armor", "shield", "weakspot", "right_shoulderguard", "delayed_gib")
HitZone.hit_zone_names = hit_zone_names
local _hit_zone_position = nil

function HitZone.get(unit, actor)
...
function HitZone.get_name(unit, actor)
...
function HitZone.get_actor_names(unit, hit_zone_name)
	local unit_data_ext = ScriptUnit.has_extension(unit, "unit_data_system")
...
function HitZone.initialize_lookup(unit, hit_zones)
...
function HitZone.destroy_hit_zone(unit, hit_zone_lookup, hit_zone_actors_lookup, hit_zone_name)
...
function HitZone.actor_index(unit, actor)
...
function HitZone.hit_zone_center_of_mass(target_unit, hit_zone_name, average_positions)
