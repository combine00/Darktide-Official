...
function Options.create_percent_slider_template(params)
...
function Options.create_value_slider_template(params)
...
function Options.keybind_value_to_string(value)
	if not value then
		return
	end
