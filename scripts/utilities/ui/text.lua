...
function TextUtilities.localize_with_button_hint(action, localization_key, optional_localization_context, optional_service_type, optional_pattern, include_input_type, color_tint_text)
...
function TextUtilities.format_time_span_localized(seconds, use_short, allow_skip, max_detail)
...
function TextUtilities.format_time_span_long_form_localized(seconds)
