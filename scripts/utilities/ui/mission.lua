...
function Missions.is_mission_same_as_narrative_mission_values(mission, book, chapter, page)
...
function Missions.get_latest_narrative_mission(missions)
	local book = 0
	local chapter = 0
	local page = 0
...
function Missions.filter_narrative_mission_by_values(missions, book, chapter, page)
...
function Missions.get_latest_narrative_mission_values(missions)
	local mission = Missions.get_latest_narrative_mission(missions)

	return Missions.get_narrative_mission_values(mission)
end

function Missions.filter_latest_narrative_missions(missions)
