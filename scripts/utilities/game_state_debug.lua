...
function GameStateDebug:init()
	self._state_machines = {}
	self._cached_description = ""
	self._dirty = true
end

function GameStateDebug:on_state_machine_created(parent_sm_name, sm_name, initial_state)
...
function GameStateDebug:on_change_state(sm_name, state_name)
...
function GameStateDebug:on_destroy_state_machine(sm_name)
...
function GameStateDebug:_find_state_machine(sm_name, sms)
...
function GameStateDebug:_create_descriptions(sm)
...
function GameStateDebug:get_current_state_description()
