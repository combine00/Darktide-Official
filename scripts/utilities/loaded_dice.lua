...
function LoadedDice.create(probabilities, normalized)
...
function LoadedDice.roll(probabilities, alias)
...
function LoadedDice.roll_seeded(probabilities, alias, seed)
