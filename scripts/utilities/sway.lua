...
function Sway.add_immediate_sway(sway_template, sway_control_component, sway_component, movement_state_component, sway_type, optional_num_hits)
...
function Sway.add_fixed_immediate_sway(sway_control_component, immediate_pitch, immediate_yaw)
	sway_control_component.immediate_pitch = immediate_pitch
	sway_control_component.immediate_yaw = immediate_yaw
end

function Sway.apply_sway_rotation(sway_template, sway_component, movement_state_component, rotation)
	if not sway_template then
		return rotation
	end
...
function Sway.movement_state_settings(sway_template, movement_state_component)
	if not sway_template then
		return nil
	end
