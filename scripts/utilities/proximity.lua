...
function Proximity.check_proximity_of_position(position, relation_side_names, radius, out_result_table, filter_function, broadphase)
...
function Proximity.check_proximity(unit, relation_side_names, radius, out_result_table, filter_function, broadphase)
	Proximity._check_proximity(POSITION_LOOKUP[unit], relation_side_names, radius, out_result_table, filter_function, broadphase)
end

function Proximity.check_sticky_proximity(unit, relation_side_names, radius, out_result_table, filter_function, broadphase, stickiness_limit, stickiness_time, stickiness_table, prev_proximity_units, dt)
