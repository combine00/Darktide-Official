...
function Pocketable.drop_pocketable(t, physics_world, is_server, player_unit, inventory_component, visual_loadout_extension, slot_name)
...
function Pocketable.equip_pocketable(t, is_server, player_unit, pickup_unit, inventory_item, slot_name)
...
function Pocketable.item_from_name(item_name)
