...
local _num_decimals, _number_value_formatter, _value_from_path, _lerp_stepped_value, _try_format_values, _try_localization_info = nil
...
function TraitValueParser.trait_description(item, trait_level, lerp_value)
