...
local RangedAction = {
	...
	execute_attack = function (target_index, attacker_unit, hit_unit, hit_actor, hit_position, hit_distance, attack_direction, hit_normal, hit_zone_name_or_nil, damage_profile, lerp_values, power_level, charge_level, penetrated, instakill, damage_type, is_critical_strike, weapon_item_or_nil, triggered_proc_events_or_nil)
	...
	explosion_arming_distance = function (attacker_unit, damage_config)
...
function RangedAction.armor_explosion(is_server, world, physics_world, attacker_unit, hit_unit, hit_zone_name_or_nil, hit_position, hit_normal, hit_distance, attack_direction, damage_config, power_level, charge_level, weapon_item_or_nil, origin_slot_or_nil)
...
function RangedAction.hitmass_explosion(is_server, world, physics_world, hit_mass_budget_attack, hit_mass_budget_impact, attacker_unit, hit_unit, hit_position, hit_normal, hit_distance, attack_direction, damage_config, attack_result, power_level, charge_level, weapon_item_or_nil, origin_slot_or_nil)
	if not is_server then
		return false
	end
