...
function Action.damage_template(action)
...
function Action.explosion_template(action)
	local fire_configuration = action.fire_configuration
...
function Action.power_level(action)
...
function Action.stat_power_level(action)
