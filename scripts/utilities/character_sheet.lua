...
local _fill_ability_blitz_or_aura, _add_modifier = nil
local TRASH_TABLE = {}
local PASSIVES_BEST_IDENTIFIER = {}
local COHERENCY_BEST_IDENTIFIER = {}
local SPECIAL_RULE_BEST_IDENTIFIER = {}

function CharacterSheet.class_loadout(profile, destination, force_base_talents, optional_selected_nodes)
	...
	local modifiers = destination.modifiers
...
function CharacterSheet.convert_talents_to_node_layout(profile, selected_talents)
