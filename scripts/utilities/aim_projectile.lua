...
function AimProjectile.get_spawn_parameters_from_aim_component(action_aim_projectile_component)
...
function AimProjectile.check_throw_position(throw_position, look_position, projectile_locomotion_template, radius, physics_world)
