...
function MinionPatrols.update_roamer_patrols(patrol_data, roamers, nav_world, zones)
...
function MinionPatrols.release_patrol_zone_location(claimed_patrol_zone_indexes, patrol_roamer)
