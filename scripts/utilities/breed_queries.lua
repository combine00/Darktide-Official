...
local BreedQueries = {
	match_minions_by_tags = function (template_breed_tags, optional_excluded_breed_tags, wanted_sub_faction)
		local best_breeds = {}
...
function BreedQueries.add_spawns_single_breed(spawners, breed_name, breed_amount, spawn_side_id, target_side_id, spawned_minion_data, optional_mission_objective_id, optional_attack_selection_template_name, optional_aggro_state, optional_group_id, optional_max_health_modifier, optional_spawn_delay)
