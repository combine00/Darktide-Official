...
function CharacterCreate:is_option_visible(option)
	local is_item = option.value and type(option.value) == "table" and (option.value.gear_id or not not option.value.always_owned)
	local start_data_table_path = nil
...
function CharacterCreate:is_option_available(option)
	local is_item = option.value and type(option.value) == "table" and (option.value.gear_id or option.value.always_owned ~= nil)
	local start_data_table_path, home_planet_data_table, childhood_data_table, growing_up_data_table, formative_event_data_table = nil
...
function CharacterCreate:_filter_options_by_visibility(options)
...
function CharacterCreate:_filter_options_by_restrictions(options)
	local filter_options = {}
...
function CharacterCreate:_add_companion_items(profile)
...
function CharacterCreate:_remove_companion_items(profile)
	for slot, item_name in pairs(default_companion_items) do
...
function CharacterCreate:set_planet(id)
...
function CharacterCreate:set_childhood(id)
...
function CharacterCreate:set_growing_up(id)
...
function CharacterCreate:set_formative_event(id)
...
function CharacterCreate:set_crime(id)
...
function CharacterCreate:randomize_companion_name()
...
function CharacterCreate:companion_name(name)
	return self._profile.companion and self._profile.companion.name or ""
end

function CharacterCreate:set_companion_name(name)
...
function CharacterCreate:check_companion_name(name)
	local profiles_service = Managers.data_service.profiles
...
function CharacterCreate:get_transformation_complete()
...
function CharacterCreate:_add_crime_items_to_parsed_profile()
...
function CharacterCreate:transform(character_id, operation_cost)
...
function CharacterCreate:reload_real_character()
...
function CharacterCreate:_fetch_crime_items()
...
function CharacterCreate:_get_current_crime_items_ids(crime_items)
	local items = {}
...
function CharacterCreate:_replace_old_crime_items_in_loadouts(slots_to_equip, granted_garbs)
...
function CharacterCreate:_get_crime_item_by_id(gear_id)
	if not gear_id then
		return
	end
