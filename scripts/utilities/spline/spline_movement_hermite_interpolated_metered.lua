...
function SplineMovementHermiteInterpolatedMetered:recalc_splines()
...
function SplineMovementHermiteInterpolatedMetered:reset_to_start()
	self._current_spline_index = 1
	self._current_subdivision_index = 1
	self._t = 0
	self._current_spline_curve_distance = 0
...
function SplineMovementHermiteInterpolatedMetered:reset_to_end()
	local current_spline = self:_current_spline()
...
function SplineMovementHermiteInterpolatedMetered:current_spline_curve_distance()
