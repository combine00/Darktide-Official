...
function Component.parse_components(components, is_array_function, is_struct_array_function)
...
function Component.has_component_by_name(unit, component_name)
...
function Component.get_components_by_name(unit, component_name)
	local component_system = Managers.state.extension:system("component_system")
	local components = component_system:get_components(unit, component_name)
...
function Component.get_all_components(unit)
	local component_system = Managers.state.extension:system("component_system")
...
function Component.event(unit, event, ...)
	return Managers.state.extension:system("component_system"):trigger_event(unit, event, ...)
end

function Component.trigger_event_on_clients(component, event_name, rpc_name, ...)
...
function Component.hot_join_sync_event_to_client(client, channel, component, event_name, rpc_name, ...)
...
function Component:receive_client_event(sender, is_level_index, id, network_index, event_id, ...)
