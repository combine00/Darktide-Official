...
function NurgleManifestation:init(unit)
	self._editor = false
	self._unit = unit
...
function NurgleManifestation:editor_init(unit)
	self:init(unit)
...
function NurgleManifestation:enable(unit)
	return
end

function NurgleManifestation:disable(unit)
	return
end

function NurgleManifestation:destroy(unit)
	self:despawn_children(unit)
end

function NurgleManifestation:editor_validate(unit)
	return true, ""
end

function NurgleManifestation:update(unit, dt, t)
...
function NurgleManifestation:editor_update(unit, dt, t)
	self:update(unit, dt, t)

	return true
end

function NurgleManifestation:spawn_children(unit)
...
function NurgleManifestation:despawn_children(unit)
	local world = Unit.world(unit)
...
function NurgleManifestation:awake(unit)
...
function NurgleManifestation:set_material_variables(unit)
...
function NurgleManifestation:trigger_effects(unit)
...
function NurgleManifestation:set_up_actors(unit)
...
function NurgleManifestation:start()
...
function NurgleManifestation:stop()
	local networked_timer_extension = self._networked_timer_extension
...
function NurgleManifestation:reset()
	local networked_timer_extension = self._networked_timer_extension
