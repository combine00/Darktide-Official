...
function SharedNav.create_nav_info()
	local component_nav_info = {
		nav_world_from_level_id = {},
		nav_tag_cost_table_from_level_id = {},
		traverse_logic_from_level_id = {},
		nav_gen_guid = nil
	}
...
function SharedNav.check_new_navmesh_generated(nav_info, component_nav_guid, with_traverse_logic)
