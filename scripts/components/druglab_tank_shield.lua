...
function DruglabTankShield:init(unit)
	self._unit = unit
...
function DruglabTankShield:extensions_ready(world, unit)
	self._health_extension = ScriptUnit.has_extension(unit, "health_system")
end

function DruglabTankShield:editor_validate(unit)
	return true, ""
end

function DruglabTankShield:enable(unit)
	return
end

function DruglabTankShield:disable(unit)
	return
end

function DruglabTankShield:destroy(unit)
	return
end

function DruglabTankShield:update(unit, dt, t)
...
function DruglabTankShield:druglab_tank_shield_start_overload()
