...
function RandomizedFriendRockUnit:init(unit)
	self._unit = unit
...
function RandomizedFriendRockUnit:enable(unit)
	return
end

function RandomizedFriendRockUnit:disable(unit)
	return
end

function RandomizedFriendRockUnit:destroy(unit)
	return
end

function RandomizedFriendRockUnit:_setup()
...
function RandomizedFriendRockUnit:random_visibility_group_index()
	local num_visibility_groups = self._num_visibility_groups
...
function RandomizedFriendRockUnit:show_visibility_group(visibility_group_index)
	local current_visibility_group_index = self._current_visibility_group_index
