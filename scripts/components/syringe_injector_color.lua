...
function SyringeInjectorColor:init(unit)
...
function SyringeInjectorColor:editor_init(unit)
	self:init(unit)
end

function SyringeInjectorColor:editor_validate(unit)
	return true, ""
end

function SyringeInjectorColor:enable(unit)
	return
end

function SyringeInjectorColor:disable(unit)
	return
end

function SyringeInjectorColor:destroy(unit)
	return
end
...
function SyringeInjectorColor:set_decal(unit, decal_index)
