...
function PropOnHitPhysics:init(unit, is_server)
	self._unit = unit
...
function PropOnHitPhysics:editor_init()
	return
end

function PropOnHitPhysics:editor_validate(unit)
	return true, ""
end

function PropOnHitPhysics:enable(unit)
	return
end

function PropOnHitPhysics:disable(unit)
	return
end

function PropOnHitPhysics:destroy(unit)
	return
end
...
function PropOnHitPhysics.events:on_hit(attack_direction)
