...
function CutsceneCompanion:init(unit)
...
function CutsceneCompanion:extensions_ready(world, unit)
...
function CutsceneCompanion:editor_validate(unit)
	return true, ""
end

function CutsceneCompanion:enable(unit)
	return
end

function CutsceneCompanion:disable(unit)
	return
end

function CutsceneCompanion:destroy(unit)
	return
end

function CutsceneCompanion:cinematic_name()
	return self._cinematic_name
end

function CutsceneCompanion:breed_name()
	return self._breed_name
end

function CutsceneCompanion:trigger_walk_animation_event()
...
function CutsceneCompanion:update(unit, dt, t)
...
function CutsceneCompanion:editor_update(unit, dt, t)
...
function CutsceneCompanion:init_materialize()
	if DEDICATED_SERVER then
		return false
	end
...
function CutsceneCompanion:start_materialize()
	if DEDICATED_SERVER then
		return false
	end
...
function CutsceneCompanion:start_dematerialize()
	if DEDICATED_SERVER then
		return false
	end
