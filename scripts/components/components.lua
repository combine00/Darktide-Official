...
local function _component_data_get_array(self, unit, data_type, ...)
	...
	if default_size > 0 then
		if data_type == "text_box_array" then
			...
			if data_type == "check_box_array" then
				-- Nothing
			end

			if data_type == "number_array" then
				default_value = 0
			elseif data_type == "resource_array" then
				default_value = ""
			else
...
_require_component("scripts/components/airlock")
...
_require_component("scripts/components/explosion_spawner")
...
_require_component("scripts/components/nurgle_manifestation")
...
_require_component("scripts/components/placement_visibility")
_require_component("scripts/components/plasma_coil")
...
_require_component("scripts/components/prop_on_hit_physics")
...
_require_component("scripts/components/randomized_friend_rock_unit")
_require_component("scripts/components/randomized_throwing_shard_unit")
_require_component("scripts/components/respawn_beacon")
_require_component("scripts/components/ritual_shield")
...
_require_component("scripts/components/stats_trigger")
_require_component("scripts/components/sweep_trail")
_require_component("scripts/components/syringe_case_color")
_require_component("scripts/components/syringe_injector_color")
_require_component("scripts/components/timed_explosive")
_require_component("scripts/components/timed_synchronizer")
_require_component("scripts/components/toxic_gas_corals")
_require_component("scripts/components/toxic_gas_fog_spawner")
_require_component("scripts/components/toxic_gas_fog")
_require_component("scripts/components/train_backdrop")
_require_component("scripts/components/trigger")
_require_component("scripts/components/twin_captain_spawner")
