...
function CompanionCustomization:editor_init(unit)
...
function CompanionCustomization:init(unit)
...
function CompanionCustomization:_customize(unit, item_definitions)
...
function CompanionCustomization:unspawn_items()
...
function CompanionCustomization:enable(unit)
	return
end

function CompanionCustomization:disable(unit)
	return
end

function CompanionCustomization:editor_destroy(unit)
