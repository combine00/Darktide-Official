...
function StatsTrigger:init(unit, is_server)
...
function StatsTrigger:editor_init(unit)
	self:enable(unit)
end

function StatsTrigger:editor_validate(unit)
	return true, ""
end

function StatsTrigger:enable(unit)
	return
end

function StatsTrigger:disable(unit)
	return
end

function StatsTrigger:destroy(unit)
	return
end

function StatsTrigger:stat_trigger_on_unit_destruction()
