...
function DruglabTank:init(unit)
	self._unit = unit
...
function DruglabTank:extensions_ready(world, unit)
	self._health_extension = ScriptUnit.has_extension(unit, "health_system")
end

function DruglabTank:editor_validate(unit)
	return true, ""
end

function DruglabTank:enable(unit)
	return
end

function DruglabTank:disable(unit)
	return
end

function DruglabTank:destroy(unit)
	return
end

function DruglabTank:update(unit, dt, t)
	...
	if health_extension then
		...
		return health_extension:is_alive() or self._liquid_levels[#self._liquid_levels].liquid_level < self._current_liquid_level
	end
