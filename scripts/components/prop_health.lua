...
function PropHealth:editor_validate(unit)
	return true, ""
end
...
function PropHealth:prop_health_set_invulnerable()
...
function PropHealth:prop_health_set_vulnerable()
	local health_extension = self._health_extension
...
function PropHealth:prop_health_kill()
	local health_extension = self._health_extension
