...
damage_templates.psyker_throwing_knives_aimed_pierce.targets[1].power_distribution.attack = 500
damage_templates.psyker_throwing_knives_aimed_pierce.targets[2].power_distribution.attack = 350
...
damage_templates.psyker_throwing_knives_pierce.targets[1].power_distribution.attack = 350
