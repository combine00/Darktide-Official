...
function attack_settings.armor_damage_modifier_to_damage_efficiency(armor_damage_modifier, armor_type, rending_damage)
	if (armor_type == "super_armor" or armor_type == "armored") and armor_damage_modifier <= 0.1 and rending_damage == 0 or armor_type == "void_shield" then
