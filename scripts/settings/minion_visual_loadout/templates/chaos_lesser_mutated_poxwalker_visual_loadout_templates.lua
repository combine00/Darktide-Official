...
local basic_lesser_mutated_poxwalker_template = {
	slots = {
		slot_body = {
			use_outline = true,
			items = {
...
local default_1 = table.clone(basic_lesser_mutated_poxwalker_template)
local default_2 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_3 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_4 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_5 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_6 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_7 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_8 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local default_9 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_1 = table.clone(basic_lesser_mutated_poxwalker_template)
local throneside_2 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_3 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_4 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_5 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_6 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_7 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_8 = table.clone(basic_lesser_mutated_poxwalker_template)
...
local throneside_9 = table.clone(basic_lesser_mutated_poxwalker_template)
