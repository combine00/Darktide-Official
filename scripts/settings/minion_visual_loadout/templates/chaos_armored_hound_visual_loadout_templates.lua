...
local basic_chaos_armored_hound_template = {
	slots = {
		slot_body = {
			use_outline = true,
			items = {
...
local default_1 = table.clone(basic_chaos_armored_hound_template)
templates.chaos_armored_hound.default = {
	default_1
}
local foundry_1 = table.clone(basic_chaos_armored_hound_template)
...
local dust_1 = table.clone(basic_chaos_armored_hound_template)
...
local watertown_1 = table.clone(basic_chaos_armored_hound_template)
