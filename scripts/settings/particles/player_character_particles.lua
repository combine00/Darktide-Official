...
function PlayerCharacterParticles.resolve_particle(particle_alias, properties, optional_external_properties)
...
function PlayerCharacterParticles.find_relevant_particles(profile_properties)
