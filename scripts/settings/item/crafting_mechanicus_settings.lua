...
CraftingSettings.recipes = {
		...
		can_craft = function (ingredients, additional_data)
			...
			if additional_data then
				...
				if not is_valid then
					...
					return additional_data.expertise_data.current > 0 and additional_data.expertise_data.start < additional_data.expertise_data.current
				end
			end
	...
	replace_perk = {
		...
		can_craft = function (ingredients, additional_context)
			...
			if additional_context.max_rank and additional_context.max_rank < new_perk_item.rarity then
