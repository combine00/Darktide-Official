...
function stay_in_party_voting_template.on_started(voting_id, template, params)
...
function stay_in_party_voting_template.on_completed(voting_id, template, params, result)
	if DEDICATED_SERVER then
...
function stay_in_party_voting_template.on_aborted(voting_id, template, params, abort_reason)
	if DEDICATED_SERVER then
		return
	end
...
function stay_in_party_voting_template.on_vote_casted(voting_id, template, voter_peer_id, vote_option)
	if DEDICATED_SERVER then
		return
	end
