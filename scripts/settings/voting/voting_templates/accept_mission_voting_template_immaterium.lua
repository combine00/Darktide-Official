...
function accept_mission_voting_template_immaterium.on_completed(voting_id, template, vote_state, result)
...
function accept_mission_voting_template_immaterium.on_aborted(voting_id, template, params, abort_reason)
	_close_voting_view(voting_id)
end

function accept_mission_voting_template_immaterium.on_vote_casted(voting_id, template, voter_account_id, vote_option)
