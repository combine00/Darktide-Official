...
function mission_vote_matchmaking_immaterium.fetch_my_vote_params(template, params, option)
	if option == "yes" then
...
function mission_vote_matchmaking_immaterium.on_aborted(voting_id, template, params, abort_reason)
	_close_voting_view()
end

function mission_vote_matchmaking_immaterium.on_vote_casted(voting_id, template, voter_account_id, vote_option)
