...
function PlayerCharacterSounds.resolve_sound(sound_alias, properties, optional_external_properties)
...
function PlayerCharacterSounds.find_relevant_events(profile_properties)
