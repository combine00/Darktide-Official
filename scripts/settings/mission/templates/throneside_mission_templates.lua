local mission_templates = {
	cm_archives = {
		...
		wwise_state = "zone_5",
		zone_id = "throneside",
		texture_small = "content/ui/textures/pj_missions/cm_archives_small",
		mission_brief_material = "content/environment/cinematic/mission_briefing/mission_briefing_hologram_cm_archives_01",
		texture_medium = "content/ui/textures/pj_missions/cm_archives_medium",
		face_state_machine_key = "state_machine_missions",
		mechanism_name = "adventure",
		texture_big = "content/ui/textures/pj_missions/cm_archives_big",
	...
	fm_resurgence = {
		...
		wwise_state = "zone_5",
		zone_id = "throneside",
		texture_small = "content/ui/textures/pj_missions/fm_resurgence_small",
		mission_brief_material = "content/environment/cinematic/mission_briefing/mission_briefing_hologram_fm_resurgence_01",
		texture_medium = "content/ui/textures/pj_missions/fm_resurgence_medium",
		face_state_machine_key = "state_machine_missions",
		mechanism_name = "adventure",
		texture_big = "content/ui/textures/pj_missions/fm_resurgence_big",
	...
	hm_complex = {
		...
		wwise_state = "zone_5",
		zone_id = "throneside",
		texture_small = "content/ui/textures/pj_missions/hm_complex_small",
		mission_brief_material = "content/environment/cinematic/mission_briefing/mission_briefing_hologram_hm_complex_01",
		texture_medium = "content/ui/textures/pj_missions/hm_complex_medium",
		face_state_machine_key = "state_machine_missions",
		mechanism_name = "adventure",
		texture_big = "content/ui/textures/pj_missions/hm_complex_big",
