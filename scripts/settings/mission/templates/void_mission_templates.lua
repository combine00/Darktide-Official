local mission_templates = {
	core_research = {
		...
		texture_small = "content/ui/textures/missions/core_research_small",
		texture_medium = "content/ui/textures/missions/core_research_medium",
		mechanism_name = "adventure",
		face_state_machine_key = "state_machine_missions",
		coordinates = "loc_mission_coordinates_core_research",
		texture_big = "content/ui/textures/missions/core_research_big",
		zone_id = "void",
		wwise_state = "zone_8",
