...
function roamer_slot_placement_functions.circle_placement(nav_world, spawn_position_boxed, roamer_placement_settings, traverse_logic, roamer_pacing)
	local roamer_slots = {}
...
function roamer_slot_placement_functions.random_circle_placement(nav_world, spawn_position_boxed, roamer_placement_settings, traverse_logic, roamer_pacing)
	local roamer_slots = {}
	local num_slots = roamer_placement_settings.num_slots
	local radians_per_roamer_slot = TWO_PI / num_slots
	local current_radians = -(radians_per_roamer_slot / 2)
...
function roamer_slot_placement_functions.flood_fill(nav_world, spawn_position_boxed, roamer_placement_settings, traverse_logic, roamer_pacing)
	local roamer_slots = {}
