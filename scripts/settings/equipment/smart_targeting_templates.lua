...
local smart_targeting_templates = {
	...
	smite = {
		precision_target = {
			...
			breed_weights = {
				renegade_flamer = 20,
				chaos_mutator_daemonhost = 5,
				renegade_assault = 1,
				cultist_shocktrooper = 10,
				renegade_radio_operator = 10,
	...
	smart_tag_target = {
		precision_target = {
			...
			breed_weights = {
				renegade_flamer = 20,
				chaos_mutator_daemonhost = 30,
				renegade_assault = 1,
				cultist_shocktrooper = 10,
				renegade_radio_operator = 15,
				renegade_executor = 10,
