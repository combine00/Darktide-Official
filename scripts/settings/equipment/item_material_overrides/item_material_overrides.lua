...
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_emissive")
...
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_pattern_properties")
...
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_hair_headgear_mask")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_face_mask")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_makeup")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_dog_fur_color")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_dog_skin_colors")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_dog_coat_masks")
_include_material_override_definition("scripts/settings/equipment/item_material_overrides/player_material_overrides_dog_gear_patterns")
