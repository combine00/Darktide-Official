local material_overrides = {
	...
	hair_mask_half_shrink_left_side = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0.072,
	...
	hair_mask_half_right_small_offset = {
		property_overrides = {
			hair_mask_types_invert = {
				-0.06,
				-0.06,
	...
	hair_mask_back_top_front_small = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_shrink_right_side_02 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0.072,
	...
	hair_mask_belladonna_shrink_back_01 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_short_reverse_mohawk_a_shrink_01 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_short_reverse_mohawk_a_shrink_02 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_short_reverse_mohawk_a_shrink_03 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_short_dreads_reduce_top = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_medium_side_swept_afro_a_short_back_01 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	hair_mask_medium_afro_a_keep_backside = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	ogryn_hair_mask_underside_small_01 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	ogryn_hair_mask_underside_back_small_01 = {
		property_overrides = {
			hair_mask_types_invert = {
				0,
				0,
	...
	facial_hair_mask_chin_strap_02 = {
		property_overrides = {
			facial_hair_mask_x = {
				-1,
				-1
	...
	facial_hair_mask_chin_sides_04 = {
		property_overrides = {
			facial_hair_mask_x = {
				-0.98,
				-0.98
	...
	facial_hair_mask_shrink_side_underside_01 = {
		property_overrides = {
			facial_hair_mask_x = {
				-0.968,
				-0.984
