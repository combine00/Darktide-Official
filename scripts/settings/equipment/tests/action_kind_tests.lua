...
function action_kind_funcs.reload_shotgun(action_settings, weapon_template)
...
function action_kind_funcs.reload_state(action_settings, weapon_template)
...
function action_kind_funcs.ranged_wield(action_settings, weapon_template)
...
function action_kind_funcs.aim(action_settings, weapon_template)
...
function action_kind_funcs.sweep(action_settings, weapon_template)
...
function action_kind_funcs.overload_explosion(action_settings, weapon_template)
