...
weapon_template.actions = {
	...
	action_melee_start_left_special = {
		...
		allowed_during_sprint = true,
		anim_event = "heavy_charge_down_folded",
	...
	action_left_heavy_special = {
		...
		anim_event = "heavy_attack_down_folded",
	...
	action_left_down_light = {
		...
		anim_end_event = "attack_finished",
		uninterruptible = true,
		anim_event = "attack_left_diagonal_down_flatside",
		total_time = 1.3,
		action_movement_curve = {
			{
				modifier = 1.25,
	...
	action_left_heavy = {
		...
		anim_event = "heavy_attack_left_diagonal_down_flatside",
		hit_stop_anim = "attack_hit",
		total_time = 1,
		action_movement_curve = {
			{
		...
		weapon_box = combat_axe_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/axe/heavy_attack_left_diagonal_down",
			anchor_point_offset = {
				0,
				0.1,
				-0.15
