...
function weapon_template.action_none_gift_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
	return not _is_minigame_in_focus(player) and (not current_action_name or current_action_name == "none")
end
...
function weapon_template.action_can_give_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
...
function weapon_template.action_cant_give_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
	local action_module_targeting_component = condition_func_params.action_module_targeting_component
	local target_unit = action_module_targeting_component.target_unit_1
...
function weapon_template.action_cancel_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
	local minigame = _get_minigame(player)
