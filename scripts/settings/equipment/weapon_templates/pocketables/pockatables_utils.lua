...
local PocketableUtils = {
	validate_slot_not_equipped = function (target_unit, slot_name)
...
function PocketableUtils.validate_give_pocketable_target_func(target_unit)
	return PocketableUtils.validate_slot_not_equipped(target_unit, "slot_pocketable")
end

function PocketableUtils.validate_give_pocketable_small_target_func(target_unit)
