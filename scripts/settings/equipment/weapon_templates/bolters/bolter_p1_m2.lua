...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.bolter_m2_boltshell,
...
weapon_template.base_stats = {
	...
	bolter_p1_m2_reload_speed_stat = {
...
weapon_template.semi_auto_chain_factor = 0.6
