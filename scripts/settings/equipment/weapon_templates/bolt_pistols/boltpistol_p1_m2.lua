...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.boltpistol_m2_hitscan,
...
weapon_template.base_stats = {
	...
	boltpistol_p1_m2_stability_stat = {
	...
	boltpistol_p1_m2_reload_speed_stat = {
...
weapon_template.ammo_template = "boltpistol_p1_m2"
