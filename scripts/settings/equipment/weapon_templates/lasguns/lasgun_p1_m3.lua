...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.lasgun_p1_m3_lasgun_beam,
...
weapon_template.ammo_template = "lasgun_p1_m3"
...
weapon_template.alternate_fire_settings = {
	...
	sway_template = "lasgun_p1_m3_killshot",
	recoil_template = "lasgun_p1_m3_ads_killshot",
	stop_anim_event = "to_unaim_reflex",
	spread_template = "lasgun_heavy_killshot",
