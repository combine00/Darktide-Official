...
weapon_template.actions = {
	...
	action_left_heavy = {
		...
		weapon_box = default_weapon_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/combat_sword/heavy_swing_down",
			anchor_point_offset = {
				0,
				0,
				-0
	...
	action_left_heavy_2 = {
		...
		weapon_box = default_weapon_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/combat_sword/heavy_swing_left_diagonal",
			anchor_point_offset = {
				0,
				0,
				-0.1
	...
	action_left_light_2 = {
		...
		weapon_box = default_weapon_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/combat_sword/swing_left_diagonal_up",
			anchor_point_offset = {
				0,
				0,
				0
