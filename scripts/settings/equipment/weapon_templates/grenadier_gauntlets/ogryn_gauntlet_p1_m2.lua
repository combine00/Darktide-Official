...
weapon_template.actions = {
	...
	action_shoot_zoomed = {
		...
		fire_configuration = {
			...
			skip_aiming = true,
			projectile = ProjectileTemplates.ogryn_gauntlet_grenade_krak
		},
		fx = {
	...
	action_execute_special = {
		...
		explosion_template = ExplosionTemplates.special_gauntlet_grenade_krak,
...
weapon_template.ammo_template = "ogryn_gauntlet_p1_m2"
...
weapon_template.base_stats = {
	...
	ogryn_gauntlet_p1_m2_explosion_damage = {
	...
	ogryn_gauntlet_p1_m2_explosion_size = {
	...
	ogryn_gauntlet_p1_m2_explosion_antiarmor = {
