...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			shotshell = ShotshellTemplates.shotgun_p4_m3_hip,
			shotshell_special = ShotshellTemplates.shotgun_p4_m3_hip_special,
	...
	action_shoot_zoomed = {
		...
		fire_configuration = {
			anim_event = "attack_shoot_semi",
			same_side_suppression_enabled = false,
			shotshell = ShotshellTemplates.shotgun_p4_m3_ads,
			shotshell_special = ShotshellTemplates.shotgun_p4_m3_ads_special,
			damage_type = damage_types.pellet
		},
		conditional_state_to_action_input = {
			no_ammo = {
...
weapon_template.ammo_template = "shotgun_p4_m3"
...
local bespoke_shotgun_p4_traits = table.ukeys(WeaponTraitsBespokeShotgunP1)

table.append(weapon_template.traits, bespoke_shotgun_p4_traits)

weapon_template.perks = {
	shotgun_p4_m3_stability_perk = {
		display_name = "loc_trait_display_shotgun_p4_m3_stability_perk",
		recoil = {
			base = {
	...
	shotgun_p4_m3_dps_perk = {
		display_name = "loc_trait_display_shotgun_p4_m3_dps_perk",
		damage = {
			action_shoot_hip = {
	...
	shotgun_p4_m3_power_perk = {
		display_name = "loc_trait_display_shotgun_p4_m3_power_perk",
		damage = {
			action_shoot_hip = {
	...
	shotgun_p4_m3_mobility_perk = {
		display_name = "loc_trait_display_shotgun_p4_m3_mobility_perk",
		dodge = {
			base = {
