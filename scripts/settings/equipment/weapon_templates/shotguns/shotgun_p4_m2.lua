...
weapon_template.ammo_template = "shotgun_p4_m2"
...
weapon_template.perks = {
	shotgun_p4_m2_stability_perk = {
		display_name = "loc_trait_display_shotgun_p4_m2_stability_perk",
		recoil = {
			base = {
	...
	shotgun_p4_m2_ammo_perk = {
		display_name = "loc_trait_display_shotgun_p4_m2_ammo_perk",
		ammo = {
			base = {
	...
	shotgun_p4_m2_dps_perk = {
		display_name = "loc_trait_display_shotgun_p4_m2_dps_perk",
		damage = {
			action_shoot_hip = {
	...
	shotgun_p4_m2_power_perk = {
		display_name = "loc_trait_display_shotgun_p4_m2_power_perk",
		damage = {
			action_shoot_hip = {
	...
	shotgun_p4_m2_mobility_perk = {
		display_name = "loc_trait_display_shotgun_p4_m2_mobility_perk",
		dodge = {
			base = {
