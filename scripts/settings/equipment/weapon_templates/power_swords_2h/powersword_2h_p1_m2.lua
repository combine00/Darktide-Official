...
weapon_template.actions = {
	...
	action_light_1 = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/2h_power_sword/attack_left_down",
			anchor_point_offset = {
				0.2,
				0,
				0
	...
	action_melee_start_right = {
		...
		anim_end_event = "attack_finished",
		kind = "windup",
		anim_event_3p = "heavy_charge_down_right",
	...
	action_melee_start_right_2 = {
		...
		anim_event = "heavy_charge_right_pose",
		stop_input = "attack_cancel",
		total_time = 3,
		action_movement_curve = {
			{
	...
	action_light_2 = {
		...
		anim_end_event = "attack_finished",
		anim_event_3p = "attack_right_down",
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/2h_power_sword/attack_right_down",
			anchor_point_offset = {
				-0.1,
				0,
				0
	...
	action_melee_start_left_2 = {
		allowed_during_sprint = true,
		chain_anim_event = "heavy_charge_left_up",
		chain_anim_event_3p = "heavy_charge_left_diagonal_up",
		kind = "windup",
		anim_end_event = "attack_finished",
		anim_event_3p = "heavy_charge_down_left",
	...
	action_light_3 = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/2h_power_sword/attack_left_diagonal_down",
			anchor_point_offset = {
				0,
				0,
				-0.35
	...
	action_heavy_3 = {
		...
		hit_stop_anim = "attack_hit",
		kind = "sweep",
		anim_event_3p = "heavy_attack_left_diagonal_up",
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/2h_power_sword/heavy_attack_left_up",
			anchor_point_offset = {
				-0.17,
				0,
				0
