...
local hit_stickyness_settings_light = {
	...
	damage = {
		instances = 3,
		damage_profile = DamageProfileTemplates.light_chainsword_sticky_m2,
		damage_type = damage_types.sawing_stuck,
		last_damage_profile = DamageProfileTemplates.light_chainsword_sticky_last_m2,
...
local hit_stickyness_settings_heavy = {
	...
	damage = {
		...
		damage_type = damage_types.sawing_stuck,
		last_damage_profile = DamageProfileTemplates.heavy_chainsword_sticky_last_m2,
		dodge_damage_profile = DamageProfileTemplates.sticky_dodge_push
	},
	disallowed_hit_zones = melee_sticky_disallowed_hit_zones,
	disallowed_armor_types = melee_sticky_heavy_attack_disallowed_armor_types,
...
weapon_template.actions = {
	...
	action_left_heavy = {
		...
		damage_profile = DamageProfileTemplates.heavy_chainsword_smiter,
		damage_type = damage_types.sawing,
		damage_profile_on_abort = DamageProfileTemplates.heavy_chainsword_smiter,
		damage_type_on_abort = damage_types.sawing,
	...
	action_right_diagonal_light = {
		...
		damage_profile = DamageProfileTemplates.light_chainsword_up,
		damage_type = damage_types.sawing,
		damage_profile_on_abort = DamageProfileTemplates.light_chainsword_up,
		damage_type_on_abort = damage_types.sawing,
		damage_profile_special_active = DamageProfileTemplates.light_chainsword_active,
		damage_type_special_active = damage_types.sawing_stuck,
		force_abort_breed_tags_special_active = _force_abort_breed_tags_special_active,
		...
		damage = {
			action_left_down_light = {
				overrides = {
					...
					light_chainsword_sticky_last_m2 = {
						damage_trait_templates.default_melee_dps_stat,
						display_data = {
							prefix = "loc_weapon_action_title_light",
							damage_profile_path = {
			...
			action_left_heavy = {
				overrides = {
					...
					heavy_chainsword_sticky_last_m2 = {
						damage_trait_templates.default_melee_dps_stat,
						display_data = {
							prefix = "loc_weapon_action_title_heavy",
							damage_profile_path = {
