...
weapon_template.actions = {
	...
	action_heavy_2 = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/power_maul/heavy_attack_down_right",
			anchor_point_offset = {
				0,
				0,
				-0.05
	...
	action_heavy_3 = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/power_maul/heavy_attack_down_left",
			anchor_point_offset = {
				0,
				0,
				-0.05
