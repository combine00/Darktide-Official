...
local action_input_hierarchy = table.clone(MeleeActionInputSetupSlow.action_input_hierarchy)

ActionInputHierarchy.update_hierarchy_entry(action_input_hierarchy, "special_action_hold", {
	{
		transition = "base",
