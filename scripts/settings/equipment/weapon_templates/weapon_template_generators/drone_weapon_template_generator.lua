...
local function generate_base_template()
	...
	function base_template.action_aim_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
		return current_action_name == "action_aim"
	end

	function base_template.action_aim_underhand_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
