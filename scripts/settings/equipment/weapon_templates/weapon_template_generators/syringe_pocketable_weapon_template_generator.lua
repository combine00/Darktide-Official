...
local function generate_base_template(buff_name, validate_target_func, hud_icon, hud_icon_small, pickup_name, assist_notification_type, vo_event)
	...
	function base_template.action_none_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
		return not current_action_name or current_action_name == "none"
	end

	function base_template.action_is_aiming_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
		return current_action_name == "action_aim"
	end

	function base_template.action_can_use_self_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
		return not current_action_name or current_action_name == "none" and validate_target_func(player.player_unit)
	end

	function base_template.action_can_use_ally_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
	...
	function base_template.action_none_gift_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
		return not current_action_name or current_action_name == "none"
	end

	function base_template.action_can_give_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
		local action_module_targeting_component = condition_func_params.action_module_targeting_component
		local target_unit = action_module_targeting_component.target_unit_1
	...
	function base_template.action_cant_give_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player, condition_func_params)
		local action_module_targeting_component = condition_func_params.action_module_targeting_component
		local target_unit = action_module_targeting_component.target_unit_1
