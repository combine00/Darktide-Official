...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fx = {
			...
			muzzle_flash_effect = "content/fx/particles/weapons/rifles/laspistol/laspistol_heavy_muzzle",
			shoot_sfx_alias = "ranged_single_shot",
			spread_rotated_muzzle_flash = true,
			shoot_tail_sfx_alias = "ranged_shot_tail",
			out_of_ammo_sfx_alias = "ranged_out_of_ammo",
			muzzle_flash_crit_effect = "content/fx/particles/weapons/rifles/laspistol/laspistol_heavy_muzzle_crit",
...
weapon_template.alternate_fire_settings = {
	...
	recoil_template = "ads_default_laspistol_bfg",
