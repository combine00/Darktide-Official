...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		weapon_handling_template = "autogun_p2_m3",
		ammunition_usage = 1,
		...
		action_movement_curve = {
			...
			start_modifier = 0.7200000000000001
		},
		fx = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.autogun_p2_m3_bullet,
...
weapon_template.spread_template = "autogun_p2_m3_hip"
...
weapon_template.ammo_template = "autogun_p2_m3"
...
weapon_template.alternate_fire_settings = {
	...
	recoil_template = "ads_autogun_p2_m3_spraynpray",
