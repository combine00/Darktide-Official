...
ui_settings.weapon_card_value_funcs = {
...
ui_settings.weapon_action_display_order = {
	secondary = 2,
	primary = 1,
	special = 3,
	extra = 4
}
ui_settings.weapon_action_display_order_array = {
	"primary",
	"secondary",
	"special",
	"extra"
}
ui_settings.weapon_action_extended_display_order_array = {
	"special",
	"primary",
	"secondary",
	"extra"
}
ui_settings.weapon_stats_armor_types = {
...
ui_settings.weapon_action_type_icons = {
	tank = "content/ui/materials/icons/weapons/actions/tank",
	vent = "content/ui/materials/icons/weapons/actions/vent",
	melee = "content/ui/materials/icons/weapons/actions/melee",
...
ui_settings.weapon_fire_type_icons = {
	projectile = "content/ui/materials/icons/weapons/actions/projectile",
	shotgun = "content/ui/materials/icons/weapons/actions/shotgun",
	full_auto = "content/ui/materials/icons/weapons/actions/full_auto",
	semi_auto = "content/ui/materials/icons/weapons/actions/semi_auto",
...
ui_settings.weapon_fire_type_display_text = {
...
ui_settings.trait_category_icon = {
	ranged_aimed = "",
	ranged_common = "",
	melee_activated = "",
	ranged_explosive = "",
...
ui_settings.contracts_icons_by_type = {
...
ui_settings.digital_clock_numbers = {
	[0] = "",
	"",
	"",
	"",
...
ui_settings.item_preview_hide_slots_per_slot = {
	slot_gear_head = {
		"slot_body_legs",
		"slot_body_face_tattoo",
		"slot_body_face_scar",
...
ui_settings.item_preview_required_slot_items_per_slot_by_breed_and_gender = {
	human = {
		male = {
			default = {
...
ui_settings.assist_type_localization_lookup = {
...
ui_settings.assist_type_enter_sound_lookup = {
