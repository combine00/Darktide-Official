...
local breed_name = "renegade_plasma_shocktrooper"
local breed_data = {
	detection_radius = 15,
	walk_speed = 2.3,
	use_bone_lod = true,
	...
	game_object_type = "minion_renegade_plasma_shocktrooper",
	challenge_rating = 3,
	bone_lod_radius = 1.05,
	use_wounds = true,
	display_name = "loc_breed_display_name_renegade_plasma_shocktrooper",
	run_speed = 5.6,
	faction_name = "chaos",
	base_height = 1.9,
	ranged = true,
	...
	inventory = MinionVisualLoadoutTemplates.renegade_plasma_shocktrooper,
	sounds = require("scripts/settings/breed/breeds/renegade/renegade_plasma_shocktrooper_sounds"),
	...
	hitzone_armor_override = {
		...
		[hit_zone_names.head] = armor_types.resistant
	},
	outline_config = {},
