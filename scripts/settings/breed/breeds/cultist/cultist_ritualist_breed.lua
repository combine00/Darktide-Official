...
local breed_name = "cultist_ritualist"
local breed_data = {
	detection_radius = 15,
	...
	sounds = require("scripts/settings/breed/breeds/cultist/cultist_ritualist_sounds"),
	...
	target_selection_template = TargetSelectionTemplates.cultist_ritualist,
