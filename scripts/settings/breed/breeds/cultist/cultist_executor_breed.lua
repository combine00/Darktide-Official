...
local breed_name = "cultist_executor"
local breed_data = {
	detection_radius = 15,
	walk_speed = 2,
	use_bone_lod = true,
	...
	bone_lod_radius = 1.2,
	use_wounds = true,
	power_level_type = "cultist_executor_melee",
	display_name = "loc_breed_display_name_cultist_executor",
	run_speed = 5.25,
	faction_name = "chaos",
	base_height = 1.9,
	...
	inventory = MinionVisualLoadoutTemplates.cultist_executor,
	sounds = require("scripts/settings/breed/breeds/cultist/cultist_executor_sounds"),
	...
	combat_range_data = BreedCombatRanges.cultist_executor,
	...
	target_selection_weights = TargetSelectionWeights.cultist_executor,
	threat_config = {
	...
	companion_pounce_setting = {
		...
		looping_sound_event_stop = "wwise/events/npc/stop_adamant_dog_vce_attack_loop",
		leap_sound_event = "wwise/events/npc/play_adamant_dog_vce_attack",
		companion_pounce_action = "human",
		looping_sound_event_start = "wwise/events/npc/play_adamant_dog_vce_attack_loop",
		damage_profile = DamageProfileTemplates.adamant_companion_human_pounce,
		initial_damage_profile = DamageProfileTemplates.adamant_companion_human_initial_pounce,
		required_token = {
