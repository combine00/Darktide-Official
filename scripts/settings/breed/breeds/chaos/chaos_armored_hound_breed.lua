...
local breed_name = "chaos_armored_hound"
local breed_data = {
	...
	gib_template = MinionGibbingTemplates.chaos_armored_hound,
	stagger_durations = {
	...
	hit_zone_weakspot_types = {
		[hit_zone_names.lower_left_arm] = weakspot_types.weakspot,
		[hit_zone_names.lower_right_arm] = weakspot_types.weakspot,
		[hit_zone_names.lower_left_leg] = weakspot_types.weakspot,
		[hit_zone_names.lower_right_leg] = weakspot_types.weakspot
	},
