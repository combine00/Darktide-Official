...
local breed_name = "chaos_lesser_mutated_poxwalker"
local breed_data = {
	...
	gib_template = MinionGibbingTemplates.chaos_lesser_mutated_poxwalker,
	stagger_durations = {
	...
	inventory = MinionVisualLoadoutTemplates.chaos_lesser_mutated_poxwalker,
