...
_create_breed_action_entry("scripts/settings/breed/breed_actions/chaos/chaos_mutator_daemonhost_actions")
_create_breed_action_entry("scripts/settings/breed/breed_actions/chaos/chaos_mutator_ritualist_actions")
...
_create_breed_action_entry("scripts/settings/breed/breed_actions/renegade/renegade_radio_operator_actions")
