...
local shooting_difficulty_settings_plasma_pistol = MinionDifficultySettings.shooting.renegade_plasma_shocktrooper
local action_data = {
	...
	shoot = {
		...
		dodge_window = shooting_difficulty_settings.shoot_dodge_window,
		shoot_template = BreedShootTemplates.renegade_plasma_shocktrooper_plasma_beam,
		strafe_anim_events = {
		...
		before_shoot_effect_template = EffectTemplates.renegade_plasma_shocktrooper_charge_up
	}
}
