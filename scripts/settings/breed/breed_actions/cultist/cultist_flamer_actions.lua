...
local action_data = {
	...
	shoot = {
		...
		min_range = CultistFlamerSettings.min_range,
		radius = CultistFlamerSettings.radius,
		liquid_area_template = LiquidAreaTemplates.cultist_flamer_liquid_paint,
		shoot_template = BreedShootTemplates.cultist_flamer_default,
