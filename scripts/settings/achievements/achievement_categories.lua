...
_add_category("mission_havoc", "loc_achievement_subcategory_missions_havoc_label", "missions")
_add_category("mission_survival", "loc_achievement_subcategory_missions_survival_label", "missions")
