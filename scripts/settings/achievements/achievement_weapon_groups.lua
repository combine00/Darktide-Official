local AchievementWeaponGroups = {
	weapons = {
		...
		{
			pattern = "forcestaff_p1"
		},
		{
			pattern = "forcestaff_p2"
		},
		{
			pattern = "forcestaff_p3"
		},
		{
...
return AchievementWeaponGroups
