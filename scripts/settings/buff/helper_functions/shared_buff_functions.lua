...
function shared_functions.regain_toughness_proc_func(params, template_data, template_context)
...
function shared_functions.vent_warp_charge_start_func(template_data, template_context)
	local unit = template_context.unit
...
function shared_functions.vent_warp_charge_proc_func(params, template_data, template_context)
	template_data.proc = true
end

function shared_functions.vent_warp_charge_update_func(template_data, template_context, dt, t)
