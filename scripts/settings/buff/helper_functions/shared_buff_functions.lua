...
function shared_buff_functions.regain_toughness_proc_func(params, template_data, template_context)
...
function shared_buff_functions.vent_warp_charge_start_func(template_data, template_context)
	local unit = template_context.unit
...
function shared_buff_functions.vent_warp_charge_proc_func(params, template_data, template_context)
	template_data.proc = true
end

function shared_buff_functions.vent_warp_charge_update_func(template_data, template_context, dt, t)
...
function shared_buff_functions.spawn_grenade_at_position(owner_unit, owner_side, item_name, projectile_template, position, direction, speed_multiplier)
...
function shared_buff_functions.get_broadphase_and_enemy_side_names(source_unit)
