...
function templates.weapon_trait_bespoke_ogryn_gauntlet_p1_windup_increases_power.bonus_step_func(template_data, template_context)
...
function templates.weapon_trait_bespoke_ogryn_gauntlet_p1_windup_increases_power.min_max_step_func(template_data, template_context)
	return 0, 5
end
...
templates.weapon_trait_bespoke_ogryn_gauntlet_p1_melee_power_after_ranged_explosion = {
	...
	check_proc_func = function (params, template_data, template_context)
		...
		if not CheckProcFunctions.on_explosion_hit_multiple(params, template_data, template_context) then
			return false
		end

		if params.weapon_special then
			return false
		end
