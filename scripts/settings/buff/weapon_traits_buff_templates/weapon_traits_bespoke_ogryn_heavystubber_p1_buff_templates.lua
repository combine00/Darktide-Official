...
templates.weapon_trait_bespoke_heavystubber_p1_increase_close_damage_on_close_kill_parent = table.clone(BaseWeaponTraitBuffTemplates.increase_close_damage_on_close_kill_parent)
templates.weapon_trait_bespoke_heavystubber_p1_increase_close_damage_on_close_kill_child = table.clone(BaseWeaponTraitBuffTemplates.increase_close_damage_on_close_kill_child)
templates.weapon_trait_bespoke_heavystubber_p1_increase_close_damage_on_close_kill_parent.child_buff_template = "weapon_trait_bespoke_heavystubber_p1_increase_close_damage_on_close_kill_child"
templates.weapon_trait_bespoke_heavystubber_p1_suppression_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.suppression_on_close_kill)
