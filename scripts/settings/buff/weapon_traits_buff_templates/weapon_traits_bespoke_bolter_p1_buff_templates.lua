...
templates.weapon_trait_bespoke_bolter_p1_increase_close_damage_on_close_kill_parent.child_buff_template = "weapon_trait_bespoke_bolter_p1_increase_close_damage_on_close_kill_child"
templates.weapon_trait_bespoke_bolter_p1_suppression_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.suppression_on_close_kill)
templates.weapon_trait_bespoke_bolter_p1_bleed_on_ranged = table.clone(BaseWeaponTraitBuffTemplates.bleed_on_ranged)
