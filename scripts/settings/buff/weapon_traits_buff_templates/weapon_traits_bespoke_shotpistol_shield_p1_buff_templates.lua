...
templates.weapon_trait_bespoke_shotpistol_shield_p1_windup_increases_power = table.clone(BaseWeaponTraitBuffTemplates.chance_based_on_aim_time)
templates.weapon_trait_bespoke_shotpistol_shield_p1_windup_increases_power.conditional_stat_buffs = {
