...
local buff_settings = {
	buff_categories = table.enum("generic", "talents", "weapon_traits", "talents_secondary", "gadget", "hordes_buff", "hordes_sub_buff", "aura")
}
