...
nurgle_parasite_settings = {
	...
	head_parasite_item_overrides = {
		...
		ogryn = {
			{
				items = {
					[1.0] = "content/items/characters/minions/chaos_ogryn/attachments_base/head_a",
					[2.0] = "content/items/characters/minions/chaos_ogryn/attachments_base/head_b"
				}
			},
			{
				items = {
					[1.0] = "content/items/characters/minions/chaos_ogryn/attachments_base/tentacle_head_01",
					[2.0] = "content/items/characters/minions/chaos_ogryn/attachments_base/tentacle_head_02"
				}
			}
		},
		poxwalker = {
