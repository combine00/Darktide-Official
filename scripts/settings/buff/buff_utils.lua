...
function BuffUtils.add_debuff_on_hit_start(template_data, template_context)
...
function BuffUtils.add_proc_debuff(t, params, template_data, template_context)
...
function BuffUtils.add_debuff_on_hit_proc(params, template_data, template_context, t)
...
function BuffUtils.consecutive_hits_proc_func(params, template_data, template_context, t)
...
function BuffUtils.consecutive_hits_same_target_proc_func(params, template_data, template_context, t)
