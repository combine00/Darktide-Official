...
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_c")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_male_a")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_male_b")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_male_c")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_female_a")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_female_b")
_add_to_lookup(DialogueSettings.default_lookup_path .. "lookup_adamant_female_c")
