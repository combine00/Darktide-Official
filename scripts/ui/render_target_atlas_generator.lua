...
function RenderTargetAtlasGenerator:generate_atlas_grid_index(slot_width, slot_height, optional_atlas_width, optional_atlas_height)
...
function RenderTargetAtlasGenerator:store_render_target_to_atlas(render_target, atlas_id, grid_index)
	local atlas = self:_get_atlas_by_id(atlas_id)
...
function RenderTargetAtlasGenerator:get_atlas_render_target(atlas_id)
	local atlas = self:_get_atlas_by_id(atlas_id)
...
function RenderTargetAtlasGenerator:_create_uv_grid(grid_size, slot_size)
...
function RenderTargetAtlasGenerator:_create_atlas_grid(slot_width, slot_height, optional_atlas_width, optional_atlas_height)
...
function RenderTargetAtlasGenerator:_get_atlas_free_grid_index(atlas)
	local occupied_grid_slots = atlas.occupied_grid_slots
	local max_grid_slots = atlas.max_grid_slots
...
function RenderTargetAtlasGenerator:_occupy_atlas_grid_index(atlas, grid_index)
	local num_used_grid_slots = atlas.num_used_grid_slots
	local occupied_grid_slots = atlas.occupied_grid_slots
	local max_grid_slots = atlas.max_grid_slots
