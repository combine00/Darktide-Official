...
function ConstantElementStayInParty:init(parent, draw_layer, start_scale)
...
function ConstantElementStayInParty:_event_voting_started(voting_id)
...
function ConstantElementStayInParty:_event_voting_completed()
	self._active = false
	self._voting_id = nil
end

function ConstantElementStayInParty:_event_voting_aborted()
	self._active = false
	self._voting_id = nil
end

function ConstantElementStayInParty:_event_vote_casted()
...
function ConstantElementStayInParty:_all_is_same_party()
...
function ConstantElementStayInParty:_sync_votes()
...
function ConstantElementStayInParty:destroy()
...
function ConstantElementStayInParty:_setup_input_legend()
...
function ConstantElementStayInParty:update(dt, t, ui_renderer, render_settings, input_service)
	if not self._active then
...
function ConstantElementStayInParty:_update_num_voters()
	self:_sync_votes()
end

function ConstantElementStayInParty:_update_warning_text()
	local party_manager = Managers.party_immaterium
...
function ConstantElementStayInParty:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	ConstantElementBase._draw_widgets(self, dt, t, input_service, ui_renderer, render_settings)
end

function ConstantElementStayInParty:draw(dt, t, ui_renderer, render_settings, input_service)
	if not self._active then
		return
	end
...
function ConstantElementStayInParty:cb_on_stay_in_party_pressed()
