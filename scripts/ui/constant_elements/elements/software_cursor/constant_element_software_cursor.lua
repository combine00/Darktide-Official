...
function ConstantElementSoftwareCursor:init(parent, draw_layer, start_scale, definitions)
...
function ConstantElementSoftwareCursor:_recreate_software_cursor(render_settings)
	self._cursor_settings = class_definitions.cursor_settings
...
function ConstantElementSoftwareCursor:update(dt, t, ui_renderer, render_settings, input_service)
...
function ConstantElementSoftwareCursor:_handle_input(input_service)
