...
function ConstantElementSubtitles:event_update_secondary_subtitles_enabled()
	self:_setup_secondary_subtitles_enabled()
end
...
function ConstantElementSubtitles:event_update_secondary_subtitles_font_size()
	self:_setup_secondary_font_size()
end
...
function ConstantElementSubtitles:_setup_secondary_subtitles_enabled()
	local save_data = Managers.save:account_data()
	local interface_settings = save_data.interface_settings
...
function ConstantElementSubtitles:_setup_secondary_font_size()
	local save_data = Managers.save:account_data()
	local interface_settings = save_data.interface_settings
...
function ConstantElementSubtitles:_setup_subtitle_speaker_enabled()
	local save_data = Managers.save:account_data()
	local interface_settings = save_data.interface_settings
...
function ConstantElementSubtitles:_add_subtitle(currently_playing, secondary_subtitle)
...
function ConstantElementSubtitles:_remove_secondary_letterbox()
...
function ConstantElementSubtitles:_set_secondary_font_size(new_size)
	local widgets_by_name = self._widgets_by_name
	local secondary_widget = widgets_by_name.secondary_subtitles
	local secondary_style = secondary_widget.style
	local secondary_text_style = secondary_style.text
...
function ConstantElementSubtitles:_display_text_line(text, duration, secondary_subtitle)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.subtitles
