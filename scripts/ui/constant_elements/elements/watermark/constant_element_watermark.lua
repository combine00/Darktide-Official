...
function ConstantElementWatermark:init(parent, draw_layer, start_scale)
...
function ConstantElementWatermark:destroy()
...
function ConstantElementWatermark:_initialize_ui_renderer(world)
	self._ui_watermark_renderer = Managers.ui:create_renderer(_render_settings.renderer_name, world)
end

function ConstantElementWatermark:update(dt, t, ui_renderer, render_settings, input_service)
...
function ConstantElementWatermark:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ConstantElementWatermark:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	if self._has_rendered then
...
function ConstantElementWatermark:_render_qr_grid(ui_renderer)
...
function ConstantElementWatermark:_generate_qr()
