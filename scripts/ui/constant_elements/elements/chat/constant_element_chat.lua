...
function ConstantElementChat:_is_state_changing()
...
function ConstantElementChat:_change_state(target_state)
	local params = {
...
function ConstantElementChat:cb_system_message_recieved(message, channel_tag)
...
function ConstantElementChat:_start_chatting(ui_renderer)
	local input_widget = self._input_field_widget
...
function ConstantElementChat:_handle_keyboard_input(input_service, ui_renderer)
	local input_widget = self._input_field_widget
	local is_input_field_active = input_widget.content.is_writing
...
function ConstantElementChat:_handle_console_input(input_service, ui_renderer)
	local input_widget = self._input_field_widget
...
function ConstantElementChat:_next_connected_channel_handle(current_priority_index)
	local channels = {}
...
function ConstantElementChat:_update_input_field(ui_renderer, widget)
...
function ConstantElementChat:_add_message(message, sender, channel)
...
function ConstantElementChat:_channel_name(channel_tag, colorize, channel_name)
...
function ConstantElementChat:_parse_slash_commands(text)
...
function ConstantElementChat:_find_participant_in_current_channel(character_name)
...
function ConstantElementChat:_participant_displayname(participant)
...
function ConstantElementChat:_find_participant_player_info(participant)
...
function ConstantElementChat:_handle_slash_command(command, params)
	return
end
