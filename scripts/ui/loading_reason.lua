...
function LoadingReason:init()
	return
end

function LoadingReason:render(gui, wait_description, wait_time, text_opacity)
...
function LoadingReason:_calculate_anchor_point(resolution_width, resolution_height, resolution_scale)
...
function LoadingReason:_render_icon(gui, anchor_x, anchor_y, resolution_scale)
...
function LoadingReason:_render_text(gui, anchor_x, anchor_y, resolution_scale, text, text_opacity)
