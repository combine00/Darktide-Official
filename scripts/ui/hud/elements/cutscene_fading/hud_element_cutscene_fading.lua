...
function HudElementCutsceneFading:event_cutscene_fade_in(player, duration, easing_function)
...
function HudElementCutsceneFading:event_cutscene_fade_out(player, duration, easing_function)
	if not self._player or self._player ~= player then
		return
	end
...
function HudElementCutsceneFading:event_cutscene_fade_out_at(player, duration, easing_function, fade_out_at)
	self._fade_out_data = {
		player = player,
		duration = duration,
...
function HudElementCutsceneFading:destroy(ui_renderer)
