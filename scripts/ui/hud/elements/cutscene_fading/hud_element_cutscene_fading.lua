...
function HudElementCutsceneFading:init(parent, draw_layer, start_scale)
...
function HudElementCutsceneFading:update(dt, t, ui_renderer, render_settings, input_service)
	...
	if fade_out and fade_out.fade_out_at <= t then
...
function HudElementCutsceneFading:event_cutscene_fade_in(player, duration, easing_function, fade_color)
...
function HudElementCutsceneFading:event_cutscene_fade_out(player, duration, easing_function, fade_color)
	if not self._player or self._player ~= player then
		return
	end
...
function HudElementCutsceneFading:event_cutscene_fade_out_at(player, duration, easing_function, fade_out_at, fade_color)
	self._fade_out_data = {
		player = player,
		duration = duration,
