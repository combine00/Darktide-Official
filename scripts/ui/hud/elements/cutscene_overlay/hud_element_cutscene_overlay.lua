...
function HudElementCutsceneOverlay:init(parent, draw_layer, start_scale)
	HudElementCutsceneOverlay.super.init(self, parent, draw_layer, start_scale, Definitions)
end

function HudElementCutsceneOverlay:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
