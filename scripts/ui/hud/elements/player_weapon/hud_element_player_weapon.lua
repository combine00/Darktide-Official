...
function HudElementPlayerWeapon:_style_text_height(text, text_style, ui_renderer)
...
function HudElementPlayerWeapon:_set_clip_amount(current, total)
...
function HudElementPlayerWeapon:_set_ammo_amount(amount, total_max_amount)
...
function HudElementPlayerWeapon:set_input_text(text, faded)
	local widgets_by_name = self._widgets_by_name
