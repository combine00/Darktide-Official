...
function HudElementPlayerBuffs:event_player_buff_stack_added(player, buff_instance)
	if not self._player or self._player ~= player then
		return
	end
...
function HudElementPlayerBuffs:_setup_buff_widget_array(ui_renderer)
...
function HudElementPlayerBuffs:_return_widget(widget, ui_renderer)
	if not widget then
		return nil
	end
...
function HudElementPlayerBuffs:_update_buff_alignments(force_update, dt)
	local active_buffs_data = self._active_buffs_data
	local num_active_buffs = #active_buffs_data
...
function HudElementPlayerBuffs:_update_buffs(t, ui_renderer)
	local active_buffs_data = self._active_buffs_data
...
function HudElementPlayerBuffs:_set_widget_state_colors(widget, is_negative, is_active)
...
function HudElementPlayerBuffs:destroy(ui_renderer)
