...
function template.damage_number_function(pass, ui_renderer, ui_style, ui_content, position, size)
...
function template.create_widget_defintion(temp, scenegraph_id)
