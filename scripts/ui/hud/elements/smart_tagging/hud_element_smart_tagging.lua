...
function HudElementSmartTagging:destroy(ui_renderer)
...
function HudElementSmartTagging:_trigger_smart_tag_interaction(tag_id, target_unit)
	local parent = self._parent
	local player_unit = parent:player_unit()
	local smart_tag_system = Managers.state.extension:system("smart_tag_system")
...
function HudElementSmartTagging:_get_chat_channel_by_tag(channel_tag)
...
function HudElementSmartTagging:_on_wheel_closed()
