...
function HudElementEmoteWheel:init(parent, draw_layer, start_scale)
...
function HudElementEmoteWheel:_populate_wheel(options)
...
function HudElementEmoteWheel:_setup_entries(num_entries)
...
function HudElementEmoteWheel:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementEmoteWheel:_update_slot_items(ui_renderer)
...
function HudElementEmoteWheel:destroy(ui_renderer)
	local entries = self._entries
...
function HudElementEmoteWheel:_on_wheel_start(t, input_service)
...
function HudElementEmoteWheel:_on_wheel_stop(t, ui_renderer, render_settings, input_service)
...
function HudElementEmoteWheel:_get_chat_channel_by_tag(channel_tag)
...
function HudElementEmoteWheel:_handle_input(t, dt, ui_renderer, render_settings)
...
function HudElementEmoteWheel:using_input()
	return self._wheel_active or self._event_to_play and self._close_delay ~= nil
end

function HudElementEmoteWheel:_handle_com_wheel(t, ui_renderer, render_settings, input_service)
...
function HudElementEmoteWheel:_should_draw_wheel(input_service)
	return input_service:get("com_wheel")
end

function HudElementEmoteWheel:_should_draw_wheel_gamepad(input_service)
...
function HudElementEmoteWheel:_on_wheel_closed()
...
function HudElementEmoteWheel:_check_box_overlap(x1, y1, x2, y2, px, py, radius)
...
function HudElementEmoteWheel:_update_wheel_presentation(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementEmoteWheel:_is_wheel_entry_hovered(t)
	local entries = self._entries
...
function HudElementEmoteWheel:_update_active_progress(dt)
...
function HudElementEmoteWheel:_update_widget_locations()
	local entries = self._entries
...
function HudElementEmoteWheel:_push_cursor()
...
function HudElementEmoteWheel:_pop_cursor()
...
function HudElementEmoteWheel:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	local active_progress = self._wheel_active_progress
