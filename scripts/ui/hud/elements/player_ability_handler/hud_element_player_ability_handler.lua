...
function HudElementPlayerAbilityHandler:_update_ability_count(new_ability_count, force_alignment_update)
...
function HudElementPlayerAbilityHandler:destroy(ui_renderer)
	local instance_data_tables = self._instance_data_tables
