...
function HudElementCombatFeed:event_update_combat_feed_enabled(value)
	self._combat_feed_enabled = value
end

function HudElementCombatFeed:event_update_assist_notification_type(value)
	self._assist_messages_enabled = value == "combat_feed"
end

function HudElementCombatFeed:event_update_crafting_pickup_notification_type(value)
	self._crafting_messages_enabled = value == "combat_feed"
end

function HudElementCombatFeed:event_update_combat_feed_max_messages(value)
	self._max_messages = value
end

function HudElementCombatFeed:event_update_combat_feed_message_duration(value)
	self._message_duration = value
end

function HudElementCombatFeed:event_add_notification_message(message_type, data, callback, sound_event, done_callback, delay)
...
function HudElementCombatFeed:destroy(ui_renderer)
...
function HudElementCombatFeed:_can_show_currency_of_type(currency_type)
...
function HudElementCombatFeed:_enabled()
