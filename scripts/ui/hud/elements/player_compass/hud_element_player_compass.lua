...
function HudElementPlayerCompass:init(parent, draw_layer, start_scale)
...
function HudElementPlayerCompass:_register_world_markers()
...
function HudElementPlayerCompass:_cb_register_world_markers_list(world_markers)
...
function HudElementPlayerCompass:_find_party_nameplate_by_unit(unit)
...
function HudElementPlayerCompass:_draw_party_icon(dt, t, ui_renderer, marker, x, y, alpha)
...
function HudElementPlayerCompass:_get_party_icons_render_buffer(dt, t, ui_renderer)
...
function HudElementPlayerCompass:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementPlayerCompass:_get_camera_direction_angle()
...
function HudElementPlayerCompass:_get_marker_direction_angle(marker)
...
function HudElementPlayerCompass:_draw_widgets(dt, t, input_service, ui_renderer)
