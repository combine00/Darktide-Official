...
function weapon_counter_template_overheat_lockout.create_widget_defintion(scenegraph_id)
...
function weapon_counter_template_overheat_lockout.on_enter(hud_element_weapon_counter, slot_name, widget, template)
	template.data.slot_name = slot_name
end

function weapon_counter_template_overheat_lockout.update_function(hud_element_weapon_counter, ui_renderer, widget, is_currently_wielded, weapon_counter_settings, template, dt, t)
