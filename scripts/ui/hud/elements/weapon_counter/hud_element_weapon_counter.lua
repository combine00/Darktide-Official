...
function HudElementWeaponCounter:init(parent, draw_layer, start_scale, data)
...
function HudElementWeaponCounter:destroy(ui_renderer)
	HudElementWeaponCounter.super.destroy(self, ui_renderer)
end

function HudElementWeaponCounter:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementWeaponCounter:_update_slot(dt, t, slot_name, is_currently_wielded, ui_renderer)
...
function HudElementWeaponCounter:_weapon_counter_settings(slot_name)
...
function HudElementWeaponCounter:_update_slot_widget(slot_name, weapon_counter_settings)
...
function HudElementWeaponCounter:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
