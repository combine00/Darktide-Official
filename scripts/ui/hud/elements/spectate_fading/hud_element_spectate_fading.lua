...
function HudElementSpectateFading:init(parent, draw_layer, start_scale)
...
function HudElementSpectateFading:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementSpectateFading:event_spectate_fade_in(duration, easing_function)
...
function HudElementSpectateFading:event_spectate_fade_out(duration, easing_function)
	self._fade_duration = duration
	self._fade_time = duration
	self._fade_easing_function = easing_function
...
function HudElementSpectateFading:event_spectate_fade_out_at(player, duration, easing_function, fade_out_at)
	self._fade_out_data = {
		player = player,
		duration = duration,
...
function HudElementSpectateFading:destroy(ui_renderer)
