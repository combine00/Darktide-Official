...
function HudElementSpectatorText:init(parent, draw_layer, start_scale)
...
function HudElementSpectatorText:_get_cycle_input_text()
...
function HudElementSpectatorText:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementSpectatorText:event_on_input_changed()
	self._update_spectator_text = true
end
