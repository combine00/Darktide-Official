...
function HudElementInteraction:_update_interactee_data(interactee_unit, extension)
...
function HudElementInteraction:destroy(ui_renderer)
...
function HudElementInteraction:_update_interaction_input_text(interactee_extension)
...
function HudElementInteraction:_update_target_interaction_size(dt, t, ui_renderer)
	local widgets_by_name = self._widgets_by_name
...
function HudElementInteraction:_setup_interaction_information(interactee_unit, interactee_extension, interactor_extension, use_minimal_presentation)
	local hold_required = interactee_extension:hold_required()
	local input_action_text = interactee_extension:action_text()
