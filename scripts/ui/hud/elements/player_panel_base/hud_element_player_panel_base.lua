...
function HudElementPlayerPanelBase:_event_player_profile_updated(synced_peer_id, synced_local_player_id, new_profile)
	if self._peer_id == synced_peer_id then
		self:_on_profile_updated(new_profile)
	end
end

function HudElementPlayerPanelBase:_event_hub_title_color_type_changed()
	self._character_title = nil
end

function HudElementPlayerPanelBase:_on_profile_updated(new_profile)
...
function HudElementPlayerPanelBase:_has_item_in_slot(inventory_component, visual_loadout_extension, slot_name)
...
function HudElementPlayerPanelBase:_set_overshielded(supported_features, is_overshielded, ui_renderer, overshield_amount)
...
function HudElementPlayerPanelBase:_get_grenade_ability_status(player, dead, inventory_component, visual_loadout_extension, ability_extension)
...
function HudElementPlayerPanelBase:_get_weapon_ammo_status(player, dead, unit_data_extension, visual_loadout_extension)
...
function HudElementPlayerPanelBase:_update_grenade_ability_presentation(status, visible, hud_icon, ui_renderer)
...
function HudElementPlayerPanelBase:_update_ammo_representation(ammo_status, visible, hud_icon, ui_renderer)
...
function HudElementPlayerPanelBase:_update_pocketable_presentation(pocketable_hud_icon, pocketable_small_hud_icon, visible, ui_renderer)
...
function HudElementPlayerPanelBase:_cb_unset_player_icon()
	local widget = self._widgets_by_name.player_icon
	local material_values = widget.style.texture.material_values
...
function HudElementPlayerPanelBase:_update_player_name_prefix(player)
