...
function MinigameBalanceView:init(context)
	self._minigame_extension = context.minigame_extension
	self._progress_widgets = {}
end

function MinigameBalanceView:destroy()
	return
end

local system_name = "dialogue_system"

function MinigameBalanceView:dialogue_system()
...
function MinigameBalanceView:update(dt, t, widgets_by_name)
...
function MinigameBalanceView:draw_widgets(dt, t, input_service, ui_renderer)
...
function MinigameBalanceView:_create_progress_widgets()
...
function MinigameBalanceView:_update_cursor(widgets_by_name)
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.balance)
