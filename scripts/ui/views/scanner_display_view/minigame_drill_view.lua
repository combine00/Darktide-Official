...
function MinigameDrillView:init(context)
...
function MinigameDrillView:destroy()
	return
end

function MinigameDrillView:update(dt, t, widgets_by_name)
...
function MinigameDrillView:draw_widgets(dt, t, input_service, ui_renderer)
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.drill)
...
function MinigameDrillView:_create_stage_widgets()
...
function MinigameDrillView:_create_background_widgets()
	local scenegraph_id = "center_pivot"
...
function MinigameDrillView:_create_target_widgets()
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.drill)
