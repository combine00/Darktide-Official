...
function MinigameFrequencyView:init(context)
	self._minigame_extension = context.minigame_extension
	self._frequency_widgets = {}
	self._stage_widgets = {}
end

function MinigameFrequencyView:destroy()
	return
end

local system_name = "dialogue_system"

function MinigameFrequencyView:dialogue_system()
...
function MinigameFrequencyView:update(dt, t, widgets_by_name)
...
function MinigameFrequencyView:draw_widgets(dt, t, input_service, ui_renderer)
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.frequency)
...
function MinigameFrequencyView:_draw_frequency(frequency, color, t, ui_renderer)
...
function MinigameFrequencyView:_create_stage_widgets()
...
function MinigameFrequencyView:_create_frequency_widgets(name)
