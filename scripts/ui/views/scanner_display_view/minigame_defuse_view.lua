...
function MinigameDefuseView:init(context)
...
function MinigameDefuseView:destroy()
	return
end

local system_name = "dialogue_system"

function MinigameDefuseView:dialogue_system()
...
function MinigameDefuseView:update(dt, t, widgets_by_name)
...
function MinigameDefuseView:draw_widgets(dt, t, input_service, ui_renderer)
...
function MinigameDefuseView:_create_option_widgets()
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.defuse)
...
function MinigameDefuseView:_create_target_widgets()
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.defuse)
...
function MinigameDefuseView:_create_stage_widgets()
...
function MinigameDefuseView:_update_option(widgets_by_name, success)
	return
end

function MinigameDefuseView:_update_cursor(widgets_by_name, success, highlight)
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.defuse)
...
function MinigameDefuseView:_update_target(widgets_by_name, success)
	return
end
