...
function CraftingExtractTraitView:init(settings, context)
...
function CraftingExtractTraitView:on_enter()
...
function CraftingExtractTraitView:_cb_fetch_trait_data(seen_traits)
	self._traits_promises = nil
	self._seen_traits = seen_traits
	self._resync_can_craft = true
end

function CraftingExtractTraitView:_present_crafting()
...
function CraftingExtractTraitView:on_back_pressed()
	self._parent:go_to_crafting_view("select_item", self._item)

	return true
end

function CraftingExtractTraitView:cb_on_main_button_pressed()
...
function CraftingExtractTraitView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingExtractTraitView:_handle_input(input_service)
...
function CraftingExtractTraitView:cb_on_trait_selected(widget, config)
...
function CraftingExtractTraitView:dialogue_system()
	return self._parent:dialogue_system()
end

function CraftingExtractTraitView:_on_navigation_input_changed()
...
function CraftingExtractTraitView:update(dt, t, input_service)
