...
function CutsceneView:_setup_input_legend()
...
function CutsceneView:_remove_input_legend()
...
function CutsceneView:on_skip_pressed()
...
function CutsceneView:draw(dt, t, input_service, layer)
