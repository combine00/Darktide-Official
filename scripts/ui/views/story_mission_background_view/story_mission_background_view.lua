...
function StoryMissionBackgroundView:init(settings, context)
	self._wallet_type = "credits"

	StoryMissionBackgroundView.super.init(self, Definitions, settings, context)
end

function StoryMissionBackgroundView:on_enter()
...
function StoryMissionBackgroundView:event_select_story_mission_background_option(index)
...
function StoryMissionBackgroundView:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
