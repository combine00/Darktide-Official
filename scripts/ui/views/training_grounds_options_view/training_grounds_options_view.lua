...
function TrainingGroundsOptionsView:draw(dt, t, input_service, layer)
...
function TrainingGroundsOptionsView:post_update(dt, t, input_service)
...
function TrainingGroundsOptionsView:_create_difficulty_stepper_indicators(current_difficulty_index)
...
function TrainingGroundsOptionsView:_update_difficulty_stepper(current_difficulty_index)
	local difficulty_selector = self._widgets_by_name.difficulty_stepper
	local content = difficulty_selector.content
