...
function CraftingMechanicusUpgradeItemView:init(settings, context)
...
function CraftingMechanicusUpgradeItemView:on_enter()
...
function CraftingMechanicusUpgradeItemView:on_exit()
...
function CraftingMechanicusUpgradeItemView:_present_upgrade_result(item)
	local result_data = {
		type = "item",
		item = item
	}
...
function CraftingMechanicusUpgradeItemView:_close_result_overlay()
...
function CraftingMechanicusUpgradeItemView:_setup_result_overlay(result_data)
	if self._result_overlay then
		self._result_overlay = nil
...
function CraftingMechanicusUpgradeItemView:_is_result_presentation_active()
	if self._result_overlay then
		return true
	end
...
function CraftingMechanicusUpgradeItemView:draw(dt, t, input_service, layer)
	if self._result_overlay then
...
function CraftingMechanicusUpgradeItemView:update(dt, t, input_service)
...
function CraftingMechanicusUpgradeItemView:_handle_input(input_service)
...
function CraftingMechanicusUpgradeItemView:on_back_pressed()
	if self._craft_promise then
		return true
	end
...
function CraftingMechanicusUpgradeItemView:_present_crafting()
...
function CraftingMechanicusUpgradeItemView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusUpgradeItemView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusUpgradeItemView:_on_navigation_input_changed()
...
function CraftingMechanicusUpgradeItemView:dialogue_system()
