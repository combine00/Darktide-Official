...
function InventoryWeaponDetailsView:_toggle_view(id, force_update)
...
function InventoryWeaponDetailsView:_setup_weapon_info()
...
function InventoryWeaponDetailsView:_update_weapon_info_position()
	if not self._weapon_info then
		return
	end
...
function InventoryWeaponDetailsView:_setup_weapon_actions_extended()
...
function InventoryWeaponDetailsView:_update_weapon_actions_extended_position()
	if not self._weapon_actions_extended then
		return
	end
...
function InventoryWeaponDetailsView:_setup_attack_patterns()
...
function InventoryWeaponDetailsView:_update_attack_patterns_position()
	if not self._attack_patterns then
		return
	end
...
function InventoryWeaponDetailsView:cb_activate_weapon_info(activate)
...
function InventoryWeaponDetailsView:_handle_input(input_service, dt, t)
...
function InventoryWeaponDetailsView:_draw_weapon_stats(ui_renderer, input_service)
...
function InventoryWeaponDetailsView:_remove_element(reference_name)
