...
function CraftingMechanicusReplaceTraitView:init(settings, context)
...
function CraftingMechanicusReplaceTraitView:on_enter()
...
function CraftingMechanicusReplaceTraitView:on_exit()
...
function CraftingMechanicusReplaceTraitView:_cb_fetch_trait_data(seen_traits)
...
function CraftingMechanicusReplaceTraitView:_get_wallet()
...
function CraftingMechanicusReplaceTraitView:_present_crafting(optional_present_callback)
...
function CraftingMechanicusReplaceTraitView:_set_trait_inventory_focused(focus)
...
function CraftingMechanicusReplaceTraitView:on_back_pressed()
...
function CraftingMechanicusReplaceTraitView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusReplaceTraitView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusReplaceTraitView:cb_on_trait_selected(widget, config)
...
function CraftingMechanicusReplaceTraitView:_on_trait_selected(widget, config)
...
function CraftingMechanicusReplaceTraitView:_draw_elements(dt, t, ui_renderer, render_settings, input_service)
...
function CraftingMechanicusReplaceTraitView:_update_elements(dt, t, input_service)
	local existing_trait_index = self._ingredients.existing_trait_index
	local elements_array = self._elements_array
...
function CraftingMechanicusReplaceTraitView:remove_ingredient(ingredient_index)
	local trait_ids = self._ingredients.trait_ids
	trait_ids[ingredient_index] = nil
	self._resync_can_craft = true
end

function CraftingMechanicusReplaceTraitView:update(dt, t, input_service)
...
function CraftingMechanicusReplaceTraitView:cb_on_new_trait_selected(widget, config)
	self._resync_can_craft = true
end

function CraftingMechanicusReplaceTraitView:_handle_input(input_service)
...
function CraftingMechanicusReplaceTraitView:_on_navigation_input_changed()
...
function CraftingMechanicusReplaceTraitView:dialogue_system()
