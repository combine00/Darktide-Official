...
function CraftingReplacePerkView:init(settings, context)
...
function CraftingReplacePerkView:on_enter()
...
function CraftingReplacePerkView:on_exit()
...
function CraftingReplacePerkView:_cb_fetch_perks_data()
...
function CraftingReplacePerkView:_get_wallet()
...
function CraftingReplacePerkView:_present_crafting(optional_present_callback)
...
function CraftingReplacePerkView:_set_perks_item_focused(focus)
...
function CraftingReplacePerkView:on_back_pressed()
...
function CraftingReplacePerkView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingReplacePerkView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingReplacePerkView:cb_on_perk_selected(widget, config)
...
function CraftingReplacePerkView:_on_perk_selected(widget, config)
...
function CraftingReplacePerkView:_draw_elements(dt, t, ui_renderer, render_settings, input_service)
...
function CraftingReplacePerkView:_update_elements(dt, t, input_service)
	local existing_perk_index = self._ingredients.existing_perk_index
	local elements_array = self._elements_array
...
function CraftingReplacePerkView:remove_ingredient(ingredient_index)
...
function CraftingReplacePerkView:update(dt, t, input_service)
...
function CraftingReplacePerkView:cb_on_new_perk_selected(widget, config)
	self._resync_can_craft = true
end

function CraftingReplacePerkView:_handle_input(input_service)
...
function CraftingReplacePerkView:_on_navigation_input_changed()
...
function CraftingReplacePerkView:dialogue_system()
