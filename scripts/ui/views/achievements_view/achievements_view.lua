...
function AchievementsView:_outdated_favorites()
...
function AchievementsView:_update_summary()
...
function AchievementsView:_cache_achievements(player)
	local total_score = 0
...
function AchievementsView:_category_score(category_id)
...
function AchievementsView:_populate_category_grid(player)
...
function AchievementsView:_first_visible_sub_category(category_id)
...
function AchievementsView:_visible_sub_category_count(category_id)
	local sub_category = self._sub_categories[category_id]
	local sub_category_count = sub_category and #sub_category or 0
...
function AchievementsView:_is_category_visible(category_id)
...
function AchievementsView:_cache_sub_categories()
...
function AchievementsView:_setup_achievements()
...
function AchievementsView:_cb_favorite_legend_visibility(add_to_favorite)
...
function AchievementsView:_should_display_achievement(player, is_complete, achievement_definition)
...
function AchievementsView:_populate_achievements_grid(category_id)
	local player = Managers.player:local_player(1)
