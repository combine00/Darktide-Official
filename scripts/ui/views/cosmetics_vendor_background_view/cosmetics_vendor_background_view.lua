...
function CosmeticsVendorBackgroundView:init(settings, context)
...
function CosmeticsVendorBackgroundView:on_enter()
...
function CosmeticsVendorBackgroundView:_set_wallet_background_width(width)
	width = 150 + width
...
function CosmeticsVendorBackgroundView:event_register_character_spawn_point(spawn_point_unit)
	CosmeticsVendorBackgroundView.super.event_register_character_spawn_point(self, spawn_point_unit)
end

function CosmeticsVendorBackgroundView:update(dt, t, input_service)
