...
function MissionBoardViewDefinitions.widget_definitions_functions.screen_decorations_pass_function(mission_type)
...
function MissionBoardViewDefinitions.widget_definitions_functions.planet_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			value_id = "title",
			style_id = "title",
...
function MissionBoardViewDefinitions.widget_definitions_functions.happening_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			scenegraph_id = "happening",
			style_id = "background",
...
function MissionBoardViewDefinitions.widget_definitions_functions.detail_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "logic",
			value = MissionBoardViewStyles.timer_logic
...
function MissionBoardViewDefinitions.widget_definitions_functions.objective_1_pass_function(mission_type)
...
function MissionBoardViewDefinitions.widget_definitions_functions.objective_2_pass_function(mission_type)
...
function MissionBoardViewDefinitions.widget_definitions_functions.difficulty_stepper_window_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "rect",
			style_id = "background"
...
function MissionBoardViewDefinitions.widget_definitions_functions.difficulty_stepper_pass_function(mission_type)
...
function MissionBoardViewDefinitions.widget_definitions_functions.game_settings_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "rect",
			style_id = "background"
...
function MissionBoardViewDefinitions.widget_definitions_functions.info_box_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "rect",
			style_id = "background"
...
function MissionBoardViewDefinitions.widget_definitions_functions.play_team_button_legend_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			value_id = "text",
			style_id = "text",
...
function MissionBoardViewDefinitions.widget_definitions_functions.mission_small_widget_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "hotspot",
			content_id = "hotspot",
...
function MissionBoardViewDefinitions.widget_definitions_functions.mission_medium_widget_pass_function(mission_type)
	return UIWidget.create_definition({
		{
			pass_type = "hotspot",
			content_id = "hotspot",
