...
local MissionBoardViewStyles = {
	difficulty_bar_change_function = function (content, style)
		if content.is_locked then
			...
			local danger_color = DangerSettings[danger_level] and DangerSettings[danger_level].color or DangerSettings[1].color
...
MissionBoardViewStyles.detail_widget_style = {
	...
	difficulty_bar_1 = {
		vertical_alignment = "center",
		horizontal_alignment = "center",
		default_color = DangerSettings[1].color,
		color = DangerSettings[1].color,
...
function MissionBoardViewStyles.planet_widget_style_function(mission_type)
...
function MissionBoardViewStyles.happening_widget_style_function(mission_type)
	return {
		background = {
			color = {
				0,
...
function MissionBoardViewStyles.detail_widget_style_function(mission_type)
	local t = {
		background = {
			color = {
				200,
...
function MissionBoardViewStyles.objective_widget_style_function(mission_type)
	return {
		background = {
...
function MissionBoardViewStyles.difficulty_stepper_window_widget_style_function(mission_type)
	return {
		background = {
			color = _get_color_by_name("color_dark_opacity", mission_type),
			offset = {
...
function MissionBoardViewStyles.game_settings_widget_style_function(mission_type)
	return {
		background = {
			color = _get_color_by_name("color_background", mission_type)
		},
...
function MissionBoardViewStyles.play_team_button_legend_function(mission_type)
	return {
		text = {
			font_type = "proxima_nova_bold",
			font_size = 18,
...
function MissionBoardViewStyles.mission_widget_style_function(mission_type)
	return {
		background = {
			color = _get_color_by_name("color_background", mission_type)
		},
...
function MissionBoardViewStyles.difficulty_stepper_style_function(mission_type)
	return {
		difficulty_bar_1 = {
			color = DangerSettings[1].color
		},
