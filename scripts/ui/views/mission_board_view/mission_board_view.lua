...
function MissionBoardView:_on_view_requirements_complete()
...
function MissionBoardView:_create_widgets(filtered_definitions, widgets, widgets_by_name)
...
function MissionBoardView:_generate_widgets_by_mission_type(mission_Type)
	local definitions = self._definitions
...
function MissionBoardView:_setup_widgets()
...
function MissionBoardView:_callback_story_mission_menu()
...
function MissionBoardView:_generate_mission_type_selection()
	...
	function widget.content.hotspot_arrow_left.pressed_callback()
		change_mission_type(widget.content.selected_index - 1)
	end

	function widget.content.hotspot_arrow_right.pressed_callback()
		change_mission_type(widget.content.selected_index + 1)
	end

	function widget.content.hotspot_selection_1.pressed_callback()
		change_mission_type(1)
	end

	function widget.content.hotspot_selection_2.pressed_callback()
...
function MissionBoardView:_on_story_mission_started()
...
function MissionBoardView:_update_story_mission_button_anim(dt)
...
function MissionBoardView:_get_matchmaking_status()
...
function MissionBoardView:_reset_selection()
...
function MissionBoardView:_set_selected_mission(mission, move_gamepad_cursor, is_flash)
	self:_reset_selection()
...
function MissionBoardView:_get_free_position(preferred_index, prefered_danger)
...
function MissionBoardView:_mission_highest_completed_danger(mission_name)
...
function MissionBoardView:_update_bonus_rewards()
...
function MissionBoardView:_add_bonus_data()
...
function MissionBoardView:_callback_open_options(region_data)
...
function MissionBoardView:_callback_close_options()
...
function MissionBoardView:_callback_switch_mission_board(mission_type)
...
function MissionBoardView:_clean_backend_data(missions)
...
function MissionBoardView:_filter_mission_board(board_type)
...
function MissionBoardView:_callback_toggle_private_matchmaking()
...
function MissionBoardView:_set_play_button_game_mode_text(is_solo_play, is_private_match)
...
function MissionBoardView:fetch_regions()
...
function MissionBoardView:_cancel_promise_on_exit(promise)
	local promises = self._promises
...
function MissionBoardView:_telemetry_open()
...
function MissionBoardView:_telemetry_close()
	local telemetry_manager = Managers.telemetry_events
