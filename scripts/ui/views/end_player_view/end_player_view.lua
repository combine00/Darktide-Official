...
function EndPlayerView:load_weapon_pattern_icon(item, cb, render_context)
...
function EndPlayerView:unload_weapon_pattern_icon(id)
	local weapon_icon_renderer = self._weapon_icon_renderer
...
function EndPlayerView:update_weapon_values(added_exp, slot, widget)
