...
function MasteriesOverviewView:init(settings, context)
...
function MasteriesOverviewView:_on_view_load_complete(loaded)
	MasteriesOverviewView.super._on_view_load_complete(self, loaded)
end

function MasteriesOverviewView:on_enter()
...
function MasteriesOverviewView:_reset_mastery_data_by_id(id)
...
function MasteriesOverviewView:_update_mastery_data(mastery_id)
...
function MasteriesOverviewView:_level_up_mastery(id)
	local mastery = id and self._masteries[id]
...
function MasteriesOverviewView:_level_up_max_mastery(id)
	local mastery = id and self._masteries[id]
...
function MasteriesOverviewView:_update_mastery_presentation(optional_mastery_id)
...
function MasteriesOverviewView:_set_button_callbacks()
	function self._widgets_by_name.mastery_button.content.hotspot.pressed_callback()
...
function MasteriesOverviewView:_setup_layout_entries()
	local layout = {}
...
function MasteriesOverviewView:_setup_patterns_grid()
...
function MasteriesOverviewView:cb_on_grid_entry_left_pressed(widget, element)
...
function MasteriesOverviewView:_update_patterns_grid_position()
...
function MasteriesOverviewView:_setup_menu_tabs(content)
...
function MasteriesOverviewView:_switch_tab(index)
	local tabs_content = self._patterns_tabs_content
...
function MasteriesOverviewView:_present_layout_by_slot_filter(slot_filter, item_type_filter, optional_display_name, optional_callback)
...
function MasteriesOverviewView:_update_patterns_tab_bar_position()
...
function MasteriesOverviewView:_cb_on_present(optional_callback)
	local grid_widgets = self._patterns_grid:widgets()
...
function MasteriesOverviewView:_handle_input(input_service, dt, t)
...
function MasteriesOverviewView:_on_navigation_input_changed()
	return
end

function MasteriesOverviewView:draw(dt, t, input_service, layer)
	MasteriesOverviewView.super.draw(self, dt, t, input_service, layer)
end

function MasteriesOverviewView:on_resolution_modified(scale)
...
function MasteriesOverviewView:update(dt, t, input_service)
	return MasteriesOverviewView.super.update(self, dt, t, input_service)
end

function MasteriesOverviewView:on_exit()
	MasteriesOverviewView.super.on_exit(self)
end

function MasteriesOverviewView:_fetch_mastery_data(mastery_id)
...
function MasteriesOverviewView:_mastery_data_available(mastery_id)
	return self._mastery_milestones[mastery_id] and self._mastery_traits[mastery_id] and self._mastery_marks[mastery_id]
end

function MasteriesOverviewView:_present_mastery(mastery_id)
	local fetch_promise = nil
...
function MasteriesOverviewView._get_next_milestone(mastery_data)
	local claimed_level = mastery_data.claimed_level or -1
...
function MasteriesOverviewView:_get_milestones_data(mastery_id)
...
function MasteriesOverviewView:_get_marks_data(mastery_id)
	if not mastery_id then
		return
	end
...
function MasteriesOverviewView:_get_traits_data(mastery_id)
	if not mastery_id then
		return
	end
...
function MasteriesOverviewView:_set_pattern_icon(mastery_id, is_max_level)
