...
function CraftingModifyView:_setup_sort_options()
...
function CraftingModifyView:_update_weapon_stats_position_and_selection(scenegraph_id, weapon_stats)
...
function CraftingModifyView:_cb_on_present()
...
function CraftingModifyView:_set_trait_inventory_focused(focus)
...
function CraftingModifyView:equipped_item_in_slot(slot_name)
