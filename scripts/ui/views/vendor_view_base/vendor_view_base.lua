...
function VendorViewBase:_update_account_items(wrapped, promise)
...
function VendorViewBase:set_loading_state(state)
...
function VendorViewBase:is_item_owned(id)
	return self._account_items[id] ~= nil
end

function VendorViewBase:_generate_menu_tabs(layout, offers)
...
function VendorViewBase:item_valid_by_profile_archetype(archetype_name, item)
...
function VendorViewBase:_update_bundle_offers_owned_skus()
...
function VendorViewBase:_generate_mannequin_loadout(profile)
...
function VendorViewBase:_update_button_disable_state()
	if self._previewed_offer then
		local offer = self._previewed_offer
		local is_active = offer.state == "active"
		local price_data = offer.price.amount
...
function VendorViewBase:_update_layout_list_on_item_purchase(items_layout, item)
...
function VendorViewBase:_handle_input(input_service, dt, t)
...
function VendorViewBase:_setup_sort_options()
