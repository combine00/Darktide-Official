...
function HavocRewardPresentationView:init(settings, context)
...
function HavocRewardPresentationView:on_enter()
...
function HavocRewardPresentationView:_generate_badge_widget(havoc_data, offset_y)
...
function HavocRewardPresentationView:_generate_promotion_widgets(rewards)
	local offset_y = 50
...
function HavocRewardPresentationView:_generate_reward_widgets(rewards)
...
function HavocRewardPresentationView:cb_on_continue_pressed()
	self:_play_sound(UISoundEvents.default_click)
	Managers.event:trigger("event_reset_havoc_background_view")
end

function HavocRewardPresentationView:on_back_pressed()
...
function HavocRewardPresentationView:on_exit()
	HavocRewardPresentationView.super.on_exit(self)
end

function HavocRewardPresentationView:_handle_input(input_service, dt, t)
	return
end

function HavocRewardPresentationView:update(dt, t, input_service)
	return HavocRewardPresentationView.super.update(self, dt, t, input_service)
end

function HavocRewardPresentationView:draw(dt, t, input_service, layer)
	HavocRewardPresentationView.super.draw(self, dt, t, input_service, layer)
end

function HavocRewardPresentationView:on_resolution_modified(scale)
	HavocRewardPresentationView.super.on_resolution_modified(self, scale)
end

function HavocRewardPresentationView:dialogue_system()
...
function HavocRewardPresentationView:set_alpha_multiplier(alpha_multiplier)
