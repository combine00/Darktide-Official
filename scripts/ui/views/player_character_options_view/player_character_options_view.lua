...
function PlayerCharacterOptionsView:trigger_on_exit_animation()
...
function PlayerCharacterOptionsView:on_exit_animation_done()
	return self._window_close_anim_id and self:_is_animation_completed(self._window_close_anim_id)
end

function PlayerCharacterOptionsView:on_enter()
...
function PlayerCharacterOptionsView:_set_player_name(name, current_level)
...
function PlayerCharacterOptionsView:_set_class_name(name)
	local widget = self._widgets_by_name.class_name
	local text = name
	widget.content.text = text
end

function PlayerCharacterOptionsView:_generate_player_icon()
...
function PlayerCharacterOptionsView:_cb_set_player_icon(grid_index, rows, columns, render_target)
...
function PlayerCharacterOptionsView:on_exit()
...
function PlayerCharacterOptionsView:draw(dt, t, input_service, layer)
...
function PlayerCharacterOptionsView:_draw_widgets(dt, t, input_service, ui_renderer)
	return PlayerCharacterOptionsView.super._draw_widgets(self, dt, t, input_service, ui_renderer)
end

function PlayerCharacterOptionsView:update(dt, t, input_service, layer)
...
function PlayerCharacterOptionsView:_update_invite_button_status()
...
function PlayerCharacterOptionsView:_on_invite_pressed()
...
function PlayerCharacterOptionsView:_setup_buttons_interactions()
...
function PlayerCharacterOptionsView:_on_inspect_pressed()
...
function PlayerCharacterOptionsView:_on_close_pressed()
	self:_play_sound(UISoundEvents.system_popup_exit)
	Managers.ui:close_view(self.view_name)
end

function PlayerCharacterOptionsView:_get_animation_widgets()
...
function PlayerCharacterOptionsView:_on_navigation_input_changed()
...
function PlayerCharacterOptionsView:_set_selected_gamepad_navigation_index(index)
...
function PlayerCharacterOptionsView:_handle_button_gamepad_navigation(input_service)
...
function PlayerCharacterOptionsView:_handle_input(input_service, dt, t)
