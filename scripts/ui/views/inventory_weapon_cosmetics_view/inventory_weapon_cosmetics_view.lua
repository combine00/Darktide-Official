...
function InventoryWeaponCosmeticsView:_equip_weapon_cosmetics()
...
function InventoryWeaponCosmeticsView:_update_weapon_preview_viewport()
...
function InventoryWeaponCosmeticsView:_handle_input(input_service, dt, t)
