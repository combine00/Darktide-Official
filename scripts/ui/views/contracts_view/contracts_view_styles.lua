...
function contracts_view_styles.task_list_item_background_change_function(content, style)
...
function contracts_view_styles.task_list_item_hover_change_function(content, style)
...
function contracts_view_styles.task_list_completion_visibility_function(content, style)
	local fulfilled = content.task_is_fulfilled

	return fulfilled
end

function contracts_view_styles.task_list_progress_bar_visibility_function(content, style)
	local fulfilled = content.task_is_fulfilled

	return not fulfilled
end

function contracts_view_styles.task_list_item_task_name_change_function(content, style)
	local fulfilled = content.task_is_fulfilled
	local hotspot = content.hotspot
	local hover_progress = hotspot.anim_hover_progress
	local select_progress = hotspot.anim_select_progress
...
function contracts_view_styles.task_list_item_task_icon_change_function(content, style)
	local color_lerp = _color_lerp
	local fulfilled = content.task_is_fulfilled
	local hotspot = content.hotspot
	local hover_progress = hotspot.anim_hover_progress
...
function contracts_view_styles.task_info_change_function(content, style)
...
function contracts_view_styles.task_info_fulfilled_visibility(content, style)
	local is_fulfilled = content.task_is_fulfilled
