...
function StoreItemDetailView:init(settings, context)
...
function StoreItemDetailView:_destroy_offscreen_gui()
...
function StoreItemDetailView:_setup_forward_gui()
	local ui_manager = Managers.ui
	local timer_name = "ui"
...
function StoreItemDetailView:_destroy_forward_gui()
...
function StoreItemDetailView:on_enter()
...
function StoreItemDetailView:_create_loading_widget()
...
function StoreItemDetailView:_is_item_owned(item)
	return self._context.parent:is_item_owned(item.gearId)
end

function StoreItemDetailView:_generate_element_from_item(entry)
...
function StoreItemDetailView:_setup_item_presentation()
...
function StoreItemDetailView:_setup_details(title, type)
...
function StoreItemDetailView:_setup_bundle_button()
	self:_destroy_details()
...
function StoreItemDetailView:_check_details_can_afford()
...
function StoreItemDetailView:_setup_description_grid(item)
...
function StoreItemDetailView:_setup_item_grid()
	self:_destroy_grid()
...
function StoreItemDetailView:set_expire_time(time, widget)
	local timer_text = time and Text.format_time_span_long_form_localized(time) or ""
	widget.content.text = timer_text
end

function StoreItemDetailView:cb_on_item_pressed(widget, element)
...
function StoreItemDetailView:cb_on_bundle_pressed()
...
function StoreItemDetailView:_present_bundle(offer)
...
function StoreItemDetailView:_present_item(item, visual_item)
...
function StoreItemDetailView:_destroy_side_panel()
...
function StoreItemDetailView:_setup_side_panel(element)
...
function StoreItemDetailView:_should_show_inspect(element)
	local offer = element.offer
	local is_bundle = not not offer.bundleInfo
...
function StoreItemDetailView:_present_current_element()
...
function StoreItemDetailView:cb_on_weapon_skin_preview_pressed()
...
function StoreItemDetailView:_destroy_grid()
...
function StoreItemDetailView:_destroy_description_grid()
...
function StoreItemDetailView:_destroy_details()
...
function StoreItemDetailView:_generate_spawn_profile(item)
	local profile = nil
...
function StoreItemDetailView:_is_spawn_profile_by_item_valid(item)
...
function StoreItemDetailView:_generate_mannequin_loadout(profile, optional_item)
...
function StoreItemDetailView:_setup_input_legend()
...
function StoreItemDetailView:_setup_background_world()
...
function StoreItemDetailView:on_resolution_modified()
...
function StoreItemDetailView:_update_viewport_resolution()
...
function StoreItemDetailView:event_register_cosmetics_preview_character_spawn_point(spawn_point_unit)
...
function StoreItemDetailView:_setup_viewport_camera(camera_unit)
	local world_spawner = self._world_spawner
...
function StoreItemDetailView:cb_on_preview_with_gear_toggled(id, input_pressed, instant)
...
function StoreItemDetailView:_stop_previewing()
...
function StoreItemDetailView:_reset_mannequin(optional_item)
...
function StoreItemDetailView:cb_preview_voice()
...
function StoreItemDetailView:_handle_input(input_service)
...
function StoreItemDetailView:_on_navigation_input_changed()
	if not self._using_cursor_navigation then
		if self._aquilas_showing then
...
function StoreItemDetailView:_update_grid_widgets(dt, t, input_service)
	local grid = self._grid
...
function StoreItemDetailView:_update_grid_widgets_visibility()
	local widgets = self._grid_widgets
	local widget_count = widgets and #widgets or 0
...
function StoreItemDetailView:_spawn_profile(profile, initial_rotation, disable_rotation_input, keep_current_rotation)
...
function StoreItemDetailView:cb_on_close_pressed()
	if self.closing_view then
		return
	end
...
function StoreItemDetailView:_hide_elements()
	local widgets_by_name = self._widgets_by_name
...
function StoreItemDetailView:_show_elements()
	local widgets_by_name = self._widgets_by_name
...
function StoreItemDetailView:draw(dt, t, input_service, layer)
...
function StoreItemDetailView:_draw_render_target()
	local ui_forward_renderer = self._ui_forward_renderer
...
function StoreItemDetailView:_draw_grid(dt, t, input_service)
	local grid = self._grid
...
function StoreItemDetailView:_draw_description_grid(dt, t, input_service)
	local description_grid = self._description_grid
...
function StoreItemDetailView:_setup_weapon_preview()
...
function StoreItemDetailView:_update_weapon_preview_viewport()
	local weapon_preview = self._weapon_preview
...
function StoreItemDetailView:_get_weapon_spawn_position_normalized()
	self:_force_update_scenegraph()
...
function StoreItemDetailView:_destroy_weapon_preview()
...
function StoreItemDetailView:_present_weapon(item)
...
function StoreItemDetailView:_destroy_weapon()
	self:_destroy_weapon_preview()
end

function StoreItemDetailView:_destroy_profile()
...
function StoreItemDetailView:_destroy_price_presentation()
	local price_widgets = self._price_widgets
...
function StoreItemDetailView:_update_price_presentation()
...
function StoreItemDetailView:_update_purchase_buttons()
	local selected_element = self._selected_element
	...
	local can_afford = self:can_afford(cost, currency)
	local purchase_button_text = nil
...
function StoreItemDetailView:_update_wallets()
	local wallet_element = self._wallet_element
...
function StoreItemDetailView:can_afford(cost, currency)
...
function StoreItemDetailView:cb_on_purchase_pressed()
	local selected_element = self._selected_element
	local offer = selected_element.offer
	local item_name, item_type = nil
...
function StoreItemDetailView:_create_aquilas_presentation(offer, item_name)
	self:_destroy_aquilas_presentation()
...
function StoreItemDetailView:cb_on_aquila_pressed(widget, element)
...
function StoreItemDetailView:_destroy_aquilas_presentation()
	local aquilas_widgets = self._aquilas_widgets
	local aquilas_widget_count = aquilas_widgets and #aquilas_widgets or 0
...
function StoreItemDetailView:_select_aquila_widget_by_row(direction)
	...
	if new_selection_row then
		...
		local start_position, end_position, delta = nil
...
function StoreItemDetailView:_select_aquila_widget_by_index(index)
	local aquilas_widgets = self._aquilas_widgets
...
function StoreItemDetailView:cb_on_inspect_pressed()
...
function StoreItemDetailView:_unload_url_textures()
	local url_textures = self._url_textures
