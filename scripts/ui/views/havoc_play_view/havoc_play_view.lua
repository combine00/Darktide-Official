...
function HavocPlayView:init(settings, context)
...
function HavocPlayView:on_enter()
...
function HavocPlayView:_setup_text_positions()
...
function HavocPlayView:_setup_current_havoc_mission_data()
...
function HavocPlayView:_extract_havoc_flags_data()
	local current_havoc_order = self._parent.havoc_order
...
function HavocPlayView:cb_view_lore()
	Managers.event:trigger("event_reset_havoc_background_view")
end

function HavocPlayView:_populate_week_data(data)
	local widgets_by_name = self._widgets_by_name
...
function HavocPlayView:_update_reward_timer(dt)
...
function HavocPlayView:_setup_mission_detail_grid(mission_circumstances)
	local definitions = self._definitions
...
function HavocPlayView:_cb_on_mission_revoke_pressed()
	local popup_params = {}
...
function HavocPlayView:_cb_on_party_finder_pressed()
...
function HavocPlayView:_update_mission_participants(participants)
...
function HavocPlayView:_on_navigation_input_changed()
	HavocPlayView.super._on_navigation_input_changed(self)
end

function HavocPlayView:on_resolution_modified(scale)
	HavocPlayView.super.on_resolution_modified(self, scale)
end

function HavocPlayView:on_back_pressed()
	local tutorial_overlay = self._tutorial_overlay
...
function HavocPlayView:draw(dt, t, input_service, layer)
	if not self._initialized then
		return
	end
...
function HavocPlayView:_update_elements(dt, t, input_service)
...
function HavocPlayView:_draw_elements(dt, t, ui_renderer, render_settings, input_service)
	local tutorial_overlay = self._tutorial_overlay
	local tutorial_overlay_active = tutorial_overlay and tutorial_overlay:is_active()
	local elements_array = self._elements_array
...
function HavocPlayView:update(dt, t, input_service)
	local tutorial_overlay = self._tutorial_overlay
...
function HavocPlayView:_update_can_play()
	local widgets_by_name = self._widgets_by_name
...
function HavocPlayView:_handle_input(input_service, dt, t)
	local tutorial_overlay = self._tutorial_overlay
...
function HavocPlayView:on_exit()
	if self._mission_detail_grid then
...
function HavocPlayView:ui_renderer()
	return self._ui_renderer
end

function HavocPlayView:dialogue_system()
...
function HavocPlayView:_ongoing_mission_id()
...
function HavocPlayView:cb_on_help_pressed()
...
function HavocPlayView:_setup_forward_gui()
...
function HavocPlayView:_destroy_forward_gui()
