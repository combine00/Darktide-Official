...
function CraftingMechanicusUpgradeExpertiseView:init(settings, context)
...
function CraftingMechanicusUpgradeExpertiseView:on_enter()
...
function CraftingMechanicusUpgradeExpertiseView:on_exit()
...
function CraftingMechanicusUpgradeExpertiseView:_get_wallet()
...
function CraftingMechanicusUpgradeExpertiseView:_present_crafting(mastery_data, optional_present_callback)
...
function CraftingMechanicusUpgradeExpertiseView:_expertise_updated(new_value)
	local expertise_data = self._expertise_data
	local current = nil

	if expertise_data.max_available <= expertise_data.start then
...
function CraftingMechanicusUpgradeExpertiseView:on_back_pressed()
	self._parent:go_to_crafting_view("select_item_mechanicus", self._item)

	return true
end

function CraftingMechanicusUpgradeExpertiseView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusUpgradeExpertiseView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingMechanicusUpgradeExpertiseView:update(dt, t, input_service)
...
function CraftingMechanicusUpgradeExpertiseView:_handle_input(input_service)
	CraftingMechanicusUpgradeExpertiseView.super._handle_input(self, input_service)
end

function CraftingMechanicusUpgradeExpertiseView:_on_navigation_input_changed()
	return
end

function CraftingMechanicusUpgradeExpertiseView:dialogue_system()
