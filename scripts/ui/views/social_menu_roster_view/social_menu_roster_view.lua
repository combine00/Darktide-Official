...
function SocialMenuRosterView:_change_show_list()
...
function SocialMenuRosterView:_on_navigation_input_changed(optional_starting_index)
...
function SocialMenuRosterView:cb_show_psn_profile(player_info)
	self:_close_popup_menu()
...
function SocialMenuRosterView:cb_update_roster(result)
...
function SocialMenuRosterView:cb_show_rename_popup()
	self:_close_popup_menu()
...
function SocialMenuRosterView:handle_find_player()
	local popup_menu = self._popup_menu
...
function SocialMenuRosterView:event_player_profile_updated(peer_id, player_id, updated_profile)
	local widgets_with_portraits = self._widgets_with_portraits
...
function SocialMenuRosterView:_cb_unset_player_icon(widget, ui_renderer)
...
function SocialMenuRosterView:_cb_unset_player_frame(widget, ui_renderer)
...
function SocialMenuRosterView:_cb_set_player_insignia(widget, item)
	local widget_content = widget.content
...
function SocialMenuRosterView:_queue_icons_for_unload(widget)
...
function SocialMenuRosterView:_unload_icons(force_unload)
	local icon_unload_queue = self._icon_unload_queue
...
function SocialMenuRosterView:_setup_roster_grid(widget_data, optional_starting_index)
...
function SocialMenuRosterView:_prepare_list(roster_list_data, roster_list, new_list_items, list_index)
...
function SocialMenuRosterView:_refresh_roster_lists(force_refresh, dt)
