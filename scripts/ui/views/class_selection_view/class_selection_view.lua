...
function ClassSelectionView:ui_renderer()
...
function ClassSelectionView:_create_archetype_option_widgets()
	...
	for i = 1, #options_data do
		...
		function icon_content.hotspot.pressed_callback()
			if self._using_cursor_navigation then
...
function ClassSelectionView:_on_archetype_pressed(selected_archetype)
...
function ClassSelectionView:_update_archetype_info()
...
function ClassSelectionView:_show_archetypes_widgets(show_details, force_archetype)
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:_destroy_archetype_option_widgets()
...
function ClassSelectionView:_destroy_archetype_abilities_info()
	self._show_archetype_abilities_info = false
...
function ClassSelectionView:_show_archetype_details(show)
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:_create_archetype_abilities_info()
	self:_destroy_archetype_abilities_info()
...
function ClassSelectionView:_handle_details_button_text()
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:on_archetype_pressed(target_option)
	self:_on_archetype_pressed(target_option)
end

function ClassSelectionView:on_continue_pressed()
	local selected_specialization_name = temp_archetype_to_specialization_lookup[self._selected_archetype.name]
