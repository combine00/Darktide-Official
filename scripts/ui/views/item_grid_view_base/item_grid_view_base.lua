...
function ItemGridViewBase:_filter_by_filter_option(entry)
...
function ItemGridViewBase:_present_layout_by_slot_filter(slot_filter, item_type_filter, optional_display_name)
...
function ItemGridViewBase:grid_layout()
...
function ItemGridViewBase:force_update_grid_widget_icon(index)
...
function ItemGridViewBase:_update_weapon_preview_viewport()
...
function ItemGridViewBase:_set_weapon_zoom(fraction)
	self._weapon_zoom_fraction = fraction

	self:_update_weapon_preview_viewport()
end

function ItemGridViewBase:_get_weapon_spawn_position_normalized()
...
function ItemGridViewBase:ui_renderer()
...
function ItemGridViewBase:get_loading_state()
	return self._item_grid and self._item_grid:get_loading_state()
end

function ItemGridViewBase:set_loading_state(is_loading)
	if self._item_grid then
...
function ItemGridViewBase:_requested_index_on_present()
...
function ItemGridViewBase:_cb_on_present()
...
function ItemGridViewBase:_sort_grid_layout(sort_function, optional_filter_layout)
	local item_grid = self._item_grid
...
function ItemGridViewBase:_add_external_layout(layout)
	local spacing_entry = {
		is_external = true,
...
function ItemGridViewBase:_handle_input(input_service, dt, t)
...
function ItemGridViewBase:scroll_to_grid_index(index, is_instant)
...
function ItemGridViewBase:_index_by_condition(condition)
	local item_grid = self._item_grid
...
function ItemGridViewBase:sort_button_widget()
	if self._item_grid then
		return self._item_grid:sort_button_widget()
	end
end

function ItemGridViewBase:sort_button_scenegraph()
	if self._item_grid then
		return self._item_grid:sort_button_scenegpraph()
	end
end

function ItemGridViewBase:get_sort_button_world_position()
	if self._item_grid then
