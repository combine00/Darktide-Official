local Definitions = require("scripts/ui/views/crafting_mechanicus_modify_options_view/crafting_mechanicus_modify_options_view_definitions")
...
local ContentBlueprints = require("scripts/ui/views/crafting_mechanicus_modify_options_view/crafting_mechanicus_modify_options_view_blueprints")
...
function CraftingMechanicusModifyOptionsView:init(settings, context)
	CraftingMechanicusModifyOptionsView.super.init(self, Definitions, settings, context)
...
function CraftingMechanicusModifyOptionsView:upgrade_item()
	self._wanted_tab_index = 1
end

function CraftingMechanicusModifyOptionsView:extract_trait()
	self._wanted_tab_index = 3
end

function CraftingMechanicusModifyOptionsView:replace_trait()
	self._wanted_tab_index = 2
end

function CraftingMechanicusModifyOptionsView:on_enter()
	CraftingMechanicusModifyOptionsView.super.on_enter(self)
...
function CraftingMechanicusModifyOptionsView:_fetch_inventory()
	local local_player_id = 1
...
function CraftingMechanicusModifyOptionsView:_get_wallet()
...
function CraftingMechanicusModifyOptionsView:_on_panel_option_pressed(index)
...
function CraftingMechanicusModifyOptionsView:setup_prices_widget(costs, afford_by_type)
...
function CraftingMechanicusModifyOptionsView:_can_afford(costs)
...
function CraftingMechanicusModifyOptionsView:_remove_traits_widgets()
...
function CraftingMechanicusModifyOptionsView:_reset_state()
...
function CraftingMechanicusModifyOptionsView:_remove_trait_tooltip()
...
function CraftingMechanicusModifyOptionsView:_set_trait_tooltip(trait_info, direction)
...
function CraftingMechanicusModifyOptionsView:_set_tooltip_position(parent_widget, direction)
...
function CraftingMechanicusModifyOptionsView:_select_trait_extract(selected_widget)
	self:_remove_selected_widget()
	self:_remove_traits_widgets()
...
function CraftingMechanicusModifyOptionsView:_select_trait_modify(selected_widget)
	self:_remove_selected_widget()
	self:_remove_traits_widgets()
...
function CraftingMechanicusModifyOptionsView:_remove_selected_widget()
...
function CraftingMechanicusModifyOptionsView:_update_item_grid_position()
	if not self._inventory_traits_grid then
		return
	end
...
function CraftingMechanicusModifyOptionsView:_generate_weapon_traits()
	local traits = {}
...
function CraftingMechanicusModifyOptionsView:_setup_trait_tabs()
...
function CraftingMechanicusModifyOptionsView:_update_tab_bar_position()
...
function CraftingMechanicusModifyOptionsView:cb_switch_trait_tab(index)
...
function CraftingMechanicusModifyOptionsView:_present_layout_by_trait_rarity(trait_rarity)
	local traits = {}
...
function CraftingMechanicusModifyOptionsView:cb_on_grid_entry_left_pressed(widget, element)
...
function CraftingMechanicusModifyOptionsView:_destroy_weapon_preview()
...
function CraftingMechanicusModifyOptionsView:_set_preview_widgets_visibility(visible)
	CraftingMechanicusModifyOptionsView.super._set_preview_widgets_visibility(self, visible)
end

function CraftingMechanicusModifyOptionsView:update(dt, t, input_service)
	...
	return CraftingMechanicusModifyOptionsView.super.update(self, dt, t, input_service)
end

function CraftingMechanicusModifyOptionsView:on_back_pressed(force_close)
...
function CraftingMechanicusModifyOptionsView:on_exit()
	CraftingMechanicusModifyOptionsView.super.on_exit(self)
	...
	self._parent:go_to_crafting_view("select_item_mechanicus", self._preview_item)
end

function CraftingMechanicusModifyOptionsView:draw(dt, t, input_service, layer)
	...
	CraftingMechanicusModifyOptionsView.super._draw_elements(self, dt, t, ui_renderer, render_settings, input_service)
	UIRenderer.begin_pass(ui_renderer, ui_scenegraph, input_service, dt, render_settings)
	CraftingMechanicusModifyOptionsView.super._draw_widgets(self, dt, t, input_service, ui_renderer, render_settings)
...
function CraftingMechanicusModifyOptionsView:_on_navigation_input_changed()
	CraftingMechanicusModifyOptionsView.super._on_navigation_input_changed(self)
end

function CraftingMechanicusModifyOptionsView:_handle_input(input_service)
	local selected_trait = self._selected_trait
...
function CraftingMechanicusModifyOptionsView:dialogue_system()
	return self._parent:dialogue_system()
end

return CraftingMechanicusModifyOptionsView
