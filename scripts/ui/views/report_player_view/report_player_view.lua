...
function ReportPlayerView:init(settings, context)
...
function ReportPlayerView:on_enter()
...
function ReportPlayerView:on_exit()
...
function ReportPlayerView:trigger_on_exit_animation()
...
function ReportPlayerView:on_exit_animation_done()
	return self._window_close_anim_id and self:_is_animation_completed(self._window_close_anim_id)
end

function ReportPlayerView:draw(dt, t, input_service, layer)
...
function ReportPlayerView:_draw_widgets(dt, t, input_service, ui_renderer)
...
function ReportPlayerView:update(dt, t, input_service, layer)
...
function ReportPlayerView:_setup_window_title()
	local context = self._context
...
function ReportPlayerView:_setup_buttons_interactions()
	local widgets_by_name = self._widgets_by_name
...
function ReportPlayerView:_initialize_description_text()
	local widgets_by_name = self._widgets_by_name
...
function ReportPlayerView:_initialize_report_options()
...
function ReportPlayerView:_initialize_report_details()
...
function ReportPlayerView:_on_option_button_pressed(widget, index)
...
function ReportPlayerView:_update_report_button_state()
...
function ReportPlayerView:_get_server_type()
...
function ReportPlayerView:_get_reporter_id()
	local player = self:_player()

	return player:account_id()
end

function ReportPlayerView:_get_session_id()
	local player = self:_player()
...
function ReportPlayerView:_send_report()
...
function ReportPlayerView:_on_submit_pressed()
	self:_update_report_button_state()
	self:_send_report()
...
function ReportPlayerView:_on_close_pressed()
	Managers.ui:close_view(self.view_name)
end

function ReportPlayerView:_on_navigation_input_changed()
...
function ReportPlayerView:_set_selected_gamepad_navigation_index(index)
...
function ReportPlayerView:_handle_button_gamepad_navigation(input_service)
...
function ReportPlayerView:_handle_input(input_service, dt, t)
...
function ReportPlayerView:_set_exclusive_focus_on_grid_widget(widget_name)
	local widgets = self._added_widgets
