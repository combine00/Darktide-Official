...
function TalentLayoutParser.selected_talents_from_selected_nodes(talent_layout, points_spent_on_nodes, selected_talents)
	local nodes = talent_layout.nodes
...
local function _calculate_damage_profile(config)
	...
	local hit_zone_name, charge_level, breed_or_nil, attacker_breed_or_nil, attacker_instigator_breed_or_nil = nil
	...
	local attacker_buff_extension, target_buff_extension, armor_penetrating, target_health_extension, target_toughness_extension = nil
...
function TalentLayoutParser.talent_description(talent_definition, points_spent, value_color)
