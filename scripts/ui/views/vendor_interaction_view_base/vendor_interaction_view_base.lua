...
function VendorInteractionViewBase:_text_widget_size(widget_name, optional_id)
...
function VendorInteractionViewBase:_update_text_height()
...
function VendorInteractionViewBase:disable_view_worlds(view)
...
function VendorInteractionViewBase:base_definitions()
...
function VendorInteractionViewBase:get_balance(type)
