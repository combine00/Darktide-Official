...
function CosmeticsInspectView:_trigger_zoom_logic(optional_slot_name, optional_time)
	local selected_slot = self._selected_slot
...
function CosmeticsInspectView:_update_zoom_logic(dt, input_service)
...
function CosmeticsInspectView:cb_on_camera_zoom_toggled()
...
function CosmeticsInspectView:_set_camera_item_slot_focus(slot_name, time, func_ptr, zoom_percentage)
	local world_spawner = self._world_spawner
