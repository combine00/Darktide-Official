...
function CharacterAppearanceView:_get_appearance_category_options(category_entry_options)
	...
	local function select_eye_by_type(new_option, slot_name)
		...
		character_create:set_item_per_slot(slot_name, selected_option)
	end
	...
	local function preview_eye_by_type(new_option, slot_name)
		...
		if not selected_data_slot[slot_name] then
			local current_value = character_create:slot_item(slot_name)
...
function CharacterAppearanceView:_open_appearance_options(index, force_refresh)
...
function CharacterAppearanceView:_setup_planets_widget()
	local planet_passes = {}
...
function CharacterAppearanceView:_destroy_planets_widget()
...
function CharacterAppearanceView:character_create()
...
function CharacterAppearanceView:profile_spawner()
	return self._profile_spawner
end

function CharacterAppearanceView:widgets_by_name()
