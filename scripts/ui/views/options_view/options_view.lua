...
function OptionsView:init(settings, context)
...
function OptionsView:_restart_popup_info()
	local context = {
...
function OptionsView:_create_settings_widget_from_config(config, category, suffix, callback_name, changed_callback_name)
