...
function TabbedMenuViewBase:set_bar_visibility(visible)
	local tab_bar = self._elements and self._elements.tab_bar
...
function TabbedMenuViewBase:event_register_character_spawn_point(spawn_point_unit)
	self:_unregister_event("event_register_character_spawn_point")

	self._spawn_point_unit = spawn_point_unit
end

function TabbedMenuViewBase:despawn_active_profile()
	if self._profile_spawner then
...
function TabbedMenuViewBase:spawn_profile(profile, visible_on_spawn)
	self:despawn_active_profile()
...
function TabbedMenuViewBase:set_profile_visible(visible)
	self._profile_spawner:set_visibility(visible)
end

function TabbedMenuViewBase:profile_spawner()
	return self._profile_spawner
end

function TabbedMenuViewBase:_setup_tab_bar(tab_bar_params, additional_context, optional_start_index)
