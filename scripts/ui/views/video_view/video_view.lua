...
function VideoView:_play_dummy_video()
...
function VideoView:_update_dummy_video(dt)
...
function VideoView:_trigger_action(action)
...
function VideoView:_record_telemetry()
...
function VideoView:on_skip_pressed()
...
function VideoView:_get_sound_playing_elapsed()
...
function VideoView:_setup_input_legend()
...
function VideoView:_remove_input_legend()
	if self._input_legend_element then
...
function VideoView:draw(dt, t, input_service, layer)
...
function VideoView:wwise_music_state()
