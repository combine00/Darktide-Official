...
function DLCPurchaseView:init(settings, context)
...
function DLCPurchaseView:on_enter()
...
function DLCPurchaseView:_setup_input_legend()
...
function DLCPurchaseView:_register_button_callbacks()
...
function DLCPurchaseView:_on_store_button_pressed(product_id, button_key)
...
function DLCPurchaseView:_cb_on_flow_finished(is_success)
...
function DLCPurchaseView:can_exit()
	return self._can_exit
end

function DLCPurchaseView:on_exit()
	DLCPurchaseView.super.on_exit(self)
end

function DLCPurchaseView:update(dt, t, input_service)
	return DLCPurchaseView.super.update(self, dt, t, input_service)
end

function DLCPurchaseView:_cb_on_back_pressed()
...
function DLCPurchaseView:_cb_on_confirm_pressed()
...
function DLCPurchaseView:_on_input_direction(input_direction)
...
function DLCPurchaseView:_get_selected_button_index()
	local dlc_buttons_ordered = self._dlc_buttons_ordered
...
function DLCPurchaseView:_set_selected_button_index(index)
	local dlc_buttons_ordered = self._dlc_buttons_ordered
...
function DLCPurchaseView:_handle_input(input_service, dt, t)
