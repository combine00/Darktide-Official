...
function CraftingReplaceTraitView:init(settings, context)
...
function CraftingReplaceTraitView:on_enter()
...
function CraftingReplaceTraitView:on_exit()
...
function CraftingReplaceTraitView:_cb_fetch_trait_data(seen_traits)
...
function CraftingReplaceTraitView:_get_wallet()
...
function CraftingReplaceTraitView:_present_crafting(optional_present_callback)
...
function CraftingReplaceTraitView:_set_trait_inventory_focused(focus)
...
function CraftingReplaceTraitView:on_back_pressed()
...
function CraftingReplaceTraitView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingReplaceTraitView:_perform_crafting()
	if self._craft_promise then
		return
	end
...
function CraftingReplaceTraitView:cb_on_trait_selected(widget, config)
...
function CraftingReplaceTraitView:_on_trait_selected(widget, config)
...
function CraftingReplaceTraitView:_draw_elements(dt, t, ui_renderer, render_settings, input_service)
...
function CraftingReplaceTraitView:_update_elements(dt, t, input_service)
	local existing_trait_index = self._ingredients.existing_trait_index
	local elements_array = self._elements_array
...
function CraftingReplaceTraitView:remove_ingredient(ingredient_index)
	local trait_ids = self._ingredients.trait_ids
	trait_ids[ingredient_index] = nil
	self._resync_can_craft = true
end

function CraftingReplaceTraitView:update(dt, t, input_service)
...
function CraftingReplaceTraitView:cb_on_new_trait_selected(widget, config)
	self._resync_can_craft = true
end

function CraftingReplaceTraitView:_handle_input(input_service)
...
function CraftingReplaceTraitView:_on_navigation_input_changed()
...
function CraftingReplaceTraitView:dialogue_system()
