...
function DiscardItemsView:init(settings, context)
...
function DiscardItemsView:_setup_default_gui()
...
function DiscardItemsView:trigger_on_exit_animation()
...
function DiscardItemsView:_sort_items_by_rarity(items)
...
function DiscardItemsView:on_exit()
...
function DiscardItemsView:draw(dt, t, input_service, layer)
...
function DiscardItemsView:_draw_widgets(dt, t, input_service, ui_renderer)
	return DiscardItemsView.super._draw_widgets(self, dt, t, input_service, ui_renderer)
end

function DiscardItemsView:update(dt, t, input_service, layer)
...
function DiscardItemsView:_setup_window_title()
	local context = self._context
...
function DiscardItemsView:_setup_buttons_interactions()
	local widgets_by_name = self._widgets_by_name
...
function DiscardItemsView:_initialize_description_text()
	local widgets_by_name = self._widgets_by_name
...
function DiscardItemsView:_initialize_rarity_options()
...
function DiscardItemsView:_on_rarity_button_pressed(widget, rarity_index)
...
function DiscardItemsView:_update_items_to_discard()
	local items_by_rarity = self._items_by_rarity
...
function DiscardItemsView:_on_discard_pressed()
...
function DiscardItemsView:_on_rating_stepper_left_pressed()
	self:_increment_rating_value(-10)
end

function DiscardItemsView:_on_rating_stepper_right_pressed()
	self:_increment_rating_value(10)
end

function DiscardItemsView:_increment_rating_value(add)
...
function DiscardItemsView:_on_close_pressed()
	Managers.ui:close_view(self.view_name)
end

function DiscardItemsView:_on_navigation_input_changed()
...
function DiscardItemsView:_set_selected_gamepad_navigation_index(index)
...
function DiscardItemsView:_handle_button_gamepad_navigation(input_service)
...
function DiscardItemsView:_handle_input(input_service, dt, t)
