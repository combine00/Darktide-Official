...
local function generate_blueprints_func(grid_size)
	...
	function tag_default.size_function(parent, element, ui_renderer)
	...
	function tag_default.init(parent, widget, element, callback_name, secondary_callback_name, ui_renderer)
		...
		group = {
			...
			init = function (parent, widget, element, callback_name, secondary_callback_name, ui_renderer)
				...
				if tags then
					...
					local difficulty_name, difficulty_text, difficulty_board = nil
