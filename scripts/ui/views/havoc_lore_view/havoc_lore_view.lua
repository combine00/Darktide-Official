...
function HavocLoreView:init(settings, context)
...
function HavocLoreView:on_enter()
...
function HavocLoreView:_handle_input(input_service, dt, t)
...
function HavocLoreView:draw(dt, t, input_service, layer)
...
function HavocLoreView:on_resolution_modified(scale)
	HavocLoreView.super.on_resolution_modified(self, scale)
end

function HavocLoreView:on_back_pressed()
	Managers.event:trigger("event_reset_havoc_background_view")

	return true
end

function HavocLoreView:_cb_on_trailer_button_pressed()
...
function HavocLoreView:update(dt, t, input_service)
	return HavocLoreView.super.update(self, dt, t, input_service)
end

function HavocLoreView:on_exit()
...
function HavocLoreView:ui_renderer()
	return self._ui_renderer
end

function HavocLoreView:_setup_lore_grid()
