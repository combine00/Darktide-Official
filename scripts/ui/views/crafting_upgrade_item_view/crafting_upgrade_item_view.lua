...
function CraftingUpgradeItemView:on_exit()
...
function CraftingUpgradeItemView:_present_upgrade_result(item)
	local result_data = {
		type = "item",
		item = item
	}
...
function CraftingUpgradeItemView:_close_result_overlay()
...
function CraftingUpgradeItemView:_setup_result_overlay(result_data)
	if self._result_overlay then
		self._result_overlay = nil
...
function CraftingUpgradeItemView:_is_result_presentation_active()
	if self._result_overlay then
		return true
	end
...
function CraftingUpgradeItemView:draw(dt, t, input_service, layer)
	if self._result_overlay then
...
function CraftingUpgradeItemView:update(dt, t, input_service)
...
function CraftingUpgradeItemView:_handle_input(input_service)
...
function CraftingUpgradeItemView:_present_crafting()
...
function CraftingUpgradeItemView:cb_on_main_button_pressed()
	if self._craft_promise then
		return
	end
...
function CraftingUpgradeItemView:_perform_crafting()
	if self._craft_promise then
		return
	end
