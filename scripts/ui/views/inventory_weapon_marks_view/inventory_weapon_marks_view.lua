...
local remove_attachment_item_slot_path = nil
...
function InventoryWeaponMarksView:init(settings, context)
...
function InventoryWeaponMarksView:_setup_forward_gui()
...
function InventoryWeaponMarksView:_destroy_forward_gui()
...
function InventoryWeaponMarksView:on_exit()
...
function InventoryWeaponMarksView:on_enter()
...
function InventoryWeaponMarksView:_setup_item_grid(optional_grid_settings)
	if not self._presentation_item then
		return
	end
...
function InventoryWeaponMarksView:_generate_fake_mark_item(mark, marks)
...
function InventoryWeaponMarksView:_register_button_callbacks()
...
function InventoryWeaponMarksView:_update_equip_button_state()
...
function InventoryWeaponMarksView:present_grid_layout(layout)
...
function InventoryWeaponMarksView:cb_on_grid_entry_left_pressed(widget, element)
...
function InventoryWeaponMarksView:_setup_weapon_preview()
...
function InventoryWeaponMarksView:_setup_input_legend()
...
function InventoryWeaponMarksView:_fetch_marks()
...
function InventoryWeaponMarksView:_equip_weapon_mark()
...
function InventoryWeaponMarksView:cb_on_equip_pressed()
	self:_equip_weapon_mark()
end

function InventoryWeaponMarksView:_cb_on_close_pressed()
	Managers.ui:close_view("inventory_weapon_marks_view")
end

function InventoryWeaponMarksView:_preview_element(element)
...
function InventoryWeaponMarksView:_preview_item(item)
...
function InventoryWeaponMarksView:on_back_pressed()
	Managers.ui:close_view("inventory_weapon_marks_view")
end

function InventoryWeaponMarksView:_set_weapon_zoom(fraction)
	self._weapon_zoom_fraction = fraction

	self:_update_weapon_preview_viewport()
end

function InventoryWeaponMarksView:_update_weapon_preview_viewport()
...
function InventoryWeaponMarksView:_handle_input(input_service, dt, t)
...
function InventoryWeaponMarksView:update(dt, t, input_service)
	self:_update_equip_button_state()

	return InventoryWeaponMarksView.super.update(self, dt, t, input_service)
end

function InventoryWeaponMarksView:draw(dt, t, input_service, layer)
...
function InventoryWeaponMarksView:_draw_render_target()
	local ui_forward_renderer = self._ui_forward_renderer
...
function InventoryWeaponMarksView:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function InventoryWeaponMarksView:on_resolution_modified(scale)
