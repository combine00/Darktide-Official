...
function CustomSettingsView:settings_grid_length()
...
function CustomSettingsView:settings_scroll_amount()
	local grid = self._grid
...
function CustomSettingsView:_update_settings_widgets(dt, t, input_service)
...
function CustomSettingsView:_setup_offscreen_gui()
...
function CustomSettingsView:_set_tooltip_data(widget)
...
function CustomSettingsView:update(dt, t, input_service, layer)
...
function CustomSettingsView:_setup_page_grid(config)
...
function CustomSettingsView:_create_settings_widget_from_config(config, suffix, callback_name, changed_callback_name)
...
function CustomSettingsView:_handle_input(input_service, dt, t)
	local selected_settings_widget = self._selected_settings_widget
...
function CustomSettingsView:_set_exclusive_focus_on_grid_widget(widget_name)
	local widgets = self._current_settings_widgets
...
function CustomSettingsView:_enable_settings_overlay(enable)
	local widgets_by_name = self._widgets_by_name
	local settings_overlay_widget = widgets_by_name.settings_overlay
	settings_overlay_widget.content.visible = enable
end

function CustomSettingsView:set_exclusive_focus_on_grid_widget(widget_name)
	self:_set_exclusive_focus_on_grid_widget(widget_name)
end

function CustomSettingsView:_set_selected_grid_widget(widgets, widget_name)
