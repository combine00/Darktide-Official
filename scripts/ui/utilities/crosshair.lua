...
local Crosshair = {}
local _apply_color_values, _hit_indicator_segment, _hit_indicator_offset, _hit_indicator_pivot, _hit_indicator_angle, _apply_hit_indicator_segment_style = nil
local CROSSHAIR_POSITION_LERP_SPEED = 35

function Crosshair.position(dt, t, ui_hud, ui_renderer, current_x, current_y, pivot_position)
	local target_x = 0
	local target_y = 0
	...
	local scaled_x = current_x * ui_renderer_scale
	local scaled_y = current_y * ui_renderer_scale
...
function Crosshair.update_hit_indicator(style, hit_progress, hit_color, hit_weakspot, draw_hit_indicator)
...
function Crosshair.hit_indicator_segment(position_name)
...
function Crosshair.weakspot_hit_indicator_segment(position_name)
