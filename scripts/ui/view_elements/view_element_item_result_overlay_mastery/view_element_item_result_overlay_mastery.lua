...
function ViewElementItemResultOverlayMastery:init(parent, draw_layer, start_scale)
...
function ViewElementItemResultOverlayMastery:start(presentation_data)
...
function ViewElementItemResultOverlayMastery:_present_mastery_reward(config)
...
function ViewElementItemResultOverlayMastery:draw(dt, t, ui_renderer, render_settings, input_service)
