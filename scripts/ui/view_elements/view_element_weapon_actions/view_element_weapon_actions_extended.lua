...
function ViewElementWeaponActionsExtended:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementWeaponActionsExtended:_hide_dividers()
...
function ViewElementWeaponActionsExtended:present_item(item)
	local menu_settings = self._menu_settings
	local grid_size = menu_settings.grid_size
	local layout = {
		{
...
function ViewElementWeaponActionsExtended:stop_presenting()
	self:_destroy_grid_widgets()
	self:_destroy_grid()
end

function ViewElementWeaponActionsExtended:present_grid_layout(layout)
...
function ViewElementWeaponActionsExtended:_on_present_grid_layout_changed(layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
...
function ViewElementWeaponActionsExtended:set_active(active)
	self._active = active
...
function ViewElementWeaponActionsExtended:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementWeaponActionsExtended:update(dt, t, input_service)
	self:_update_animations(dt, t)

	return ViewElementWeaponActionsExtended.super.update(self, dt, t, input_service)
end

function ViewElementWeaponActionsExtended:_update_animations(dt, t)
