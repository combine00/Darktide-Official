...
function ViewElemenMissionBoardOptions:init(parent, draw_layer, start_scale, context)
...
function ViewElemenMissionBoardOptions:_create_offscreen_renderer()
...
function ViewElemenMissionBoardOptions:_create_default_gui()
...
function ViewElemenMissionBoardOptions:_create_background_gui()
	local ui_manager = Managers.ui
	local class_name = self.__class_name
	local timer_name = "ui"
...
function ViewElemenMissionBoardOptions:cb_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function ViewElemenMissionBoardOptions:_set_exclusive_focus_on_grid_widget(widget_name)
...
function ViewElemenMissionBoardOptions:_handle_input(input_service, dt, t)
...
function ViewElemenMissionBoardOptions:_enable_settings_overlay(enable)
	local widgets_by_name = self._widgets_by_name
	local settings_overlay_widget = widgets_by_name.settings_overlay
	settings_overlay_widget.content.visible = enable
end

function ViewElemenMissionBoardOptions:present(presentation_data)
	local widgets = {}
	local alignments = {}
	local size = {
		800,
	...
	for i = 1, #presentation_data do
		...
		if type == "dropdown" then
			...
			function data.changed_callback(changed_value)
...
function ViewElemenMissionBoardOptions:update(dt, t, input_service)
...
function ViewElemenMissionBoardOptions:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElemenMissionBoardOptions:_setup_presentation()
	local height = 800
...
function ViewElemenMissionBoardOptions:_cleanup_presentation()
...
function ViewElemenMissionBoardOptions:_destroy_offscreen_renderer()
...
function ViewElemenMissionBoardOptions:_close_button_pressed()
	self:_cleanup_presentation()
end

function ViewElemenMissionBoardOptions:_destroy_background()
...
function ViewElemenMissionBoardOptions:_destroy_default_gui()
...
function ViewElemenMissionBoardOptions:destroy(ui_renderer)
	if self._offscreen_renderer then
...
function ViewElemenMissionBoardOptions:_scenegraph_world_position(id, scale)
	local ui_scenegraph = self._ui_scenegraph

	return UIScenegraph.world_position(ui_scenegraph, id, scale)
end

function ViewElemenMissionBoardOptions:_set_tooltip_data(widget)
...
function ViewElemenMissionBoardOptions:_on_navigation_input_changed()
