...
function ViewElementTabMenu:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementTabMenu:content_by_id(id)
	local widget = self:_widget_by_id(id)
...
function ViewElementTabMenu:set_color_intensity_multiplier(color_intensity_multiplier)
