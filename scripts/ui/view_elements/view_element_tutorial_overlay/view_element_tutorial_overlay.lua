...
function ViewElementTutorialOverlay:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementTutorialOverlay:_setup_default_gui()
...
function ViewElementTutorialOverlay:activate(data, start_delay)
...
function ViewElementTutorialOverlay:_present_next()
...
function ViewElementTutorialOverlay:draw_begin(ui_renderer)
...
function ViewElementTutorialOverlay:draw_end(ui_renderer)
	local table_name = table_to_address_string(ui_renderer)
...
function ViewElementTutorialOverlay:draw_external_widget(widget, ui_renderer, render_settings)
	local table_name = table_to_address_string(ui_renderer)
...
function ViewElementTutorialOverlay:draw_external_element(element, dt, t, ui_renderer, render_settings, input_service)
	local table_name = table_to_address_string(ui_renderer)
...
function ViewElementTutorialOverlay:active_tutorial_index()
	return self._current_index
end

function ViewElementTutorialOverlay:_active_tutorial_data()
	local current_index = self._current_index or 0
	local tutorial_data = self._tutorial_data
...
function ViewElementTutorialOverlay:active_tutorial_widgets_name()
	local data = self:_active_tutorial_data()

	return data and data.widgets_name
end

function ViewElementTutorialOverlay:active_tutorial_elements()
	local data = self:_active_tutorial_data()

	return data and data.elements
end

function ViewElementTutorialOverlay:active_tutorial_position_data()
	local data = self:_active_tutorial_data()

	return data and data.position_data
end

function ViewElementTutorialOverlay:active_tutorial_clamping_data()
	local data = self:_active_tutorial_data()

	return data and data.clamping_data
end

function ViewElementTutorialOverlay:ui_renderer()
	return self._ui_default_renderer
end

function ViewElementTutorialOverlay:is_active()
	return self._active
end

function ViewElementTutorialOverlay:_setup_tooltip_grid()
...
function ViewElementTutorialOverlay:_present_tooltip_grid_layout(layout)
	local definitions = self._definitions
...
function ViewElementTutorialOverlay:cb_on_grid_layout_changed(layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
	local grid = self._tooltip_grid
...
function ViewElementTutorialOverlay:_update_active_tooltip_entry_position()
...
function ViewElementTutorialOverlay:_update_tooltip_grid_position()
...
function ViewElementTutorialOverlay:_set_tooltip_visibility(visible, pulse_tooltip)
...
function ViewElementTutorialOverlay:_on_navigation_input_changed()
	ViewElementTutorialOverlay.super._on_navigation_input_changed(self)
end

function ViewElementTutorialOverlay:on_resolution_modified(scale)
	ViewElementTutorialOverlay.super.on_resolution_modified(self, scale)
	self:_update_active_tooltip_entry_position()
	self._tooltip_grid:set_render_scale(scale)
end

function ViewElementTutorialOverlay:background_color_intensity()
	return self._background_color_intensity
end

function ViewElementTutorialOverlay:highligt_color_intensity()
...
function ViewElementTutorialOverlay:update(dt, t, input_service)
...
function ViewElementTutorialOverlay:force_close()
	if self._active then
		self._close_intro_popup = true
	end
end

function ViewElementTutorialOverlay:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementTutorialOverlay:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	ViewElementTutorialOverlay.super._draw_widgets(self, dt, t, input_service, ui_renderer, render_settings)
end

function ViewElementTutorialOverlay:_get_input_text(input_action)
...
function ViewElementTutorialOverlay:set_input_actions(input_action_left, input_action_right)
...
function ViewElementTutorialOverlay:_update_input_action_texts()
...
function ViewElementTutorialOverlay:destroy(ui_renderer)
