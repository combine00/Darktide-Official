...
function ViewElementProfilePresets:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementProfilePresets:sync_profiles_states()
	self:_sync_profile_buttons_items_status()
end

function ViewElementProfilePresets:_setup_tooltip_grid()
...
function ViewElementProfilePresets:_setup_intro_grid()
	local layout = {
		{
...
function ViewElementProfilePresets:_setup_custom_icons_grid()
...
function ViewElementProfilePresets:_present_tooltip_grid_layout(layout)
	local definitions = self._definitions
...
function ViewElementProfilePresets:_setup_preset_buttons()
...
function ViewElementProfilePresets:_sync_profile_buttons_items_status()
	local profile_presets = ProfileUtils.get_profile_presets()
	local num_profile_presets = profile_presets and #profile_presets or 0
	local profile_buttons_widgets = self._profile_buttons_widgets
...
function ViewElementProfilePresets:set_current_profile_loadout_status(show_warning, show_modified)
	self._current_profile_loadout_warning = show_warning
	self._current_profile_loadout_modified = show_modified
end

function ViewElementProfilePresets:show_profile_preset_missing_items_warning(is_missing_content, is_modified_content, optional_preset_id)
...
function ViewElementProfilePresets:can_add_profile_preset()
	local profile_presets = ProfileUtils.get_profile_presets()
	local active_profile_preset_id = ProfileUtils.get_active_profile_preset_id()
...
function ViewElementProfilePresets:cb_add_new_profile_preset()
...
function ViewElementProfilePresets:_remove_profile_preset(widget, element)
...
function ViewElementProfilePresets:cb_on_profile_preset_icon_grid_layout_changed(layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
	local grid = self._profile_preset_tooltip_grid
...
function ViewElementProfilePresets:cb_on_profile_preset_icon_grid_left_pressed(widget, element)
...
function ViewElementProfilePresets:_update_profile_preset_tooltip_grid_position()
...
function ViewElementProfilePresets:has_active_profile_preset()
	return self._active_profile_preset_id ~= nil
end

function ViewElementProfilePresets:customize_active_profile_presets()
...
function ViewElementProfilePresets:on_profile_preset_index_customize(index)
...
function ViewElementProfilePresets:handling_input()
	if self._intro_active then
		return true
	end
...
function ViewElementProfilePresets:_set_tooltip_visibility(visible, pulse_tooltip)
...
function ViewElementProfilePresets:cycle_next_profile_preset()
	local profile_buttons_widgets = self._profile_buttons_widgets
	local active_profile_preset_id = self._active_profile_preset_id
...
function ViewElementProfilePresets:_get_widget_by_preset_id(id)
	local profile_buttons_widgets = self._profile_buttons_widgets
...
function ViewElementProfilePresets:_get_profile_preset_id_by_widget_index(index)
	local profile_buttons_widgets = self._profile_buttons_widgets
...
function ViewElementProfilePresets:on_profile_preset_index_change(index, ignore_activation, on_preset_deleted, ignore_sound)
...
function ViewElementProfilePresets:_update_profile_presets(input_service, dt, t)
...
function ViewElementProfilePresets:_on_navigation_input_changed()
	ViewElementProfilePresets.super._on_navigation_input_changed(self)
end

function ViewElementProfilePresets:set_pivot_offset(x, y)
...
function ViewElementProfilePresets:on_resolution_modified(scale)
...
function ViewElementProfilePresets:update(dt, t, input_service)
...
function ViewElementProfilePresets:draw(dt, t, ui_renderer, render_settings, input_service)
	if not self._is_inventory_ready then
		input_service = input_service:null_service()
	end
...
function ViewElementProfilePresets:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
	local profile_buttons_widgets = self._profile_buttons_widgets
...
function ViewElementProfilePresets:_get_input_text(input_action)
...
function ViewElementProfilePresets:set_input_actions(input_action_left, input_action_right)
...
function ViewElementProfilePresets:set_is_handling_navigation_input(is_enabled)
	self._is_handling_navigation_input = is_enabled
end

function ViewElementProfilePresets:_update_input_action_texts()
...
function ViewElementProfilePresets:destroy(ui_renderer)
...
function ViewElementProfilePresets:is_costumization_open()
