...
function ViewElementWintrackMastery:init(parent, draw_layer, start_scale, optional_menu_settings)
	ViewElementWintrackMastery.super.init(self, parent, draw_layer, start_scale, optional_menu_settings, Definitions)
end

function ViewElementWintrackMastery:_create_reward_widgets(rewards, ui_renderer)
	local widgets = {}
	local item_widgets = {}
...
function ViewElementWintrackMastery:_on_reward_items_hover_start(items, index, widget)
	index = index or 1
...
function ViewElementWintrackMastery:tooltip_visible()
	return self._widgets_by_name.tooltip.content.visible
end

function ViewElementWintrackMastery:_on_reward_items_hover_stop()
