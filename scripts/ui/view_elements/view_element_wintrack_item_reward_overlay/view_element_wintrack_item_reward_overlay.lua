...
function ViewElementWintrackItemRewardOverlay:init(parent, draw_layer, start_scale)
	self._time = nil
...
function ViewElementWintrackItemRewardOverlay:_setup_default_gui()
...
function ViewElementWintrackItemRewardOverlay:_setup_background_world()
...
function ViewElementWintrackItemRewardOverlay:event_register_title_screen_camera(camera_unit)
...
function ViewElementWintrackItemRewardOverlay:_setup_background_gui()
	local ui_manager = Managers.ui
	local reference_name = self._reference_name
	local timer_name = "ui"
...
function ViewElementWintrackItemRewardOverlay:cb_background_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function ViewElementWintrackItemRewardOverlay:on_resolution_modified(scale)
...
function ViewElementWintrackItemRewardOverlay:_update_viewport_resolution()
...
function ViewElementWintrackItemRewardOverlay:start(presentation_data)
...
function ViewElementWintrackItemRewardOverlay:_load_item_icon(item)
...
function ViewElementWintrackItemRewardOverlay:unload_item_icon()
...
function ViewElementWintrackItemRewardOverlay:cb_start_reward_presentation()
	return
end

function ViewElementWintrackItemRewardOverlay:destroy(ui_renderer)
...
function ViewElementWintrackItemRewardOverlay:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementWintrackItemRewardOverlay:update(dt, t, input_service)
...
function ViewElementWintrackItemRewardOverlay:_set_background_blur(fraction)
...
function ViewElementWintrackItemRewardOverlay:presentation_complete()
	return self._done
end

function ViewElementWintrackItemRewardOverlay:_setup_weapon_stats()
...
function ViewElementWintrackItemRewardOverlay:_update_weapon_stats_position()
	...
	local length = weapon_stats:grid_area_length() or 0
...
function ViewElementWintrackItemRewardOverlay:set_title_text(localized_text)
