...
function ViewElementGrid:set_sort_button_offset(x, y)
	local widget = self._widgets_by_name.sort_button
...
function ViewElementGrid:set_timer_text_offset(x, y)
...
function ViewElementGrid:set_grid_interaction_offset(x, y)
...
function ViewElementGrid:set_draw_layer(draw_layer)
	if self._world then
...
function ViewElementGrid:_setup_grid_gui(optional_world)
...
function ViewElementGrid:set_color_intensity_multiplier(color_intensity_multiplier)
	self._color_intensity_multiplier = color_intensity_multiplier or 1
end

function ViewElementGrid:set_tutorial_color_intensity_multiplier(color_intensity_multiplier)
	self._tutorial_color_intensity_multiplier = color_intensity_multiplier
end

function ViewElementGrid:set_alpha_multiplier(alpha_multiplier)
	self._alpha_multiplier = alpha_multiplier or 1
end

function ViewElementGrid:alpha_multiplier()
...
function ViewElementGrid:_draw_grid(dt, t, ui_renderer, input_service, render_settings)
...
function ViewElementGrid:grid_layout()
	return self._grid_layout
end

function ViewElementGrid:update_grid_layout(new_layout)
...
function ViewElementGrid:set_enable_gamepad_scrolling(enable_gamepad_scrolling)
	local menu_settings = self._menu_settings
...
function ViewElementGrid:is_gamepad_scrolling_enabled()
	local menu_settings = self._menu_settings

	return menu_settings.enable_gamepad_scrolling
end

function ViewElementGrid:grid_scrollbar()
	return self._widgets_by_name.grid_scrollbar
end

function ViewElementGrid:_show_empty_message()
	self._widgets_by_name.grid_empty.content.visible = true
end

function ViewElementGrid:_hide_empty_message()
	self._widgets_by_name.grid_empty.content.visible = false
end

function ViewElementGrid:set_empty_message(text)
	if text then
		self._widgets_by_name.grid_empty.content.text = text
	end
end

function ViewElementGrid:set_handle_grid_navigation(allow)
	local grid = self._grid

	grid:set_handle_grid_navigation(allow)
end

function ViewElementGrid:get_loading_state()
	return self._widgets_by_name.grid_loading.content.is_loading
end

function ViewElementGrid:set_loading_state(is_loading)
...
function ViewElementGrid:update_dividers_alpha(top_alpha, bottom_alpha)
...
function ViewElementGrid:focused_grid_widget()
	local grid = self._grid
...
function ViewElementGrid:widget_by_index(index)
	local grid = self._grid
...
function ViewElementGrid:scrollbar_progress()
	local grid = self._grid

	return grid and grid:scrollbar_progress()
end

function ViewElementGrid:set_scrollbar_progress(scroll_progress, instant_scroll)
	local grid = self._grid
...
function ViewElementGrid:force_update_grid_widget_icon(index)
	local widgets = self._grid_widgets
...
function ViewElementGrid:set_default_item_icon_profile(profile)
...
function ViewElementGrid:destroy(ui_renderer)
	if self._present_grid_layout then
		self._present_grid_layout = nil
	end
...
function ViewElementGrid:sort_button_widget()
	return self._widgets_by_name.sort_button
end

function ViewElementGrid:sort_button_scenegpraph()
	return self._ui_scenegraph.sort_button
end

function ViewElementGrid:get_sort_button_world_position()
	local widget = self._widgets_by_name.sort_button
	local scenegraph_id = widget.scenegraph_id
...
function ViewElementGrid:length_scrolled()
	local grid = self._grid
...
function ViewElementGrid:scroll_length()
	local grid = self._grid
...
function ViewElementGrid:force_update_list_size_keeping_scroll()
...
function ViewElementGrid:hovered_grid_index()
	local grid = self._grid
...
function ViewElementGrid:hovered_widget()
	local grid = self._grid
...
function ViewElementGrid:set_background_hovered(hovered)
...
function ViewElementGrid:hovered()
	local widgets_by_name = self._widgets_by_name
	local interaction_widget = widgets_by_name.grid_interaction
...
function ViewElementGrid:pressed()
	local widgets_by_name = self._widgets_by_name
	local interaction_widget = widgets_by_name.grid_interaction
