...
function ViewElementCraftingRecipe:set_continue_button_force_disabled(is_disabled, force_effect)
	self._continue_button_force_disabled = is_disabled

	self:_update_continue_button_state(force_effect)
end

function ViewElementCraftingRecipe:set_continue_button_callback(button_callback)
	self._continue_button_callback = button_callback
end

function ViewElementCraftingRecipe:_update_continue_button_state(force_effect)
	local widgets_by_name = self._widgets_by_name
...
function ViewElementCraftingRecipe:_cb_on_continue_pressed()
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.continue_button
...
function ViewElementCraftingRecipe:cb_on_grid_entry_right_pressed(widget, element)
...
function ViewElementCraftingRecipe:remove_ingredient(ingredient)
...
function ViewElementCraftingRecipe:_is_costs_free_of_charge(costs)
	local is_free = true
...
function ViewElementCraftingRecipe:refresh_cost(additional_data)
	local content = self.content
	content.costs = nil
...
function ViewElementCraftingRecipe:play_continue_button_animation()
...
function ViewElementCraftingRecipe:stop_continue_button_animation()
