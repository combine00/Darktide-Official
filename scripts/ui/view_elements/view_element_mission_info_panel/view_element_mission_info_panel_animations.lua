...
function animations.change_functions.event_frame(content, style, animations, dt)
...
function animations.change_functions.frame_lights(content, style, animations, dt)
