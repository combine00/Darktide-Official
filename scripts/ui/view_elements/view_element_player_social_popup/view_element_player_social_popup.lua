...
function ViewElementPlayerSocialPopup:event_player_profile_updated(peer_id, player_id, updated_profile)
...
function ViewElementPlayerSocialPopup:_update_portrait()
	local player_header = self._widgets_by_name.player_header
	local content = player_header.content
	local player_info = self._player_info
...
function ViewElementPlayerSocialPopup:cb_set_player_info(player_info)
	self:set_player_info(self._parent, player_info)
end

function ViewElementPlayerSocialPopup:set_player_info(parent, player_info)
...
function ViewElementPlayerSocialPopup:setup_find_player(parent, player_info)
...
function ViewElementPlayerSocialPopup:_search_for_player(fatshark_id)
...
function ViewElementPlayerSocialPopup:previously_searched_fatshark_id()
...
function ViewElementPlayerSocialPopup:_transition_to_new_player_info(parent, player_info, menu_items, num_menu_items)
...
function ViewElementPlayerSocialPopup:_set_player_info(parent, player_info, menu_items, num_menu_items, show_friend_code)
	local player_header = self._widgets_by_name.player_header
	...
	elseif not player_info:is_myself() and (IS_XBS or IS_GDK) and player_info:platform() == "xbox" then
		local xuid = player_info:platform_user_id()
		local platform_profile = parent:get_platform_profile(xuid)
...
function ViewElementPlayerSocialPopup:_cb_set_player_icon(widget, grid_index, rows, columns, render_target)
...
function ViewElementPlayerSocialPopup:_cb_unset_player_icon(widget, ui_renderer)
...
function ViewElementPlayerSocialPopup:_cb_set_player_frame(widget, item)
	local icon = item.icon
	local portrait_style = widget.style.portrait
	portrait_style.material_values.portrait_frame_texture = icon
end

function ViewElementPlayerSocialPopup:_cb_unset_player_frame(widget, ui_renderer)
	local previously_visible = widget.content.visible
...
function ViewElementPlayerSocialPopup:destroy(ui_renderer)
