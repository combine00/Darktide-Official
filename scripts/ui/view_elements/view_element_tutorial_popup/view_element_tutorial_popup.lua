...
function ViewElementTutorialPopup:init(parent, draw_layer, start_scale, context)
...
function ViewElementTutorialPopup:_setup_default_gui()
...
function ViewElementTutorialPopup:_setup_tutorial_grid()
...
function ViewElementTutorialPopup:ui_renderer()
	return self._ui_default_renderer
end

function ViewElementTutorialPopup:_update_grid_position()
...
function ViewElementTutorialPopup:_present_tutorial_popup_page(page_index)
...
function ViewElementTutorialPopup:_handle_tutorial_button_gamepad_navigation(input_service)
	local widgets_by_name = self._widgets_by_name
...
function ViewElementTutorialPopup:_update_tutorial_button_texts()
...
function ViewElementTutorialPopup:cb_on_tutorial_button_1_pressed()
...
function ViewElementTutorialPopup:cb_on_tutorial_button_2_pressed()
	local current_page_index = self._active_tutorial_popup_page or 1
...
function ViewElementTutorialPopup:_on_navigation_input_changed()
	ViewElementTutorialPopup.super._on_navigation_input_changed(self)
	self:_update_tutorial_button_texts()
end

function ViewElementTutorialPopup:destroy(ui_renderer)
...
function ViewElementTutorialPopup:update(dt, t, input_service)
...
function ViewElementTutorialPopup:draw(dt, t, ui_renderer, render_settings, input_service)
