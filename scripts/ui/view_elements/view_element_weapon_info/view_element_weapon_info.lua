...
function ViewElementWeaponInfo:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementWeaponInfo:set_pivot_offset(x, y)
	ViewElementWeaponInfo.super.set_pivot_offset(self, x, y)
	self:_start_animation()
end

function ViewElementWeaponInfo:activate(activate)
...
function ViewElementWeaponInfo:set_alpha_multiplier(alpha_multiplier)
	self._alpha_multiplier = alpha_multiplier
end

function ViewElementWeaponInfo:is_active()
	return self._active
end

function ViewElementWeaponInfo:_start_animation()
...
function ViewElementWeaponInfo:_hide_dividers()
...
function ViewElementWeaponInfo:present_item(item, on_present_callback, ignore_list)
	local menu_settings = self._menu_settings
	local grid_size = menu_settings.grid_size
...
function ViewElementWeaponInfo:stop_presenting()
	self:_destroy_grid_widgets()
	self:_destroy_grid()
end

function ViewElementWeaponInfo:present_grid_layout(layout, on_present_callback)
...
function ViewElementWeaponInfo:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementWeaponInfo:update(dt, t, input_service)
	self:_update_animations(dt, t)

	return ViewElementWeaponInfo.super.update(self, dt, t, input_service)
end

function ViewElementWeaponInfo:_update_animations(dt, t)
...
function ViewElementWeaponInfo:_draw_bar_breakdown_widgets(dt, t, input_service, render_settings)
	local ui_scenegraph = self._ui_scenegraph
...
function ViewElementWeaponInfo:update_bar_breakdown_data(bar_data)
...
function ViewElementWeaponInfo:_destroy_bar_breakdown_widgets()
...
function ViewElementWeaponInfo:_scale_value_by_type(value, display_type)
...
function ViewElementWeaponInfo:_value_to_text(value, is_signed)
...
function ViewElementWeaponInfo:_get_stats_text(stat)
...
function ViewElementWeaponInfo:_strip_redundant_stats(bar_data)
...
function ViewElementWeaponInfo:_create_bar_breakdown_widgets(bar_data)
	table.clear(self._bar_breakdown_widgets)
	table.clear(self._bar_breakdown_widgets_by_name)
