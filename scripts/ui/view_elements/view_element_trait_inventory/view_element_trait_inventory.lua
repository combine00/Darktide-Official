...
function ViewElementTraitInventory:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementTraitInventory:destroy(ui_renderer)
...
function ViewElementTraitInventory:show_overlay(show)
...
function ViewElementTraitInventory:clear_marks()
...
function ViewElementTraitInventory:cb_on_grid_entry_left_pressed(widget, config)
...
function ViewElementTraitInventory:marked_trait_item()
	return self._marked_trait_item
end

function ViewElementTraitInventory:marked_trait_cost()
	return self._marked_widget and self._marked_widget.content.cost
end

function ViewElementTraitInventory:_on_trait_hover(config)
	self._hovered_trait_item = config.trait_item
end

function ViewElementTraitInventory:start_animation()
	local ui_scenegraph = self._ui_scenegraph
	local func = UIAnimation.function_by_time
...
function ViewElementTraitInventory:disable()
	self._disabled = true

	self:select_grid_index(nil)
end

function ViewElementTraitInventory:enable()
...
function ViewElementTraitInventory:hide()
	self._active = false
end

function ViewElementTraitInventory:show()
	self._active = true
end

function ViewElementTraitInventory:active()
	return self._active and not self._disabled
end

function ViewElementTraitInventory:select_best_widget(allow_only_marked_widget)
...
function ViewElementTraitInventory:set_alpha_multiplier(alpha_multiplier)
	self._alpha_multiplier = alpha_multiplier or 0
end

function ViewElementTraitInventory:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementTraitInventory:_update_animations(dt, t)
...
function ViewElementTraitInventory:_update_info_box()
...
function ViewElementTraitInventory:present_inventory(sticker_book, ingredients, external_left_click_callback, do_animation)
...
function ViewElementTraitInventory:_update_tab_counts()
...
function ViewElementTraitInventory:_setup_tabs()
	local tab_settings = {
...
function ViewElementTraitInventory:_switch_to_rank_tab(rank, initializing)
	self._rank = rank
...
function ViewElementTraitInventory:update(dt, t, input_service)
	if not self._active then
		return
	end
...
function ViewElementTraitInventory:_update_tabs()
...
function ViewElementTraitInventory:_handle_input(dt, t, input_service)
...
function ViewElementTraitInventory:ingredients()
	return self._ingredients
end

function ViewElementTraitInventory:_present(first_presentation)
	if not self._sticker_book then
		return
	end
...
function ViewElementTraitInventory:_cb_present_grid_layout()
...
function ViewElementTraitInventory:_on_navigation_input_changed()
