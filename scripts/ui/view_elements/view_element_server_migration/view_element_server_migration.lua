...
function ViewElemenServerMigration:init(parent, draw_layer, start_scale, context)
...
function ViewElemenServerMigration:_create_offscreen_renderer()
...
function ViewElemenServerMigration:_create_default_gui()
...
function ViewElemenServerMigration:_create_background_gui()
	local ui_manager = Managers.ui
	local class_name = self.__class_name
	local timer_name = "ui"
...
function ViewElemenServerMigration:cb_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function ViewElemenServerMigration:change_page_presentation(index)
...
function ViewElemenServerMigration:_generate_slider_widget(current_index)
	...
	if current_index < #self._presentation_data then
		function self._widgets_by_name.next_button.content.hotspot.pressed_callback()
...
function ViewElemenServerMigration:present(migration_data)
...
function ViewElemenServerMigration:update(dt, t, input_service)
...
function ViewElemenServerMigration:_handle_input(input_service, dt, t)
...
function ViewElemenServerMigration:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElemenServerMigration:_setup_presentation()
...
function ViewElemenServerMigration:_cleanup_presentation()
...
function ViewElemenServerMigration:_destroy_offscreen_renderer()
...
function ViewElemenServerMigration:_destroy_background()
...
function ViewElemenServerMigration:_destroy_default_gui()
...
function ViewElemenServerMigration:_on_navigation_input_changed()
...
function ViewElemenServerMigration:_close_button_pressed()
	self:_cleanup_presentation()
end

function ViewElemenServerMigration:destroy(ui_renderer)
	if self._offscreen_renderer then
