...
function ViewElementInputLegend:add_entry(display_name, input_action, visibility_function, on_pressed_callback, side_optional, sound_overrides, use_mouse_hold, extra_input_actions, suffix_function)
