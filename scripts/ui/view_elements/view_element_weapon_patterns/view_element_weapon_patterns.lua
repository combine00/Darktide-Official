...
function ViewElementWeaponPatterns:init(parent, draw_layer, start_scale, optional_menu_settings)
...
function ViewElementWeaponPatterns:_hide_dividers()
...
function ViewElementWeaponPatterns:present_item(item)
	local layout = {
		{
...
function ViewElementWeaponPatterns:stop_presenting()
	self:_destroy_grid_widgets()
	self:_destroy_grid()
end

function ViewElementWeaponPatterns:present_grid_layout(layout, item)
...
function ViewElementWeaponPatterns:_on_present_grid_layout_changed(layout, content_blueprints, left_click_callback, right_click_callback, display_name, optional_grow_direction)
...
function ViewElementWeaponPatterns:current_attack_index()
	return self._current_attack_index, self._chain_index
end

function ViewElementWeaponPatterns:set_current_attack_index(attack_index, chain_index)
	self._current_attack_index = attack_index
	self._chain_index = chain_index
end

function ViewElementWeaponPatterns:is_active()
	return self._active
end

function ViewElementWeaponPatterns:set_active(active)
	self._active = active
...
function ViewElementWeaponPatterns:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementWeaponPatterns:update(dt, t, input_service)
	self:_update_animations(dt, t)

	return ViewElementWeaponPatterns.super.update(self, dt, t, input_service)
end

function ViewElementWeaponPatterns:_update_animations(dt, t)
