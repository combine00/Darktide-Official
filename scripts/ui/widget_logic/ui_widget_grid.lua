...
function UIWidgetGrid:init(widgets, alignment_list, scenegraph, area_scenegraph_id, direction, spacing, fill_section_spacing, use_is_focused_for_navigation, use_select_on_focused, bottom_chin, top_padding, scroll_start_margin, center, optional_size)
...
function UIWidgetGrid:set_handle_grid_navigation(allow)
	self._handle_grid_navigation = allow
end

function UIWidgetGrid:_get_area_size(optional_size)
...
function UIWidgetGrid:assign_scrollbar(scrollbar_widget, pivot_scenegraph_id, interaction_scenegraph_id, use_custom_scroll_amount)
...
function UIWidgetGrid:set_enable_gamepad_scrolling(enable_gamepad_scrolling)
...
function UIWidgetGrid:_update_scroll_progress(force_update)
...
function UIWidgetGrid:can_move_vertical(input_direction)
	local current_index = self._selected_grid_index
...
function UIWidgetGrid:hovered_grid_index()
	local widgets = self._widgets
