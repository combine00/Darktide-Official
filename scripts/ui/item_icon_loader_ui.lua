...
function ItemIconLoaderUI:load_icon(item, on_load_callback, on_unload_callback)
...
function ItemIconLoaderUI:_handle_icon_unloads(force_unload)
...
function ItemIconLoaderUI:_unload_icon(id)
	local data = self:_request_by_id(id)
...
function ItemIconLoaderUI:prepare_for_destruction()
...
function ItemIconLoaderUI:prioritize_request(reference_id)
