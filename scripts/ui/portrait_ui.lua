...
function PortraitUI:unload_profile_portrait(reference_id)
	self:unload_request_reference(reference_id)
end

function PortraitUI:change_render_portrait_status(value, force_change)
...
function PortraitUI:load_profile_portrait(profile, on_load_callback, optional_render_context, prioritized, on_unload_callback)
	local character_id = profile.character_id
...
function PortraitUI:_should_render()
	local profile_spawner = self._profile_spawner
...
function PortraitUI:_prepare_request_capture(request)
...
function PortraitUI:_is_ready_to_capture_request()
	local profile_spawner = self._profile_spawner
...
function PortraitUI:_on_capture_complete(active_request)
	if self._profile_spawner then
		self._profile_spawner:destroy()
...
function PortraitUI:_store_camera_settings_by_breed(breed, camera_unit)
...
function PortraitUI:_reset_active_spawning()
...
function PortraitUI:_camera_unit()
