...
function ButtonPassTemplates.terminal_list_button_frame_hover_change_function(content, style)
...
function ButtonPassTemplates.terminal_list_button_text_change_function(content, style)
	local color_lerp = color_lerp
	local math_max = math_max
	local hotspot = content.hotspot
