...
function WeaponIconUI:_check_weapon_icon_enabled_status()
...
function WeaponIconUI:unload_weapon_icon(reference_id)
	self:unload_request_reference(reference_id)
end

function WeaponIconUI:load_weapon_icon(item, on_load_callback, optional_render_context, prioritized, on_unload_callback)
...
function WeaponIconUI:_should_render()
	local ui_weapon_spawner = self._ui_weapon_spawner
...
function WeaponIconUI:_prepare_request_capture(request)
...
function WeaponIconUI:_is_ready_to_capture_request()
	local ui_weapon_spawner = self._ui_weapon_spawner
...
function WeaponIconUI:_on_capture_complete(active_request)
	if self._ui_weapon_spawner then
		self._ui_weapon_spawner:destroy()
...
function WeaponIconUI:_reset_active_spawning()
...
function WeaponIconUI:_camera_unit()
...
function WeaponIconUI:change_render_weapon_icon_status(value, force_change)
