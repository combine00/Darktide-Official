...
function ViewTransitionUI:init(render_settings)
...
function ViewTransitionUI:_destroy_renderer()
...
function ViewTransitionUI:destroy()
...
function ViewTransitionUI:active()
	return self._active
end

function ViewTransitionUI:update(dt, t, should_transition, transition_progress)
