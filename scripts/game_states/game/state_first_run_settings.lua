...
function StateFirstRunSettings:on_enter(parent, params, creation_context)
...
function StateFirstRunSettings:_continue_cb()
	self._continue = true
end

function StateFirstRunSettings:update(main_dt, main_t)
...
function StateFirstRunSettings:on_exit()
