...
function GameplayInitStepMusic:on_enter(parent, params)
...
function GameplayInitStepMusic:update(main_dt, main_t)
...
function GameplayInitStepMusic:_music_post_init(level, is_dedicated_server)
