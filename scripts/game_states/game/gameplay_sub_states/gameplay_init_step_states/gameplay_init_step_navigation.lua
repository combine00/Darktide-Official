...
function GameplayInitStepNavigation:update(main_dt, main_t)
...
function GameplayInitStepNavigation:_init_navigation(world, nav_world, is_server, level_name, level_seed, mission_name, network_event_delegate)
