...
function GameplayInitStepOutOfBounds:on_enter(parent, params)
...
function GameplayInitStepOutOfBounds:update(main_dt, main_t)
...
function GameplayInitStepOutOfBounds:_init_out_of_bounds_checker(world, out_shared_state)
