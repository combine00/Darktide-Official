...
function GameplayInitStepNavWorld:on_enter(parent, params)
...
function GameplayInitStepNavWorld:update(main_dt, main_t)
...
function GameplayInitStepNavWorld:_init_nav_world(level_name, out_shared_state)
