...
function GameplayInitStepGameMode:on_enter(parent, params)
...
function GameplayInitStepGameMode:update(main_dt, main_t)
...
function GameplayInitStepGameMode:_init_game_mode(mission_name, world, physics_world, is_server, network_event_delegate)
