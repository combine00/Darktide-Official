...
function GameplayInitStepMutator:on_enter(parent, params)
...
function GameplayInitStepMutator:update(main_dt, main_t)
	self._shared_state.initialized_steps.GameplayInitStepMutator = true
