...
function MissionCleanupUtilies.cleanup(shared_state, gameplay_state, initialized_steps)
	...
	Crashify.remove_print_property("in_havoc_mission")
...
function MissionCleanupUtilies._unregister_network_events(is_server, shared_state)
...
function MissionCleanupUtilies._destroy_nvidia_ai_agent(is_dedicated_server, shared_state)
...
function MissionCleanupUtilies._despawn_units(is_server, world, level, themes)
...
function MissionCleanupUtilies._destroy_nav_world(shared_state)
...
function MissionCleanupUtilies._unregister_timer(is_server, shared_state)
