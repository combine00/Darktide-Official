local mission_vo_cm_habs_remake_veteran_female_b = {
	...
	level_hab_block_apartments = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_female_b__level_hab_block_apartments_01",
			[2.0] = "loc_veteran_female_b__level_hab_block_apartments_02"
		},
		sound_events_duration = {
			[1.0] = 1.674729,
			[2.0] = 2.228979
	...
	level_hab_block_apartments_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_female_b__level_hab_block_apartments_response_01",
			[2.0] = "loc_veteran_female_b__level_hab_block_apartments_response_02"
		},
		sound_events_duration = {
			[1.0] = 3.304958,
			[2.0] = 3.055271
	...
	level_hab_block_collapse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_female_b__level_hab_block_collapse_01",
			[2.0] = "loc_veteran_female_b__level_hab_block_collapse_02"
		},
		sound_events_duration = {
			[1.0] = 0.987792,
			[2.0] = 0.690313
	...
	level_hab_block_corpse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_female_b__level_hab_block_corpse_01",
			[2.0] = "loc_veteran_female_b__level_hab_block_corpse_02"
		},
		sound_events_duration = {
			[1.0] = 2.739229,
			[2.0] = 2.786125
	...
	level_hab_block_security = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_female_b__level_hab_block_security_01",
			[2.0] = "loc_veteran_female_b__level_hab_block_security_02"
		},
		sound_events_duration = {
			[1.0] = 4.099167,
			[2.0] = 4.166479
