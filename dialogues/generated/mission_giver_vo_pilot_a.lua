local mission_giver_vo_pilot_a = {
	...
	info_air_strike_a = {
		...
		sound_events_n = 10,
		sound_events = {
			"loc_pilot_a__info_air_strike_a_01",
			"loc_pilot_a__info_air_strike_a_02",
			"loc_pilot_a__info_air_strike_a_03",
			"loc_pilot_a__info_air_strike_a_04",
			"loc_pilot_a__info_air_strike_a_05",
			"loc_pilot_a__info_air_strike_a_06",
