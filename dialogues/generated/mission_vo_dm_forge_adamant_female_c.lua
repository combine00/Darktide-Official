local mission_vo_dm_forge_adamant_female_c = {
	...
	mission_forge_main_entrance_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_adamant_female_c__region_mechanicus_02",
			[2.0] = "loc_adamant_female_c__region_mechanicus_03"
		},
		sound_events_duration = {
			[1.0] = 3.516042,
			[2.0] = 3.609
	...
	mission_forge_start_banter_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_forge_start_banter_a_01"
		},
		sound_events_duration = {
			[1.0] = 4.397594
		},
	...
	mission_forge_strategic_asset = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_forge_strategic_asset_01"
		},
		sound_events_duration = {
			[1.0] = 5.656938
		},
