local mission_vo_lm_rails_psyker_female_b = {
	mission_rails_disable_skyfire_a = {
		randomize_indexes_n = 0,
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_disable_skyfire_a_01",
			[2.0] = "loc_psyker_female_b__mission_rails_disable_skyfire_a_02"
		},
	...
	mission_rails_district_gate = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_district_gate_01",
	...
	mission_rails_end_event_conversation_one_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_one_a_01",
			[2.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_one_a_02"
		},
		sound_events_duration = {
			[1.0] = 2.203458,
			[2.0] = 4.369333
	...
	mission_rails_end_event_conversation_one_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_one_c_01",
	...
	mission_rails_end_event_conversation_three_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_three_a_01",
	...
	mission_rails_end_event_conversation_three_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_three_c_01",
	...
	mission_rails_end_event_conversation_two_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_two_a_01",
			[2.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_two_a_02"
		},
		sound_events_duration = {
			[1.0] = 3.815604,
			[2.0] = 4.060813
	...
	mission_rails_end_event_conversation_two_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_two_c_01",
			[2.0] = "loc_psyker_female_b__mission_rails_end_event_conversation_two_c_02"
		},
		sound_events_duration = {
			[1.0] = 4.986604,
			[2.0] = 2.583063
	...
	mission_rails_hab_block_dreyko = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_hab_block_dreyko_01",
	...
	mission_rails_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_start_banter_a_01",
			[2.0] = "loc_psyker_female_b__mission_rails_start_banter_a_02"
		},
		sound_events_duration = {
			[1.0] = 4.349625,
			[2.0] = 2.787979
	...
	mission_rails_trains = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__mission_rails_trains_01",
...
return settings("mission_vo_lm_rails_psyker_female_b", mission_vo_lm_rails_psyker_female_b)
