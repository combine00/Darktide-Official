local mission_vo_dm_propaganda_adamant_female_c = {
	mission_propaganda_short_elevator_conversation_one_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_propaganda_short_elevator_conversation_one_a_01"
		},
	...
	mission_propaganda_short_elevator_conversation_three_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_propaganda_short_elevator_conversation_three_a_01"
		},
		sound_events_duration = {
			[1.0] = 5.322594
		},
	...
	mission_propaganda_short_elevator_conversation_two_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_propaganda_short_elevator_conversation_two_a_01"
		},
		sound_events_duration = {
			[1.0] = 3.106271
		},
	...
	mission_propaganda_start_banter_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_female_c__mission_propaganda_start_banter_a_01"
		},
		sound_events_duration = {
			[1.0] = 3.677552
		},
