local gameplay_vo_ogryn_c = {
	...
	found_ammo_low_on_ammo = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_ogryn_c__found_ammo_low_on_ammo_01",
			"loc_ogryn_c__found_ammo_low_on_ammo_02",
			"loc_ogryn_c__found_ammo_low_on_ammo_03",
			"loc_ogryn_c__found_ammo_low_on_ammo_04",
			"loc_ogryn_c__found_ammo_low_on_ammo_05"
		},
		sound_events_duration = {
			2.270885,
			1.765917,
	...
	response_for_ogryn_start_revive_ogryn = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_ogryn_c__response_for_ogryn_start_revive_ogryn_01",
			"loc_ogryn_c__response_for_ogryn_start_revive_ogryn_02",
			"loc_ogryn_c__response_for_ogryn_start_revive_ogryn_03",
			"loc_ogryn_c__response_for_ogryn_start_revive_ogryn_04",
			"loc_ogryn_c__response_for_ogryn_start_revive_ogryn_05"
		},
		sound_events_duration = {
			2.371823,
			3.085365,
	...
	seen_enemy_bulwark_custom = {
		...
		sound_events_n = 8,
		sound_events = {
			"loc_ogryn_c__seen_enemy_bulwark_01",
			"loc_ogryn_c__seen_enemy_bulwark_02",
			"loc_ogryn_c__seen_enemy_bulwark_03",
			"loc_ogryn_c__seen_enemy_bulwark_05",
	...
	seen_horde_static = {
		...
		sound_events_n = 10,
		sound_events = {
			"loc_ogryn_c__seen_horde_static_01",
			"loc_ogryn_c__seen_horde_static_02",
			"loc_ogryn_c__seen_horde_static_03",
			"loc_ogryn_c__seen_horde_static_04",
			"loc_ogryn_c__seen_horde_static_05",
			"loc_ogryn_c__seen_horde_static_06",
			"loc_ogryn_c__seen_horde_static_07",
			"loc_ogryn_c__seen_horde_static_08",
			"loc_ogryn_c__seen_horde_static_09",
			"loc_ogryn_c__seen_horde_static_10"
		},
		sound_events_duration = {
			1.999292,
			1.958938,
