local gameplay_vo_psyker_female_b = {
	...
	combat_pause_quirk_ammo_hog_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__combat_pause_quirk_ammo_hog_b_01",
			[2.0] = "loc_psyker_female_b__combat_pause_quirk_ammo_hog_b_02"
		},
		sound_events_duration = {
			[1.0] = 1.892292,
			[2.0] = 2.985396
	...
	combat_pause_quirk_health_hog_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__combat_pause_quirk_health_hog_b_01",
			[2.0] = "loc_psyker_female_b__combat_pause_quirk_health_hog_b_02"
		},
		sound_events_duration = {
			[1.0] = 4.000917,
			[2.0] = 3.151292
	...
	info_door_open = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_psyker_female_b__info_door_open_01",
			[2.0] = "loc_psyker_female_b__info_door_open_02"
		},
		sound_events_duration = {
			[1.0] = 2.448188,
			[2.0] = 1.014417
	...
	seen_enemy_executor = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_psyker_female_b__seen_enemy_executor_01",
	...
	seen_enemy_poxwalker_bomber = {
		...
		sound_events = {
			...
			"loc_psyker_female_b__seen_enemy_poxwalker_bomber_08",
