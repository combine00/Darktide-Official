local mission_vo_hm_strain_adamant_male_a = {
	...
	mission_strain_atmosphere_shield = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_male_a__mission_strain_atmosphere_shield_01"
		},
		sound_events_duration = {
			[1.0] = 4.849365
		},
	...
	mission_strain_crossroads = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_male_a__mission_strain_crossroads_01"
		},
		sound_events_duration = {
			[1.0] = 4.213281
		},
	...
	mission_strain_start_banter_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1.0] = "loc_adamant_male_a__mission_strain_start_banter_a_01"
		},
		sound_events_duration = {
			[1.0] = 6.507302
		},
