local gameplay_vo_veteran_male_c = {
	...
	combat_pause_quirk_ammo_hog_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_male_c__combat_pause_quirk_ammo_hog_b_01",
			[2.0] = "loc_veteran_male_c__combat_pause_quirk_ammo_hog_b_02"
		},
		sound_events_duration = {
			[1.0] = 1.907698,
			[2.0] = 2.217625
	...
	combat_pause_quirk_health_hog_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_male_c__combat_pause_quirk_health_hog_b_01",
			[2.0] = "loc_veteran_male_c__combat_pause_quirk_health_hog_b_02"
		},
		sound_events_duration = {
			[1.0] = 2.1225,
			[2.0] = 3.582188
	...
	info_door_open = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_male_c__info_door_open_01",
			[2.0] = "loc_veteran_male_c__info_door_open_02"
		},
		sound_events_duration = {
			[1.0] = 0.763521,
			[2.0] = 0.74051
	...
	seen_enemy_executor = {
		...
		sound_events_n = 6,
		sound_events = {
			"loc_veteran_male_c__seen_enemy_executor_02",
			"loc_veteran_male_c__seen_enemy_executor_05",
